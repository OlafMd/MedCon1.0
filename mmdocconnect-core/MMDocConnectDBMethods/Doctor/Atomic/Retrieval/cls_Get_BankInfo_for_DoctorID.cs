/* 
 * Generated on 04/24/15 10:04:40
...
namespace MMDocConnectDBMethods.Doctor.Atomic.Retrieval
{
	...
	public class cls_Get_BankInfo_for_DoctorID
	{
		...
		protected static FR_DO_BBIfDID_1424 Execute(DbConnection Connection,DbTransaction Transaction,P_DO_BBIfDID_1424 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			...
			var commandLocation = "MMDocConnectDBMethods.Doctor.Atomic.Retrieval.SQL.cls_Get_BankInfo_for_DoctorID.sql";
...
var parameter = new MMDocConnectDBMethods.Doctor.Atomic.Retrieval.P_DO_BBIfDID_1424();
parameter.DoctorID = ...;

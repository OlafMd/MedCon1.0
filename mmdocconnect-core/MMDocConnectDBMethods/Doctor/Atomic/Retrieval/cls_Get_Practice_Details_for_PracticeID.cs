/* 
 * Generated on 02/01/17 20:09:37
...
namespace MMDocConnectDBMethods.Doctor.Atomic.Retrieval
{
	...
	public class cls_Get_Practice_Details_for_PracticeID
	{
		...
		protected static FR_DO_GPDfPID_1432_Array Execute(DbConnection Connection,DbTransaction Transaction,P_DO_GPDfPID_1432 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			...
			var commandLocation = "MMDocConnectDBMethods.Doctor.Atomic.Retrieval.SQL.cls_Get_Practice_Details_for_PracticeID.sql";
			...
			try
			{
				reader.SetOrdinals(new string[] { "practiceID","practice_BSNR","is_company","practice_name","street","number","zip","city","practice_address","practice_town","contact_email","contact_telephone","contact_fax","contact_person_name","practice_IBAN","account_holder","practice_bank_name","practice_bank_BIC","IsValue_String","IsValue_Number","IsValue_Boolean","PropertyName","Value_String","Value_Number","Value_Boolean","sign_in_email" });
				while(reader.Read())
				{
					...
					//4:Parameter street of type String
					resultItem.street = reader.GetString(4);
					//5:Parameter number of type String
					resultItem.number = reader.GetString(5);
					...
					//8:Parameter practice_address of type String
					resultItem.practice_address = reader.GetString(8);
					//9:Parameter practice_town of type String
					resultItem.practice_town = reader.GetString(9);
					//10:Parameter contact_email of type String
					resultItem.contact_email = reader.GetString(10);
					//11:Parameter contact_telephone of type String
					resultItem.contact_telephone = reader.GetString(11);
					//12:Parameter contact_fax of type String
					resultItem.contact_fax = reader.GetString(12);
					//13:Parameter contact_person_name of type String
					resultItem.contact_person_name = reader.GetString(13);
					//14:Parameter practice_IBAN of type String
					resultItem.practice_IBAN = reader.GetString(14);
					//15:Parameter account_holder of type String
					resultItem.account_holder = reader.GetString(15);
					//16:Parameter practice_bank_name of type String
					resultItem.practice_bank_name = reader.GetString(16);
					//17:Parameter practice_bank_BIC of type String
					resultItem.practice_bank_BIC = reader.GetString(17);
					//18:Parameter IsValue_String of type Boolean
					resultItem.IsValue_String = reader.GetBoolean(18);
					//19:Parameter IsValue_Number of type Boolean
					resultItem.IsValue_Number = reader.GetBoolean(19);
					//20:Parameter IsValue_Boolean of type Boolean
					resultItem.IsValue_Boolean = reader.GetBoolean(20);
					//21:Parameter PropertyName of type String
					resultItem.PropertyName = reader.GetString(21);
					//22:Parameter Value_String of type String
					resultItem.Value_String = reader.GetString(22);
					//23:Parameter Value_Number of type int
					resultItem.Value_Number = reader.GetInteger(23);
					//24:Parameter Value_Boolean of type Boolean
					resultItem.Value_Boolean = reader.GetBoolean(24);
					//25:Parameter sign_in_email of type String
					resultItem.sign_in_email = reader.GetString(25);
...
var parameter = new MMDocConnectDBMethods.Doctor.Atomic.Retrieval.P_DO_GPDfPID_1432();

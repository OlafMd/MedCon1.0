...
From
  ...
  cmn_bpt_businessparticipants cmn_bpt_businessparticipants1
    On cmn_bpt_ctm_organizationalunit_staff.BusinessParticipant_RefID = cmn_bpt_businessparticipants1.CMN_BPT_BusinessParticipantID And
    cmn_bpt_businessparticipants1.Tenant_RefID = @TenantID And cmn_bpt_businessparticipants1.IsDeleted = 0 Inner Join
  hec_doctors
    On hec_doctors.BusinessParticipant_RefID = cmn_bpt_businessparticipants1.CMN_BPT_BusinessParticipantID And hec_doctors.Tenant_RefID = @TenantID And

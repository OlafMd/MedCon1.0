    ...
    Select
      hec_doctor_universalpropertyvalues.Value_String As DoctorCustomerNumber
    From
    ...
    Where
      ...
      hec_doctor_universalproperties.GlobalPropertyMatchingID = 'mm.docconnect.doctor.customer.number'

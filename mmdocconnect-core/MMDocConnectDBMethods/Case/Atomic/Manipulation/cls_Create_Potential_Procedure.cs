/* 
 * Generated on 06/11/15 11:51:02
...
namespace MMDocConnectDBMethods.Case.Atomic.Manipulation
{
	...
	public class cls_Create_Potential_Procedure
	{
		...
		protected static FR_Guid Execute(DbConnection Connection,DbTransaction Transaction,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
            ...
            //Put your code here
            var intraocular_procedure_packageQ = new ORM_HEC_TRE_PotentialProcedure_Package.Query();
            ...
            {
                var intraocular_procedure = new ORM_HEC_TRE_PotentialProcedure();
            ...
            {
                var intraocular_procedureQ = new ORM_HEC_TRE_PotentialProcedure.Query();

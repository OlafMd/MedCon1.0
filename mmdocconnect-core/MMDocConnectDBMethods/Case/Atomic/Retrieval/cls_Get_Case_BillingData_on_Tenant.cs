/* 
 * Generated on 04/25/17 10:17:12
...
namespace MMDocConnectDBMethods.Case.Atomic.Retrieval
{
	...
	public class cls_Get_Case_BillingData_on_Tenant
	{
		...
		///<summary>
		public static FR_CAS_GCBDoT_1048_Array Invoke(string ConnectionString,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_CAS_GCBDoT_1048_Array Invoke(DbConnection Connection,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_CAS_GCBDoT_1048_Array Invoke(DbConnection Connection, DbTransaction Transaction,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_CAS_GCBDoT_1048_Array Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_CAS_GCBDoT_1048_Array functionReturn = new FR_CAS_GCBDoT_1048_Array();
			try
			{
	...
	[Serializable]
	public class FR_CAS_GCBDoT_1048_Array : FR_Base
	{
		public CAS_GCBDoT_1048[] Result	{ get; set; } 
		public FR_CAS_GCBDoT_1048_Array() : base() {}

		public FR_CAS_GCBDoT_1048_Array(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass CAS_GCBDoT_1048 for attribute CAS_GCBDoT_1048
		[DataContract]
		public class CAS_GCBDoT_1048 
		{
...
[OperationContract]
FR_CAS_GCBDoT_1048_Array cls_Get_Case_BillingData_on_Tenant(string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_CAS_GCBDoT_1048_Array invocationResult = cls_Get_Case_BillingData_on_Tenant.Invoke(connectionString,securityTicket);

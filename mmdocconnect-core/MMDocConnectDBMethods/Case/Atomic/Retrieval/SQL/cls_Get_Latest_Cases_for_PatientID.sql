    ...
    From
      ...
      hec_cas_case_universalproperties
        ...
        (hec_cas_case_universalproperties.GlobalPropertyMatchingID = 'mm.doc.connect.case.is.for.documentation.only' Or
        hec_cas_case_universalproperties.GlobalPropertyMatchingID = 'mm.doc.connect.case.treatment.year.fake' Or
        hec_cas_case_universalproperties.GlobalPropertyMatchingID = 'mm.doc.connect.case.missing.oct.ivom') And
    ...
    Where
      ...
      hec_cas_case_universalproperties.GlobalPropertyMatchingID is null and

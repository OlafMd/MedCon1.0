...
From
  ...
  bil_billpositions
    ...
    bil_billpositions.IsDeleted = 0 Inner Join
  bil_billposition_transmitionstatuses
    On bil_billpositions.BIL_BillPositionID = bil_billposition_transmitionstatuses.BillPosition_RefID And
...
Where
  bil_billposition_transmitionstatuses.TransmitionCode = @Statuses And

...
Select
  ...
  Count(Distinct hec_cas_case_billcodes.HEC_CAS_Case_BillCodeID) As
  NumberOfTreatmentGposes
From
  ...
  hec_bil_potentialcode_2_healthcareproduct
    ...
    And hec_bil_potentialcode_2_healthcareproduct.IsDeleted = 0 Inner Join
  hec_bil_potentialcode_2_potentialdiagnosis
    ...
    hec_bil_potentialcode_2_potentialdiagnosis.IsDeleted = 0 Inner Join
  hec_cas_cases

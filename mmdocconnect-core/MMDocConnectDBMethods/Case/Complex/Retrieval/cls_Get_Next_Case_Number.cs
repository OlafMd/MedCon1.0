/* 
 * Generated on 05/21/15 12:00:16
...
namespace MMDocConnectDBMethods.Case.Complex.Retrieval
{
    ...
    public class cls_Get_Next_Case_Number
    {
        ...
        protected static FR_CAS_GNCN_1159 Execute(DbConnection Connection, DbTransaction Transaction, CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
        {
            ...
            var latest_case_number = 10000;

            if (latest_case != null && !String.IsNullOrEmpty(latest_case.latest_case_number))
            {
                latest_case_number = Int32.Parse(latest_case.latest_case_number);
            }

            case_number += SynchronizedSequentialNumberGeneratorCase.Instance.Generate(latest_case_number);

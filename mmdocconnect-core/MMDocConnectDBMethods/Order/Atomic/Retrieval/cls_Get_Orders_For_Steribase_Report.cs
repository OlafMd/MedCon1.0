/* 
 * Generated on 3/14/2017 11:49:35 AM
...
namespace MMDocConnectDBMethods.Order.Atomic.Retrieval
{
    ...
    /// var result = cls_Get_Orders_For_Steribase_Report.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Get_Orders_For_Steribase_Report
	{
		...
		///<summary>
		public static FR_OR_GOFSR_1055_Array Invoke(string ConnectionString,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_OR_GOFSR_1055_Array Invoke(DbConnection Connection,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_OR_GOFSR_1055_Array Invoke(DbConnection Connection, DbTransaction Transaction,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_OR_GOFSR_1055_Array Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_OR_GOFSR_1055_Array functionReturn = new FR_OR_GOFSR_1055_Array();
			try
			{
			...
			catch (Exception ex)
			{
				...
				throw new Exception("Exception occured in method cls_Get_Orders_For_Steribase_Report",ex);
			}
	...
	[Serializable]
	public class FR_OR_GOFSR_1055_Array : FR_Base
	{
		public OR_GOFSR_1055[] Result	{ get; set; } 
		public FR_OR_GOFSR_1055_Array() : base() {}

		public FR_OR_GOFSR_1055_Array(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass OR_GOFSR_1055 for attribute OR_GOFSR_1055
		[DataContract]
		public class OR_GOFSR_1055 
		{
...
[OperationContract]
FR_OR_GOFSR_1055_Array cls_Get_Orders_For_Steribase_Report(string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_OR_GOFSR_1055_Array invocationResult = cls_Get_Orders_For_Steribase_Report.Invoke(connectionString,securityTicket);

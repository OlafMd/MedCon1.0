...
namespace EdifactInterface
{
    public class Converter
    {
        ...
        public Converter(int iCounter, Int64 iBillingID, Int64 iMaxProcessNumberOfLastBilling, DateTime dtStartDate, DateTime dtEndDate, List<BillingInfo> lsBillingInfo, bool bIsTestData = true)
        {
            ...
            if (lsBillingInfo == null || lsBillingInfo.Count <= 0)
            {
                ...
                lsExcelOutput.Add(new EdifactInterface.ExcelOutput(this.iBillingID, this.iProcessNumber, "0", "", "Error, no valid patient with treatment was passed by calling module! BillingInfo argument was malformed.", "", "", "", "", ' ', ' ', 0, " ", false, false, "", "", "", "", "", "", "", Guid.Empty));
                return;
            }
        ...
        {            
            ...
            lsExcelOutput.Add(new EdifactInterface.ExcelOutput(iBillingID, iProcessNumber, bi.strPatientInsuranceState, bi.strPatientInsuranceNumber, bi.strPatientFirstName, bi.strPatientLastName, bi.strDoctorLANR, bi.strPracticeBSNR, diMain.strDiagnosisICD10, diMain.cDiagnosisState, bi.cTreatmentLocalization, bi.iTreatmentNumber + 1, treatmentMainArticle(bi.lsArticles), treatmentWithOzurdex(bi.lsArticles), treatmentWithBeva(bi.lsArticles), strGpos, strValue, bi.dtTreatment.ToString("MM.dd.yyyy"), bi.strFollowupPractice, bi.strFollowupDoctor, bi.strFollowupStatus, bi.dtFollowup.ToString("MM.dd.yyyy"), bi.gdBillingPositionID));
        ...
        private string buildBevaUNH(Int64 iProcessNumber, DateTime dtStartDate, DateTime dtEndDate, int iCounterUNHSegments, BillingInfo bi)
        {
            ...
            lsExcelOutput.Add(new EdifactInterface.ExcelOutput(iBillingID, iProcessNumber, bi.strPatientInsuranceState, bi.strPatientInsuranceNumber, bi.strPatientFirstName, bi.strPatientLastName, bi.strDoctorLANR, bi.strPracticeBSNR, "Zusatzposition Bevacizumab", diMain.cDiagnosisState, bi.cTreatmentLocalization, bi.iTreatmentNumber + 1, "-", false, false, strGpos, strValue, bi.dtTreatment.ToString("MM.dd.yyyy"), bi.strFollowupPractice, bi.strFollowupDoctor, bi.strFollowupStatus, bi.dtFollowup.ToString("MM.dd.yyyy"), bi.gdBillingPositionID));
        ...
        private string buildAdditionalUNH(Int64 iProcessNumber, DateTime dtStartDate, DateTime dtEndDate, int iCounterUNHSegments, BillingInfo bi)
        {
            ...
            lsExcelOutput.Add(new EdifactInterface.ExcelOutput(iBillingID, iProcessNumber, bi.strPatientInsuranceState, bi.strPatientInsuranceNumber, bi.strPatientFirstName, bi.strPatientLastName, bi.strDoctorLANR, bi.strPracticeBSNR, "Zusatzposition Vergütung", diMain.cDiagnosisState, bi.cTreatmentLocalization, bi.iTreatmentNumber + 1, "-", false, false, strGpos, strValue, bi.dtTreatment.ToString("MM.dd.yyyy"), bi.strFollowupPractice, bi.strFollowupDoctor, bi.strFollowupStatus, bi.dtFollowup.ToString("MM.dd.yyyy"), bi.gdBillingPositionID));
        ...
        private string treatmentMainArticle(List<ArticleInfo> lsArticles)
        {   
        ...
        private const string STR_IK_RECEIVER = "109519005";
    ...
    {
        public BillingInfo(Guid _gdBillingPositionID, string _strPatientInsuranceState, string _strPatientInsuranceNumber, int _iPatientSex, string _strPatientFirstName, string _strPatientLastName, DateTime _dtPatientBirthDate,
        ...
        {
            gdBillingPositionID = _gdBillingPositionID;
        ...
        public BillingInfo(string[] arrInit)
        {
            if (arrInit.Length != 14)
            {
                ...
                lsArticle.Add(new EdifactInterface.ArticleInfo("Kein Artikel gefunden", "0000000", 1));
            ...
            else
            {
                ...
                lsArticle.Add(new EdifactInterface.ArticleInfo(arrInit[3], "0000000", 1));
        ...
        public Guid gdBillingPositionID;
    ...
    {
        public ArticleInfo(string _strName, string _strPZN, int _iQuantity)
        {
            strName = _strName;
            strPZN = _strPZN;
    ...
    {
        public ExcelOutput(Int64 _iBillingID, Int64 _iProcessNumber, string _strPatientInsuranceState, string _strPatientInsuranceNumber, string _strPatientFirstName, string _strPatientLastName,
                           ...
                           string _strArticleName, bool _bTreatmentWithOzurdex, bool _bTreatmentWithBeva, string _strGpos, string _strChargedValue, string _strDateOfTreatment,
                           string _strFollowupPractice, string _strFollowupDoctor, string _strFollowupStatus, string _strDateOfFollowup, Guid _gdBillingPositionID)
        {
            ...
            cTreatmentLocalization = _cTreatmentLocalization;
            iTreatmentNumber = _iTreatmentNumber;
            strArticleName = _strArticleName;
            strGpos = _strGpos;

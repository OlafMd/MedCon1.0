/* 
 * Generated on 7/2/2013 12:40:53 PM
...
{
	[DataContract]
	public class cls_Get_BBV_Patients_For_ID
	{
		public static readonly int QueryTimeout = 60;

		#region Method Execution
		protected static FR_L6PA_GBBVPfID_1714 Execute(DbConnection Connection,DbTransaction Transaction,P_L6PA_GBBVPfID_1714 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			var returnStatus = new FR_L6PA_GBBVPfID_1714();

			DbCommand command = Connection.CreateCommand();
			command.Connection = Connection;
			command.Transaction = Transaction;
			var commandLocation = "CL6_BBV_Patient.Atomic.Retrieval.SQL.cls_Get_BBV_Patients_For_ID.sql";
			...
			try
			{
				...
				while(reader.Read())
				{
					...
					//14:Parameter Content of type String
					resultItem.Content = reader.GetString(14);
					...
					//21:Parameter Province_Name of type String
					resultItem.Province_Name = reader.GetString(21);
					//22:Parameter SequenceNumber of type int
					resultItem.SequenceNumber = reader.GetInteger(22);
					//23:Parameter IsPrimary of type bool
					resultItem.IsPrimary = reader.GetBoolean(23);
					//24:Parameter CMN_AddressID of type Guid
					resultItem.CMN_AddressID = reader.GetGuid(24);
					//25:Parameter AssignmentID of type Guid
					resultItem.AssignmentID = reader.GetGuid(25);
					//26:Parameter GlobalPropertyMatchingID of type String
					resultItem.GlobalPropertyMatchingID = reader.GetString(26);
					//27:Parameter HEC_STU_Study_PatientDocumentID of type Guid
					resultItem.HEC_STU_Study_PatientDocumentID = reader.GetGuid(27);
					//28:Parameter File_Name of type String
					resultItem.File_Name = reader.GetString(28);
					//29:Parameter File_Extension of type String
					resultItem.File_Extension = reader.GetString(29);
					//30:Parameter File_ServerLocation of type String
					resultItem.File_ServerLocation = reader.GetString(30);
					//31:Parameter File_Size_Bytes of type int
					resultItem.File_Size_Bytes = reader.GetInteger(31);
			...
			returnStatus.Result = L6PA_GBBVPfID_1714_raw.Convert(results).FirstOrDefault();
		...
		///<summary>
		public static FR_L6PA_GBBVPfID_1714 Invoke(string ConnectionString,P_L6PA_GBBVPfID_1714 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L6PA_GBBVPfID_1714 Invoke(DbConnection Connection,P_L6PA_GBBVPfID_1714 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L6PA_GBBVPfID_1714 Invoke(DbConnection Connection, DbTransaction Transaction,P_L6PA_GBBVPfID_1714 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L6PA_GBBVPfID_1714 Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L6PA_GBBVPfID_1714 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L6PA_GBBVPfID_1714 functionReturn = new FR_L6PA_GBBVPfID_1714();
			try
			{
	...
	[Serializable]
	public class L6PA_GBBVPfID_1714_raw 
	{
		...
		public static L6PA_GBBVPfID_1714[] Convert(List<L6PA_GBBVPfID_1714_raw> rawResult)
		{	
		    var gfunct_rawResult = rawResult;
			var groupResult = from el_L6PA_GBBVPfID_1714 in gfunct_rawResult.Where(element => !EqualsDefaultValue(element.HEC_PatientID)).ToArray()
	group el_L6PA_GBBVPfID_1714 by new 
	{ 
		el_L6PA_GBBVPfID_1714.HEC_PatientID,

	}
	into gfunct_L6PA_GBBVPfID_1714
	select new L6PA_GBBVPfID_1714
	{     
		Salutation_General = gfunct_L6PA_GBBVPfID_1714.FirstOrDefault().Salutation_General ,
		FirstName = gfunct_L6PA_GBBVPfID_1714.FirstOrDefault().FirstName ,
		LastName = gfunct_L6PA_GBBVPfID_1714.FirstOrDefault().LastName ,
		PrimaryEmail = gfunct_L6PA_GBBVPfID_1714.FirstOrDefault().PrimaryEmail ,
		HealthInsurance_Number = gfunct_L6PA_GBBVPfID_1714.FirstOrDefault().HealthInsurance_Number ,
		PatientComment = gfunct_L6PA_GBBVPfID_1714.FirstOrDefault().PatientComment ,
		HasFulfilledParticipationPolicyRequirements = gfunct_L6PA_GBBVPfID_1714.FirstOrDefault().HasFulfilledParticipationPolicyRequirements ,
		CMN_PER_PersonInfoID = gfunct_L6PA_GBBVPfID_1714.FirstOrDefault().CMN_PER_PersonInfoID ,
		CMN_BPT_BusinessParticipantID = gfunct_L6PA_GBBVPfID_1714.FirstOrDefault().CMN_BPT_BusinessParticipantID ,
		HEC_Patient_HealthInsurancesID = gfunct_L6PA_GBBVPfID_1714.FirstOrDefault().HEC_Patient_HealthInsurancesID ,
		HEC_PatientID = gfunct_L6PA_GBBVPfID_1714.Key.HEC_PatientID ,
		HEC_STU_Study_ParticipatingPatientID = gfunct_L6PA_GBBVPfID_1714.FirstOrDefault().HEC_STU_Study_ParticipatingPatientID ,
		Participation_DateOfSigning = gfunct_L6PA_GBBVPfID_1714.FirstOrDefault().Participation_DateOfSigning ,
		Participation_Comment = gfunct_L6PA_GBBVPfID_1714.FirstOrDefault().Participation_Comment ,

		Contacts = 
		(
			from el_Contacts in gfunct_L6PA_GBBVPfID_1714.Where(element => !EqualsDefaultValue(element.CMN_PER_CommunicationContactID)).ToArray()
			...
			select new L6PA_GBBVPfID_1714_Contact
			{     
		...
		Addresses = 
		(
			from el_Addresses in gfunct_L6PA_GBBVPfID_1714.Where(element => !EqualsDefaultValue(element.CMN_AddressID)).ToArray()
			...
			select new L6PA_GBBVPfID_1714_Address
			{     
		...
		PoliciyImages = 
		(
			from el_PoliciyImages in gfunct_L6PA_GBBVPfID_1714.Where(element => !EqualsDefaultValue(element.HEC_STU_Study_PatientDocumentID)).ToArray()
			...
			select new L6PA_GBBVPfID_1714_PoliciyImage
			{     
	...
	[Serializable]
	public class FR_L6PA_GBBVPfID_1714 : FR_Base
	{
		public L6PA_GBBVPfID_1714 Result	{ get; set; }

		public FR_L6PA_GBBVPfID_1714() : base() {}

		public FR_L6PA_GBBVPfID_1714(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass P_L6PA_GBBVPfID_1714 for attribute P_L6PA_GBBVPfID_1714
		[DataContract]
		public class P_L6PA_GBBVPfID_1714 
		{
		...
		#endregion
		#region SClass L6PA_GBBVPfID_1714 for attribute L6PA_GBBVPfID_1714
		[DataContract]
		public class L6PA_GBBVPfID_1714 
		{
			[DataMember]
			public L6PA_GBBVPfID_1714_Contact[] Contacts { get; set; }
			[DataMember]
			public L6PA_GBBVPfID_1714_Address[] Addresses { get; set; }
			[DataMember]
			public L6PA_GBBVPfID_1714_PoliciyImage[] PoliciyImages { get; set; }
		...
		#endregion
		#region SClass L6PA_GBBVPfID_1714_Contact for attribute Contacts
		[DataContract]
		public class L6PA_GBBVPfID_1714_Contact 
		{
			//Standard type parameters
			[DataMember]
		...
		#endregion
		#region SClass L6PA_GBBVPfID_1714_Address for attribute Addresses
		[DataContract]
		public class L6PA_GBBVPfID_1714_Address 
		{
			//Standard type parameters
			[DataMember]
		...
		#endregion
		#region SClass L6PA_GBBVPfID_1714_PoliciyImage for attribute PoliciyImages
		[DataContract]
		public class L6PA_GBBVPfID_1714_PoliciyImage 
		{
			//Standard type parameters
			[DataMember]

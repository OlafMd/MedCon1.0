/* 
 * Generated on 7/15/2014 5:35:46 PM
...
namespace CL6_DanuTask_DeveloperModule.Complex.Retrieval
{
	/// <summary>
    /// 
	...
	public class cls_Get_DeveloperModuleDashboardMenuData_for_ActiveUser
	{
		...
		protected static FR_L6US_GDMDMDfAU_1802 Execute(DbConnection Connection,DbTransaction Transaction,P_L6US_GDMDMDfAU_1802 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
            ...
            Parameter_ActiveTask.FeatureStatusExcluded = Parameter.FeatureStatusDifferentFromThis;
            Parameter_ActiveTask.BusinessTaskStatusExcluded = Parameter.BusinessTaskStatusDifferentFromThis;
            Parameter_ActiveTask.ProjectStatusExcluded = Parameter.ProjectStatusDifferenFromThis;
            returnValue.Result.ActiveTask = cls_Get_ActiveDeveloperTask_for_ActiveUser.Invoke(Connection, Transaction, Parameter_ActiveTask, securityTicket).Result;
            #endregion
            ...
            //#region InvestedTime
            //returnValue.Result.CurrentDayWorkTime = cls_Get_Invested_Working_Time_for_Today.Invoke(Connection, Transaction, securityTicket).Result.ToArray();
            //#endregion
...
var parameter = new CL6_DanuTask_DeveloperModule.Complex.Retrieval.P_L6US_GDMDMDfAU_1802();

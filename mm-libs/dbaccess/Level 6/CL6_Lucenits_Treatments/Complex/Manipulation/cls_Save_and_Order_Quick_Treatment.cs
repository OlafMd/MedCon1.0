/* 
 * Generated on 9/23/2013 3:04:55 PM
...
namespace CL6_Lucenits_Treatments.Complex.Manipulation
{
    ...
    /// var result = cls_Save_and_Order_Quick_Treatment.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Save_and_Order_Quick_Treatment
	{
		public static readonly int QueryTimeout = 60;

		#region Method Execution
		protected static FR_Guid Execute(DbConnection Connection,DbTransaction Transaction,P_L6TR_SaOQT_1503 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
		...
		///<summary>
		public static FR_Guid Invoke(string ConnectionString,P_L6TR_SaOQT_1503 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Guid Invoke(DbConnection Connection,P_L6TR_SaOQT_1503 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Guid Invoke(DbConnection Connection, DbTransaction Transaction,P_L6TR_SaOQT_1503 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_Guid Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L6TR_SaOQT_1503 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			...
			catch (Exception ex)
			{
				...
				throw new Exception("Exception occured in method cls_Save_and_Order_Quick_Treatment",ex);
			}
	...
	#region Support Classes
		#region SClass P_L6TR_SaOQT_1503 for attribute P_L6TR_SaOQT_1503
		[DataContract]
		public class P_L6TR_SaOQT_1503 
		{
...
[OperationContract]
FR_Guid cls_Save_and_Order_Quick_Treatment(,P_L6TR_SaOQT_1503 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_Guid invocationResult = cls_Save_and_Order_Quick_Treatment.Invoke(connectionString,P_L6TR_SaOQT_1503 Parameter,securityTicket);
...
var parameter = new CL6_Lucenits_Treatments.Complex.Manipulation.P_L6TR_SaOQT_1503();

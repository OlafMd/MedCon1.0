/* 
 * Generated on 03.11.2014 09:57:06
...
namespace CL6_APOReporting_Logistic.APOLogistic_DeliveryList
{
	/// <summary>
    /// 
    /// <example>
	/// string connectionString = ...;
    /// var result = cls_Get_Data_for_DeliveryList_Report.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Get_Data_for_DeliveryList_Report
	{
            ...
            if (shipmentAndCustomerOrderDetails != null)
            {
                shipmentNoteList = ORM_LOG_SHP_Shipment_Note.Query
                    .Search(Connection, Transaction,
                        new ORM_LOG_SHP_Shipment_Note.Query { IsDeleted = false, IsNotePrintedOnDeliveryPaper = true, Shipment_Header_RefID = shipmentAndCustomerOrderDetails.LOG_SHP_Shipment_HeaderID })
		...
		///<summary>
		public static FR_L6LG_GDfDLR_1522 Invoke(string ConnectionString,P_L6LG_GDfDLR_1522 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L6LG_GDfDLR_1522 Invoke(DbConnection Connection,P_L6LG_GDfDLR_1522 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L6LG_GDfDLR_1522 Invoke(DbConnection Connection, DbTransaction Transaction,P_L6LG_GDfDLR_1522 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L6LG_GDfDLR_1522 Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L6LG_GDfDLR_1522 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L6LG_GDfDLR_1522 functionReturn = new FR_L6LG_GDfDLR_1522();
			try
			{
			...
			catch (Exception ex)
			{
				...
				throw new Exception("Exception occured in method cls_Get_Data_for_DeliveryList_Report",ex);
			}
	...
	[Serializable]
	public class FR_L6LG_GDfDLR_1522 : FR_Base
	{
		public L6LG_GDfDLR_1522 Result	{ get; set; }

		public FR_L6LG_GDfDLR_1522() : base() {}

		public FR_L6LG_GDfDLR_1522(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass P_L6LG_GDfDLR_1522 for attribute P_L6LG_GDfDLR_1522
		[DataContract]
		public class P_L6LG_GDfDLR_1522 
		{
		...
		#endregion
		#region SClass L6LG_GDfDLR_1522 for attribute L6LG_GDfDLR_1522
		[DataContract]
		public class L6LG_GDfDLR_1522 
		{
			[DataMember]
			public L6LG_GDfDLR_1522a[] ShipmentPositionList { get; set; }
			[DataMember]
			public L6LG_GDfDLR_1522b[] CustomerOrderPositionList { get; set; }
			[DataMember]
			public L6LG_GDfDLR_1522c[] CommentList { get; set; }
		...
		#endregion
		#region SClass L6LG_GDfDLR_1522a for attribute ShipmentPositionList
		[DataContract]
		public class L6LG_GDfDLR_1522a 
		{
			//Standard type parameters
			[DataMember]
		...
		#endregion
		#region SClass L6LG_GDfDLR_1522b for attribute CustomerOrderPositionList
		[DataContract]
		public class L6LG_GDfDLR_1522b 
		{
			//Standard type parameters
			[DataMember]
			public CL5_APOBackoffice_CustomerOrder.Atomic.Retrieval.L5CO_GACOPfUSP_1038 CustomerOrderPositionDetails { get; set; } 
			[DataMember]
			public CL3_Articles.Atomic.Retrieval.L3AR_GAfAL_0942 ProductDetails { get; set; } 

		}
		#endregion
		#region SClass L6LG_GDfDLR_1522c for attribute CommentList
		[DataContract]
		public class L6LG_GDfDLR_1522c 
		{
			//Standard type parameters
			[DataMember]
...
[OperationContract]
FR_L6LG_GDfDLR_1522 cls_Get_Data_for_DeliveryList_Report(,P_L6LG_GDfDLR_1522 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_L6LG_GDfDLR_1522 invocationResult = cls_Get_Data_for_DeliveryList_Report.Invoke(connectionString,P_L6LG_GDfDLR_1522 Parameter,securityTicket);
...
var parameter = new CL6_APOReporting_Logistic.APOLogistic_DeliveryList.P_L6LG_GDfDLR_1522();

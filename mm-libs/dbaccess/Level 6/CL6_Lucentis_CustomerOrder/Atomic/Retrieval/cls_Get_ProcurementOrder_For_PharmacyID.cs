/* 
 * Generated on 3/6/2014 2:42:23 PM
...
namespace CL6_Lucentis_CustomerOrder.Atomic.Retrieval
{
    ...
    /// var result = cls_Get_ProcurementOrder_For_PharmacyID.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Get_ProcurementOrder_For_PharmacyID
	{
		public static readonly int QueryTimeout = 60;

		#region Method Execution
		protected static FR_L6CO_GPOFPID_1440_Array Execute(DbConnection Connection,DbTransaction Transaction,P_L6CO_GPOFPID_1440 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			var returnStatus = new FR_L6CO_GPOFPID_1440_Array();

			DbCommand command = Connection.CreateCommand();
			command.Connection = Connection;
			command.Transaction = Transaction;
			var commandLocation = "CL6_Lucentis_CustomerOrder.Atomic.Retrieval.SQL.cls_Get_ProcurementOrder_For_PharmacyID.sql";
			...
			try
			{
				...
				while(reader.Read())
				{
					...
					//2:Parameter ORD_PRC_ProcurementOrder_StatusID of type Guid
					resultItem.ORD_PRC_ProcurementOrder_StatusID = reader.GetGuid(2);
					...
					//5:Parameter ProcurementOrder_Number of type String
					resultItem.ProcurementOrder_Number = reader.GetString(5);
					//6:Parameter ProcurementOrder_Date of type DateTime
					resultItem.ProcurementOrder_Date = reader.GetDate(6);
					...
					//15:Parameter ORD_PRC_ProcurementOrder_PositionID of type Guid
					resultItem.ORD_PRC_ProcurementOrder_PositionID = reader.GetGuid(15);
			...
			{
				reader.Close();
				throw new Exception("Exception occured durng data retrieval in method cls_Get_ProcurementOrder_For_PharmacyID",ex);
			}
			reader.Close();
			//Load all the dictionaries from the datatables
			loader.Load();

			returnStatus.Result = L6CO_GPOFPID_1440_raw.Convert(results).ToArray();
			return returnStatus;
		}
		#endregion
		...
		///<summary>
		public static FR_L6CO_GPOFPID_1440_Array Invoke(string ConnectionString,P_L6CO_GPOFPID_1440 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L6CO_GPOFPID_1440_Array Invoke(DbConnection Connection,P_L6CO_GPOFPID_1440 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L6CO_GPOFPID_1440_Array Invoke(DbConnection Connection, DbTransaction Transaction,P_L6CO_GPOFPID_1440 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L6CO_GPOFPID_1440_Array Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L6CO_GPOFPID_1440 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L6CO_GPOFPID_1440_Array functionReturn = new FR_L6CO_GPOFPID_1440_Array();
			try
			{
			...
			catch (Exception ex)
			{
				...
				throw new Exception("Exception occured in method cls_Get_ProcurementOrder_For_PharmacyID",ex);
			}
	...
	[Serializable]
	public class L6CO_GPOFPID_1440_raw 
	{
		public String Status_Code; 
		public Dict Status_Name; 
		public Guid ORD_PRC_ProcurementOrder_StatusID; 
		public Guid ORD_PRC_ProcurementOrder_HeaderID; 
		public String GlobalPropertyMatchingID; 
		public String ProcurementOrder_Number; 
		public DateTime ProcurementOrder_Date; 
		...
		public static L6CO_GPOFPID_1440[] Convert(List<L6CO_GPOFPID_1440_raw> rawResult)
		{	
		    var gfunct_rawResult = rawResult;
			var groupResult = from el_L6CO_GPOFPID_1440 in gfunct_rawResult.Where(element => !EqualsDefaultValue(element.ORD_PRC_ProcurementOrder_HeaderID)).ToArray()
	group el_L6CO_GPOFPID_1440 by new 
	{ 
		el_L6CO_GPOFPID_1440.ORD_PRC_ProcurementOrder_HeaderID,

	}
	into gfunct_L6CO_GPOFPID_1440
	select new L6CO_GPOFPID_1440
	{     
		Status_Code = gfunct_L6CO_GPOFPID_1440.FirstOrDefault().Status_Code ,
		Status_Name = gfunct_L6CO_GPOFPID_1440.FirstOrDefault().Status_Name ,
		ORD_PRC_ProcurementOrder_StatusID = gfunct_L6CO_GPOFPID_1440.FirstOrDefault().ORD_PRC_ProcurementOrder_StatusID ,
		ORD_PRC_ProcurementOrder_HeaderID = gfunct_L6CO_GPOFPID_1440.Key.ORD_PRC_ProcurementOrder_HeaderID ,
		GlobalPropertyMatchingID = gfunct_L6CO_GPOFPID_1440.FirstOrDefault().GlobalPropertyMatchingID ,
		ProcurementOrder_Number = gfunct_L6CO_GPOFPID_1440.FirstOrDefault().ProcurementOrder_Number ,
		ProcurementOrder_Date = gfunct_L6CO_GPOFPID_1440.FirstOrDefault().ProcurementOrder_Date ,
		HEC_Patient_TreatmentID = gfunct_L6CO_GPOFPID_1440.FirstOrDefault().HEC_Patient_TreatmentID ,
		HEC_Patient_Treatment_RequiredProductID = gfunct_L6CO_GPOFPID_1440.FirstOrDefault().HEC_Patient_Treatment_RequiredProductID ,
		CMN_COM_CompanyInfoID = gfunct_L6CO_GPOFPID_1440.FirstOrDefault().CMN_COM_CompanyInfoID ,
		CMN_BPT_BusinessParticipantID = gfunct_L6CO_GPOFPID_1440.FirstOrDefault().CMN_BPT_BusinessParticipantID ,
		DisplayName = gfunct_L6CO_GPOFPID_1440.FirstOrDefault().DisplayName ,
		HEC_MedicalPractiseID = gfunct_L6CO_GPOFPID_1440.FirstOrDefault().HEC_MedicalPractiseID ,
		ExpectedDateOfDelivery = gfunct_L6CO_GPOFPID_1440.FirstOrDefault().ExpectedDateOfDelivery ,

		Positions = 
		(
			from el_Positions in gfunct_L6CO_GPOFPID_1440.Where(element => !EqualsDefaultValue(element.ORD_PRC_ProcurementOrder_PositionID)).ToArray()
			group el_Positions by new 
			{ 
				el_Positions.ORD_PRC_ProcurementOrder_PositionID,

			}
			into gfunct_Positions
			select new L6CO_GPOFPID_1440_Position
			{     
				Product_Name = gfunct_Positions.FirstOrDefault().Product_Name ,
				ORD_PRC_ProcurementOrder_PositionID = gfunct_Positions.Key.ORD_PRC_ProcurementOrder_PositionID ,
		...
		DoctorPerformed = 
		(
			from el_DoctorPerformed in gfunct_L6CO_GPOFPID_1440.ToArray()
			select new L6CO_GPOFPID_1440_DoctorsPerformed
			{     
		...
		DoctorScheduled = 
		(
			from el_DoctorScheduled in gfunct_L6CO_GPOFPID_1440.ToArray()
			select new L6CO_GPOFPID_1440_DoctorsScheduled
			{     
	...
	[Serializable]
	public class FR_L6CO_GPOFPID_1440_Array : FR_Base
	{
		public L6CO_GPOFPID_1440[] Result	{ get; set; } 
		public FR_L6CO_GPOFPID_1440_Array() : base() {}

		public FR_L6CO_GPOFPID_1440_Array(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass P_L6CO_GPOFPID_1440 for attribute P_L6CO_GPOFPID_1440
		[DataContract]
		public class P_L6CO_GPOFPID_1440 
		{
		...
		#endregion
		#region SClass L6CO_GPOFPID_1440 for attribute L6CO_GPOFPID_1440
		[DataContract]
		public class L6CO_GPOFPID_1440 
		{
			[DataMember]
			public L6CO_GPOFPID_1440_Position[] Positions { get; set; }
			[DataMember]
			public L6CO_GPOFPID_1440_DoctorsPerformed DoctorPerformed { get; set; }
			[DataMember]
			public L6CO_GPOFPID_1440_DoctorsScheduled DoctorScheduled { get; set; }
		...
		#endregion
		#region SClass L6CO_GPOFPID_1440_Position for attribute Positions
		[DataContract]
		public class L6CO_GPOFPID_1440_Position 
		{
			//Standard type parameters
			[DataMember]
		...
		#endregion
		#region SClass L6CO_GPOFPID_1440_DoctorsPerformed for attribute DoctorPerformed
		[DataContract]
		public class L6CO_GPOFPID_1440_DoctorsPerformed 
		{
			//Standard type parameters
			[DataMember]
		...
		#endregion
		#region SClass L6CO_GPOFPID_1440_DoctorsScheduled for attribute DoctorScheduled
		[DataContract]
		public class L6CO_GPOFPID_1440_DoctorsScheduled 
		{
			//Standard type parameters
			[DataMember]
...
[OperationContract]
FR_L6CO_GPOFPID_1440_Array cls_Get_ProcurementOrder_For_PharmacyID(,P_L6CO_GPOFPID_1440 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_L6CO_GPOFPID_1440_Array invocationResult = cls_Get_ProcurementOrder_For_PharmacyID.Invoke(connectionString,P_L6CO_GPOFPID_1440 Parameter,securityTicket);
...
var parameter = new CL6_Lucentis_CustomerOrder.Atomic.Retrieval.P_L6CO_GPOFPID_1440();

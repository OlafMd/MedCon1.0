/* 
 * Generated on 7/14/2014 4:18:10 PM
...
namespace CL6_Document.Complex.Manipulation
{
	/// <summary>
    /// Save document item to new location
    /// <example>
	...
	public class cls_Save_DocumentItem_To_New_Location
	{
		...
		///<summary>
		public static FR_Guid Invoke(string ConnectionString,P_L6SDTNL_1544 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Guid Invoke(DbConnection Connection,P_L6SDTNL_1544 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Guid Invoke(DbConnection Connection, DbTransaction Transaction,P_L6SDTNL_1544 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_Guid Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L6SDTNL_1544 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
	...
	#region Support Classes
		#region SClass P_L6SDTNL_1544 for attribute P_L6SDTNL_1544
		[DataContract]
		public class P_L6SDTNL_1544 
		{
...
[OperationContract]
FR_Guid cls_Save_DocumentItem_To_New_Location(,P_L6SDTNL_1544 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_Guid invocationResult = cls_Save_DocumentItem_To_New_Location.Invoke(connectionString,P_L6SDTNL_1544 Parameter,securityTicket);
...
var parameter = new CL6_Document.Complex.Manipulation.P_L6SDTNL_1544();
parameter.ItemID = ...;
parameter.ParentID = ...;

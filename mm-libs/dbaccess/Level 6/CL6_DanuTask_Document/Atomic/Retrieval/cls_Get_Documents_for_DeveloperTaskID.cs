/* 
 * Generated on 7/14/2014 3:26:08 PM
...
namespace CL6_DanuTask_Document.Atomic.Retrieval
{
	/// <summary>
    /// Get documents for Developer task ID
    /// <example>
	...
	public class cls_Get_Documents_for_DeveloperTaskID
	{
		...
		protected static FR_L6DO_GDfDT_1451_Array Execute(DbConnection Connection,DbTransaction Transaction,P_L6DO_GDfDT_1451 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			var returnStatus = new FR_L6DO_GDfDT_1451_Array();

			DbCommand command = Connection.CreateCommand();
			command.Connection = Connection;
            command.Transaction = Transaction;
            var commandLocation = "CL6_DanuTask_Document.Atomic.Retrieval.SQL.cls_Get_Documents_for_DeveloperTaskID.sql";
			...
			List<L6DO_GDfDT_1451_raw> results = new List<L6DO_GDfDT_1451_raw>();
			...
			try
			{
				...
				while(reader.Read())
				{
					L6DO_GDfDT_1451_raw resultItem = new L6DO_GDfDT_1451_raw();
			...
			returnStatus.Result = L6DO_GDfDT_1451_raw.Convert(results).ToArray();
			return returnStatus;
		}
		#endregion
		...
		///<summary>
		public static FR_L6DO_GDfDT_1451_Array Invoke(string ConnectionString,P_L6DO_GDfDT_1451 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L6DO_GDfDT_1451_Array Invoke(DbConnection Connection,P_L6DO_GDfDT_1451 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L6DO_GDfDT_1451_Array Invoke(DbConnection Connection, DbTransaction Transaction,P_L6DO_GDfDT_1451 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L6DO_GDfDT_1451_Array Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L6DO_GDfDT_1451 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L6DO_GDfDT_1451_Array functionReturn = new FR_L6DO_GDfDT_1451_Array();
			try
			{
	...
	[Serializable]
	public class L6DO_GDfDT_1451_raw 
	{
		...
		public static L6DO_GDfDT_1451[] Convert(List<L6DO_GDfDT_1451_raw> rawResult)
		{	
		    var gfunct_rawResult = rawResult;
			var groupResult = from el_L6DO_GDfDT_1451 in gfunct_rawResult.Where(element => !EqualsDefaultValue(element.DOC_DocumentID)).ToArray()
	group el_L6DO_GDfDT_1451 by new 
	{ 
		el_L6DO_GDfDT_1451.DOC_DocumentID,

	}
	into gfunct_L6DO_GDfDT_1451
	select new L6DO_GDfDT_1451
	{     
		AssignmentID = gfunct_L6DO_GDfDT_1451.FirstOrDefault().AssignmentID ,
		Structure_RefID = gfunct_L6DO_GDfDT_1451.FirstOrDefault().Structure_RefID ,
		StructureHeader_RefID = gfunct_L6DO_GDfDT_1451.FirstOrDefault().StructureHeader_RefID ,
		DOC_DocumentID = gfunct_L6DO_GDfDT_1451.Key.DOC_DocumentID ,
		Alias = gfunct_L6DO_GDfDT_1451.FirstOrDefault().Alias ,
		PrimaryType = gfunct_L6DO_GDfDT_1451.FirstOrDefault().PrimaryType ,

		Revisions = 
		(
			from el_Revisions in gfunct_L6DO_GDfDT_1451.Where(element => !EqualsDefaultValue(element.DOC_DocumentRevisionID)).ToArray()
	...
	[Serializable]
	public class FR_L6DO_GDfDT_1451_Array : FR_Base
	{
		public L6DO_GDfDT_1451[] Result	{ get; set; } 
		public FR_L6DO_GDfDT_1451_Array() : base() {}

		public FR_L6DO_GDfDT_1451_Array(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass P_L6DO_GDfDT_1451 for attribute P_L6DO_GDfDT_1451
		[DataContract]
		public class P_L6DO_GDfDT_1451 
		{
		...
		#endregion
		#region SClass L6DO_GDfDT_1451 for attribute L6DO_GDfDT_1451
		[DataContract]
		public class L6DO_GDfDT_1451 
		{
			[DataMember]
			public L6DO_GDfDT_1451a[] Revisions { get; set; }
		...
		#endregion
		#region SClass L6DO_GDfDT_1451a for attribute Revisions
		[DataContract]
		public class L6DO_GDfDT_1451a 
		{
			//Standard type parameters
			[DataMember]
...
[OperationContract]
FR_L6DO_GDfDT_1451_Array cls_Get_Documents_for_DeveloperTaskID(,P_L6DO_GDfDT_1451 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_L6DO_GDfDT_1451_Array invocationResult = cls_Get_Documents_for_DeveloperTaskID.Invoke(connectionString,P_L6DO_GDfDT_1451 Parameter,securityTicket);
...
var parameter = new CL6_DanuTask_Document.Atomic.Retrieval.P_L6DO_GDfDT_1451();

/* 
 * Generated on 7/8/2013 10:57:44 AM
...
namespace CL6_Lucenits_Document.Atomic.Retrieval
{
	/// <summary>
    /// 
    /// <example>
	...
	public class cls_Get_Documents_for_PatientID
	{
		...
		protected static FR_L6DO_GDfP_1552_Array Execute(DbConnection Connection,DbTransaction Transaction,P_L6DO_GDfP_1552 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			var returnStatus = new FR_L6DO_GDfP_1552_Array();

			DbCommand command = Connection.CreateCommand();
			command.Connection = Connection;
			command.Transaction = Transaction;
			var commandLocation = "CL6_Lucenits_Document.Atomic.Retrieval.SQL.cls_Get_Documents_for_PatientID.sql";
			...
			List<L6DO_GDfP_1552> results = new List<L6DO_GDfP_1552>();
			...
			try
			{
				...
				while(reader.Read())
				{
					L6DO_GDfP_1552 resultItem = new L6DO_GDfP_1552();
		...
		///<summary>
		public static FR_L6DO_GDfP_1552_Array Invoke(string ConnectionString,P_L6DO_GDfP_1552 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L6DO_GDfP_1552_Array Invoke(DbConnection Connection,P_L6DO_GDfP_1552 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L6DO_GDfP_1552_Array Invoke(DbConnection Connection, DbTransaction Transaction,P_L6DO_GDfP_1552 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L6DO_GDfP_1552_Array Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L6DO_GDfP_1552 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L6DO_GDfP_1552_Array functionReturn = new FR_L6DO_GDfP_1552_Array();
			try
			{
	...
	[Serializable]
	public class FR_L6DO_GDfP_1552_Array : FR_Base
	{
		public L6DO_GDfP_1552[] Result	{ get; set; } 
		public FR_L6DO_GDfP_1552_Array() : base() {}

		public FR_L6DO_GDfP_1552_Array(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass P_L6DO_GDfP_1552 for attribute P_L6DO_GDfP_1552
		[DataContract]
		public class P_L6DO_GDfP_1552 
		{
		...
		#endregion
		#region SClass L6DO_GDfP_1552 for attribute L6DO_GDfP_1552
		[DataContract]
		public class L6DO_GDfP_1552 
		{
			//Standard type parameters
			[DataMember]

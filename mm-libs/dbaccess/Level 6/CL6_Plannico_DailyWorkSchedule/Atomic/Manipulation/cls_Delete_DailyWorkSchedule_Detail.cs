/* 
 * Generated on 15/05/2014 14:24:32
...
namespace CL5_Plannico_DailyWorkSchedules.Atomic.Manipulation
{
    ...
    /// var result = cls_Delete_DailyWorkSchedule_Detail.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
    [DataContract]
    public class cls_Delete_DailyWorkSchedule_Detail
    {
        ...
        ///<summary>
        public static FR_Base Invoke(string ConnectionString, P_L6DWS_DDWSDFIDL_1014 Parameter, CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
        {
        ...
        ///<summary>
        public static FR_Base Invoke(DbConnection Connection, P_L6DWS_DDWSDFIDL_1014 Parameter, CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
        {
        ...
        ///<summary>
        public static FR_Base Invoke(DbConnection Connection, DbTransaction Transaction, P_L6DWS_DDWSDFIDL_1014 Parameter, CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
        {
        ...
        ///<summary>
        protected static FR_Base Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString, P_L6DWS_DDWSDFIDL_1014 Parameter, CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("Exception occured in method cls_Delete_DailyWorkSchedule_Detail", ex);
            }
...
[OperationContract]
FR_Base cls_Delete_DailyWorkSchedule_Detail(,P_L6DWS_DDWSDFIDL_1014 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_Base invocationResult = cls_Delete_DailyWorkSchedule_Detail.Invoke(connectionString,P_L6DWS_DDWSDFIDL_1014 Parameter,securityTicket);
...
var parameter = new CL5_Plannico_DailyWorkSchedules.Atomic.Manipulation.P_L6DWS_DDWSDFIDL_1014();

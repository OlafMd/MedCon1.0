/* 
 * Generated on 1/21/2015 14:27:36
...
namespace CL6_MyHealthClub_Observations.Complex.Retrieval
{
	...
	public class cls_Get_All_PotentialObservations_and_MadeObservations_for_PerformedActionID
	{
		...
		protected static FR_L6OB_GAPOaMOfPAID_1639 Execute(DbConnection Connection,DbTransaction Transaction,P_L6OB_GAPOaMOfPAID_1639 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
            ...
            L6OB_GAPOaMOfPAID_1639 madeAndPotentialObservations = new L6OB_GAPOaMOfPAID_1639();
            ...
            List<L6OB_GAPOaMOfPAID_1639MadeObservations> madeObservations = new List<L6OB_GAPOaMOfPAID_1639MadeObservations>();
            foreach (var observation in madeObservationsForPerformedActionID)
            {
                L6OB_GAPOaMOfPAID_1639MadeObservations newObservation = new L6OB_GAPOaMOfPAID_1639MadeObservations();

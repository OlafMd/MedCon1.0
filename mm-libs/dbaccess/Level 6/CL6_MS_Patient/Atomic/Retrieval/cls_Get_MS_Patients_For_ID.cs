/* 
 * Generated on 7/22/2013 4:39:51 PM
...
namespace CL6_MS_Patient.Atomic.Retrieval
{
    ...
    /// var result = cls_Get_MS_Patients_For_ID.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Get_MS_Patients_For_ID
	{
		public static readonly int QueryTimeout = 60;

		#region Method Execution
		protected static FR_L6PA_GMSPfID_1538 Execute(DbConnection Connection,DbTransaction Transaction,P_L6PA_GMSPfID_1538 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			var returnStatus = new FR_L6PA_GMSPfID_1538();

			DbCommand command = Connection.CreateCommand();
			command.Connection = Connection;
			command.Transaction = Transaction;
			var commandLocation = "CL6_MS_Patient.Atomic.Retrieval.SQL.cls_Get_MS_Patients_For_ID.sql";
			...
			List<L6PA_GMSPfID_1538_raw> results = new List<L6PA_GMSPfID_1538_raw>();
			...
			try
			{
				...
				while(reader.Read())
				{
					L6PA_GMSPfID_1538_raw resultItem = new L6PA_GMSPfID_1538_raw();
			...
			{
				reader.Close();
				throw new Exception("Exception occured durng data retrieval in method cls_Get_MS_Patients_For_ID",ex);
			}
			reader.Close();
			//Load all the dictionaries from the datatables
			loader.Load();

			returnStatus.Result = L6PA_GMSPfID_1538_raw.Convert(results).FirstOrDefault();
		...
		///<summary>
		public static FR_L6PA_GMSPfID_1538 Invoke(string ConnectionString,P_L6PA_GMSPfID_1538 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L6PA_GMSPfID_1538 Invoke(DbConnection Connection,P_L6PA_GMSPfID_1538 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L6PA_GMSPfID_1538 Invoke(DbConnection Connection, DbTransaction Transaction,P_L6PA_GMSPfID_1538 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L6PA_GMSPfID_1538 Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L6PA_GMSPfID_1538 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L6PA_GMSPfID_1538 functionReturn = new FR_L6PA_GMSPfID_1538();
			try
			{
			...
			catch (Exception ex)
			{
				...
				throw new Exception("Exception occured in method cls_Get_MS_Patients_For_ID",ex);
			}
	...
	[Serializable]
	public class L6PA_GMSPfID_1538_raw 
	{
		...
		public static L6PA_GMSPfID_1538[] Convert(List<L6PA_GMSPfID_1538_raw> rawResult)
		{	
		    var gfunct_rawResult = rawResult;
			var groupResult = from el_L6PA_GMSPfID_1538 in gfunct_rawResult.Where(element => !EqualsDefaultValue(element.HEC_PatientID)).ToArray()
	group el_L6PA_GMSPfID_1538 by new 
	{ 
		el_L6PA_GMSPfID_1538.HEC_PatientID,

	}
	into gfunct_L6PA_GMSPfID_1538
	select new L6PA_GMSPfID_1538
	{     
		USR_AccountID = gfunct_L6PA_GMSPfID_1538.FirstOrDefault().USR_AccountID ,
		USR_Device_AccountCodeID = gfunct_L6PA_GMSPfID_1538.FirstOrDefault().USR_Device_AccountCodeID ,
		AccountCode_Value = gfunct_L6PA_GMSPfID_1538.FirstOrDefault().AccountCode_Value ,
		Salutation_General = gfunct_L6PA_GMSPfID_1538.FirstOrDefault().Salutation_General ,
		FirstName = gfunct_L6PA_GMSPfID_1538.FirstOrDefault().FirstName ,
		LastName = gfunct_L6PA_GMSPfID_1538.FirstOrDefault().LastName ,
		PrimaryEmail = gfunct_L6PA_GMSPfID_1538.FirstOrDefault().PrimaryEmail ,
		HealthInsurance_Number = gfunct_L6PA_GMSPfID_1538.FirstOrDefault().HealthInsurance_Number ,
		PatientComment = gfunct_L6PA_GMSPfID_1538.FirstOrDefault().PatientComment ,
		HasFulfilledParticipationPolicyRequirements = gfunct_L6PA_GMSPfID_1538.FirstOrDefault().HasFulfilledParticipationPolicyRequirements ,
		CMN_PER_PersonInfoID = gfunct_L6PA_GMSPfID_1538.FirstOrDefault().CMN_PER_PersonInfoID ,
		CMN_BPT_BusinessParticipantID = gfunct_L6PA_GMSPfID_1538.FirstOrDefault().CMN_BPT_BusinessParticipantID ,
		HEC_Patient_HealthInsurancesID = gfunct_L6PA_GMSPfID_1538.FirstOrDefault().HEC_Patient_HealthInsurancesID ,
		HEC_PatientID = gfunct_L6PA_GMSPfID_1538.Key.HEC_PatientID ,
		HEC_STU_Study_ParticipatingPatientID = gfunct_L6PA_GMSPfID_1538.FirstOrDefault().HEC_STU_Study_ParticipatingPatientID ,
		Participation_DateOfSigning = gfunct_L6PA_GMSPfID_1538.FirstOrDefault().Participation_DateOfSigning ,
		Participation_Comment = gfunct_L6PA_GMSPfID_1538.FirstOrDefault().Participation_Comment ,

		Contacts = 
		(
			from el_Contacts in gfunct_L6PA_GMSPfID_1538.Where(element => !EqualsDefaultValue(element.CMN_PER_CommunicationContactID)).ToArray()
			...
			select new L6PA_GMSPfID_1538_Contact
			{     
		...
		Addresses = 
		(
			from el_Addresses in gfunct_L6PA_GMSPfID_1538.Where(element => !EqualsDefaultValue(element.CMN_AddressID)).ToArray()
			...
			select new L6PA_GMSPfID_1538_Address
			{     
	...
	[Serializable]
	public class FR_L6PA_GMSPfID_1538 : FR_Base
	{
		public L6PA_GMSPfID_1538 Result	{ get; set; }

		public FR_L6PA_GMSPfID_1538() : base() {}

		public FR_L6PA_GMSPfID_1538(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass P_L6PA_GMSPfID_1538 for attribute P_L6PA_GMSPfID_1538
		[DataContract]
		public class P_L6PA_GMSPfID_1538 
		{
		...
		#endregion
		#region SClass L6PA_GMSPfID_1538 for attribute L6PA_GMSPfID_1538
		[DataContract]
		public class L6PA_GMSPfID_1538 
		{
			[DataMember]
			public L6PA_GMSPfID_1538_Contact[] Contacts { get; set; }
			[DataMember]
			public L6PA_GMSPfID_1538_Address[] Addresses { get; set; }
		...
		#endregion
		#region SClass L6PA_GMSPfID_1538_Contact for attribute Contacts
		[DataContract]
		public class L6PA_GMSPfID_1538_Contact 
		{
			//Standard type parameters
			[DataMember]
		...
		#endregion
		#region SClass L6PA_GMSPfID_1538_Address for attribute Addresses
		[DataContract]
		public class L6PA_GMSPfID_1538_Address 
		{
			//Standard type parameters
			[DataMember]
...
[OperationContract]
FR_L6PA_GMSPfID_1538 cls_Get_MS_Patients_For_ID(,P_L6PA_GMSPfID_1538 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_L6PA_GMSPfID_1538 invocationResult = cls_Get_MS_Patients_For_ID.Invoke(connectionString,P_L6PA_GMSPfID_1538 Parameter,securityTicket);
...
var parameter = new CL6_MS_Patient.Atomic.Retrieval.P_L6PA_GMSPfID_1538();

/* 
 * Generated on 7/22/2013 4:40:08 PM
...
namespace CL6_MS_Patient.Atomic.Retrieval
{
    ...
    /// var result = cls_Get_MS_Patients_For_Tenant.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Get_MS_Patients_For_Tenant
	{
		public static readonly int QueryTimeout = 60;

		#region Method Execution
		protected static FR_L6PA_GMSPfT_1634_Array Execute(DbConnection Connection,DbTransaction Transaction,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			var returnStatus = new FR_L6PA_GMSPfT_1634_Array();

			DbCommand command = Connection.CreateCommand();
			command.Connection = Connection;
			command.Transaction = Transaction;
			var commandLocation = "CL6_MS_Patient.Atomic.Retrieval.SQL.cls_Get_MS_Patients_For_Tenant.sql";
			command.CommandText = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream(commandLocation)).ReadToEnd();
			CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command,"ticket", securityTicket);
			command.CommandTimeout = QueryTimeout;

			List<L6PA_GMSPfT_1634_raw> results = new List<L6PA_GMSPfT_1634_raw>();
			...
			try
			{
				...
				while(reader.Read())
				{
					L6PA_GMSPfT_1634_raw resultItem = new L6PA_GMSPfT_1634_raw();
			...
			{
				reader.Close();
				throw new Exception("Exception occured durng data retrieval in method cls_Get_MS_Patients_For_Tenant",ex);
			}
			reader.Close();
			//Load all the dictionaries from the datatables
			loader.Load();

			returnStatus.Result = L6PA_GMSPfT_1634_raw.Convert(results).ToArray();
			return returnStatus;
		}
		#endregion
		...
		///<summary>
		public static FR_L6PA_GMSPfT_1634_Array Invoke(string ConnectionString,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L6PA_GMSPfT_1634_Array Invoke(DbConnection Connection,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L6PA_GMSPfT_1634_Array Invoke(DbConnection Connection, DbTransaction Transaction,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L6PA_GMSPfT_1634_Array Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L6PA_GMSPfT_1634_Array functionReturn = new FR_L6PA_GMSPfT_1634_Array();
			try
			{
			...
			catch (Exception ex)
			{
				...
				throw new Exception("Exception occured in method cls_Get_MS_Patients_For_Tenant",ex);
			}
	...
	[Serializable]
	public class L6PA_GMSPfT_1634_raw 
	{
		...
		public static L6PA_GMSPfT_1634[] Convert(List<L6PA_GMSPfT_1634_raw> rawResult)
		{	
		    var gfunct_rawResult = rawResult;
			var groupResult = from el_L6PA_GMSPfT_1634 in gfunct_rawResult.Where(element => !EqualsDefaultValue(element.HEC_PatientID)).ToArray()
	group el_L6PA_GMSPfT_1634 by new 
	{ 
		el_L6PA_GMSPfT_1634.HEC_PatientID,

	}
	into gfunct_L6PA_GMSPfT_1634
	select new L6PA_GMSPfT_1634
	{     
		USR_AccountID = gfunct_L6PA_GMSPfT_1634.FirstOrDefault().USR_AccountID ,
		USR_Device_AccountCodeID = gfunct_L6PA_GMSPfT_1634.FirstOrDefault().USR_Device_AccountCodeID ,
		AccountCode_Value = gfunct_L6PA_GMSPfT_1634.FirstOrDefault().AccountCode_Value ,
		Salutation_General = gfunct_L6PA_GMSPfT_1634.FirstOrDefault().Salutation_General ,
		FirstName = gfunct_L6PA_GMSPfT_1634.FirstOrDefault().FirstName ,
		LastName = gfunct_L6PA_GMSPfT_1634.FirstOrDefault().LastName ,
		PrimaryEmail = gfunct_L6PA_GMSPfT_1634.FirstOrDefault().PrimaryEmail ,
		HealthInsurance_Number = gfunct_L6PA_GMSPfT_1634.FirstOrDefault().HealthInsurance_Number ,
		PatientComment = gfunct_L6PA_GMSPfT_1634.FirstOrDefault().PatientComment ,
		HasFulfilledParticipationPolicyRequirements = gfunct_L6PA_GMSPfT_1634.FirstOrDefault().HasFulfilledParticipationPolicyRequirements ,
		CMN_PER_PersonInfoID = gfunct_L6PA_GMSPfT_1634.FirstOrDefault().CMN_PER_PersonInfoID ,
		CMN_BPT_BusinessParticipantID = gfunct_L6PA_GMSPfT_1634.FirstOrDefault().CMN_BPT_BusinessParticipantID ,
		HEC_Patient_HealthInsurancesID = gfunct_L6PA_GMSPfT_1634.FirstOrDefault().HEC_Patient_HealthInsurancesID ,
		HEC_PatientID = gfunct_L6PA_GMSPfT_1634.Key.HEC_PatientID ,
		HEC_STU_Study_ParticipatingPatientID = gfunct_L6PA_GMSPfT_1634.FirstOrDefault().HEC_STU_Study_ParticipatingPatientID ,
		Participation_DateOfSigning = gfunct_L6PA_GMSPfT_1634.FirstOrDefault().Participation_DateOfSigning ,
		Participation_Comment = gfunct_L6PA_GMSPfT_1634.FirstOrDefault().Participation_Comment ,

		Contacts = 
		(
			from el_Contacts in gfunct_L6PA_GMSPfT_1634.Where(element => !EqualsDefaultValue(element.CMN_PER_CommunicationContactID)).ToArray()
			...
			select new L6PA_GMSPfT_1634_Contact
			{     
		...
		Addresses = 
		(
			from el_Addresses in gfunct_L6PA_GMSPfT_1634.Where(element => !EqualsDefaultValue(element.CMN_AddressID)).ToArray()
			...
			select new L6PA_GMSPfT_1634_Address
			{     
	...
	[Serializable]
	public class FR_L6PA_GMSPfT_1634_Array : FR_Base
	{
		public L6PA_GMSPfT_1634[] Result	{ get; set; } 
		public FR_L6PA_GMSPfT_1634_Array() : base() {}

		public FR_L6PA_GMSPfT_1634_Array(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass L6PA_GMSPfT_1634 for attribute L6PA_GMSPfT_1634
		[DataContract]
		public class L6PA_GMSPfT_1634 
		{
			[DataMember]
			public L6PA_GMSPfT_1634_Contact[] Contacts { get; set; }
			[DataMember]
			public L6PA_GMSPfT_1634_Address[] Addresses { get; set; }
		...
		#endregion
		#region SClass L6PA_GMSPfT_1634_Contact for attribute Contacts
		[DataContract]
		public class L6PA_GMSPfT_1634_Contact 
		{
			//Standard type parameters
			[DataMember]
		...
		#endregion
		#region SClass L6PA_GMSPfT_1634_Address for attribute Addresses
		[DataContract]
		public class L6PA_GMSPfT_1634_Address 
		{
			//Standard type parameters
			[DataMember]
...
[OperationContract]
FR_L6PA_GMSPfT_1634_Array cls_Get_MS_Patients_For_Tenant(string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_L6PA_GMSPfT_1634_Array invocationResult = cls_Get_MS_Patients_For_Tenant.Invoke(connectionString,securityTicket);

/* 
 * Generated on 1/15/2015 10:50:25
...
namespace CL2_Warehouse.Atomic.Retrieval
{
    ...
    /// var result = cls_Get_Warehouse_for_ID_or_TenantID.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Get_Warehouse_for_ID_or_TenantID
	{
		...
		///<summary>
		public static FR_L2WH_GWHfIoT_1442_Array Invoke(string ConnectionString,P_L2WH_GWHfIoT_1442 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L2WH_GWHfIoT_1442_Array Invoke(DbConnection Connection,P_L2WH_GWHfIoT_1442 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L2WH_GWHfIoT_1442_Array Invoke(DbConnection Connection, DbTransaction Transaction,P_L2WH_GWHfIoT_1442 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L2WH_GWHfIoT_1442_Array Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L2WH_GWHfIoT_1442 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L2WH_GWHfIoT_1442_Array functionReturn = new FR_L2WH_GWHfIoT_1442_Array();
			try
			{
			...
			catch (Exception ex)
			{
				...
				throw new Exception("Exception occured in method cls_Get_Warehouse_for_ID_or_TenantID",ex);
			}
	...
	[Serializable]
	public class FR_L2WH_GWHfIoT_1442_Array : FR_Base
	{
		public L2WH_GWHfIoT_1442[] Result	{ get; set; } 
		public FR_L2WH_GWHfIoT_1442_Array() : base() {}

		public FR_L2WH_GWHfIoT_1442_Array(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass P_L2WH_GWHfIoT_1442 for attribute P_L2WH_GWHfIoT_1442
		[DataContract]
		public class P_L2WH_GWHfIoT_1442 
		{
		...
		#endregion
		#region SClass L2WH_GWHfIoT_1442 for attribute L2WH_GWHfIoT_1442
		[DataContract]
		public class L2WH_GWHfIoT_1442 
		{
			//Standard type parameters
			[DataMember]
...
[OperationContract]
FR_L2WH_GWHfIoT_1442_Array cls_Get_Warehouse_for_ID_or_TenantID(,P_L2WH_GWHfIoT_1442 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_L2WH_GWHfIoT_1442_Array invocationResult = cls_Get_Warehouse_for_ID_or_TenantID.Invoke(connectionString,P_L2WH_GWHfIoT_1442 Parameter,securityTicket);
...
var parameter = new CL2_Warehouse.Atomic.Retrieval.P_L2WH_GWHfIoT_1442();

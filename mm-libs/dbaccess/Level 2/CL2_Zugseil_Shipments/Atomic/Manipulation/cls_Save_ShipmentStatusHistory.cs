/* 
 * Generated on 3/12/2015 1:15:53 PM
...
namespace CL2_Zugseil_Shipments.Atomic.Manipulation
{
	/// <summary>
    /// 
    /// <example>
	...
	public class cls_Save_ShipmentStatusHistory
	{
		...
		///<summary>
		public static FR_Guid Invoke(string ConnectionString,P_L2SH_SSSH_1313 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Guid Invoke(DbConnection Connection,P_L2SH_SSSH_1313 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Guid Invoke(DbConnection Connection, DbTransaction Transaction,P_L2SH_SSSH_1313 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_Guid Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L2SH_SSSH_1313 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
	...
	#region Support Classes
		#region SClass P_L2SH_SSSH_1313 for attribute P_L2SH_SSSH_1313
		[DataContract]
		public class P_L2SH_SSSH_1313 
		{
...
[OperationContract]
FR_Guid cls_Save_ShipmentStatusHistory(,P_L2SH_SSSH_1313 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_Guid invocationResult = cls_Save_ShipmentStatusHistory.Invoke(connectionString,P_L2SH_SSSH_1313 Parameter,securityTicket);
...
var parameter = new CL2_Zugseil_Shipments.Atomic.Manipulation.P_L2SH_SSSH_1313();

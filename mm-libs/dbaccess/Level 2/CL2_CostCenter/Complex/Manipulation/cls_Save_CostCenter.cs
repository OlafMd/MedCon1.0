/* 
 * Generated on 4/11/2013 05:02:43
...
namespace CL2_CostCenter.Complex.Manipulation
{
    ...
    /// var result = cls_Save_CostCenter.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Save_CostCenter
	{
		...
		///<summary>
		public static FR_Guid Invoke(DbConnection Connection,P_L2CC_SCC_1356 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
	...
	#region Support Classes
		#region SClass P_L2CC_SCC_1356 for attribute P_L2CC_SCC_1356
		[DataContract]
		public class P_L2CC_SCC_1356 
		{
...
[OperationContract]
FR_Guid cls_Save_CostCenter(,P_L2CC_SCC_1356 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_Guid invocationResult = cls_Save_CostCenter.Invoke(connectionString,P_L2CC_SCC_1356 Parameter,securityTicket);
...
var parameter = new CL2_CostCenter.Complex.Manipulation.P_L2CC_SCC_1356();

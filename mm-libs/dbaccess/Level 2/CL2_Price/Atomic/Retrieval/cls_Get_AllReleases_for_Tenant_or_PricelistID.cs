/* 
 * Generated on 11/29/2013 9:29:35 AM
...
namespace CL2_Price.Atomic.Retrieval
{
    ...
    /// var result = cls_Get_AllReleases_for_Tenant_or_PricelistID.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Get_AllReleases_for_Tenant_or_PricelistID
	{
		...
		protected static FR_L2PL_GARfToPID_1730_Array Execute(DbConnection Connection,DbTransaction Transaction,P_L2PL_GARfToPID_1730 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			...
			var commandLocation = "CL2_Price.Atomic.Retrieval.SQL.cls_Get_AllReleases_for_Tenant_or_PricelistID.sql";
			...
			try
			{
				...
				while(reader.Read())
				{
					...
					//1:Parameter PricelistRelease_ValidFrom of type String
					resultItem.PricelistRelease_ValidFrom = reader.GetString(1);
					//2:Parameter PricelistRelease_ValidTo of type String
					resultItem.PricelistRelease_ValidTo = reader.GetString(2);
			...
			{
				reader.Close();
				throw new Exception("Exception occured durng data retrieval in method cls_Get_AllReleases_for_Tenant_or_PricelistID",ex);
			}
			reader.Close();
		...
		protected static FR_L2PL_GARfToPID_1730_Array Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L2PL_GARfToPID_1730 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			...
			catch (Exception ex)
			{
				...
				throw new Exception("Exception occured in method cls_Get_AllReleases_for_Tenant_or_PricelistID",ex);
			}
...
[OperationContract]
FR_L2PL_GARfToPID_1730_Array cls_Get_AllReleases_for_Tenant_or_PricelistID(,P_L2PL_GARfToPID_1730 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_L2PL_GARfToPID_1730_Array invocationResult = cls_Get_AllReleases_for_Tenant_or_PricelistID.Invoke(connectionString,P_L2PL_GARfToPID_1730 Parameter,securityTicket);

/* 
 * Generated on 3/12/2014 2:34:27 PM
...
namespace CL2_Catalog.Atomic.Manipulation
{
	...
	public class cls_Save_CMN_BPT_CTM_CatalogProductExtensionRequest
	{
		...
		///<summary>
		public static FR_Guid Invoke(string ConnectionString,P_L2CA_SCPER_1105 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Guid Invoke(DbConnection Connection,P_L2CA_SCPER_1105 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Guid Invoke(DbConnection Connection, DbTransaction Transaction,P_L2CA_SCPER_1105 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_Guid Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L2CA_SCPER_1105 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
	...
	#region Support Classes
		#region SClass P_L2CA_SCPER_1105 for attribute P_L2CA_SCPER_1105
		[DataContract]
		public class P_L2CA_SCPER_1105 
		{
...
[OperationContract]
FR_Guid cls_Save_CMN_BPT_CTM_CatalogProductExtensionRequest(,P_L2CA_SCPER_1105 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_Guid invocationResult = cls_Save_CMN_BPT_CTM_CatalogProductExtensionRequest.Invoke(connectionString,P_L2CA_SCPER_1105 Parameter,securityTicket);
...
var parameter = new CL2_Catalog.Atomic.Manipulation.P_L2CA_SCPER_1105();

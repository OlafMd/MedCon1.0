/* 
 * Generated on 21-Oct-13 15:02:07
...
namespace CL5_Plannico_Projects.Atomic.Manipulation
{
    ...
    /// var result = cls_Delete_Project.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Delete_Project
	{
		...
		///<summary>
		public static FR_Guid Invoke(string ConnectionString,P_L5PR_DPR_1501 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Guid Invoke(DbConnection Connection,P_L5PR_DPR_1501 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Guid Invoke(DbConnection Connection, DbTransaction Transaction,P_L5PR_DPR_1501 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_Guid Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L5PR_DPR_1501 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{

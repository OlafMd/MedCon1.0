/* 
 * Generated on 24.10.2014 13:52:32
...
namespace CL5_MyHealthClub_TimeAndException.Atomic.Retrieval
{
	...
	public class cls_Get_Staff_Available_for_WebBooking
	{
		...
		///<summary>
		public static FR_L5TE_GSAfWB_1426_Array Invoke(string ConnectionString,P_L5TE_GSAfWB_1426 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L5TE_GSAfWB_1426_Array Invoke(DbConnection Connection,P_L5TE_GSAfWB_1426 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L5TE_GSAfWB_1426_Array Invoke(DbConnection Connection, DbTransaction Transaction,P_L5TE_GSAfWB_1426 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
	...
	[Serializable]
	public class L5TE_GSAfWB_1426_raw 
	{
		...
		public static L5TE_GSAfWB_1426[] Convert(List<L5TE_GSAfWB_1426_raw> rawResult)
		{	
		    var gfunct_rawResult = rawResult;
			var groupResult = from el_L5TE_GSAfWB_1426 in gfunct_rawResult.Where(element => !EqualsDefaultValue(element.CMN_BPT_EMP_EmployeeID)).ToArray()
	group el_L5TE_GSAfWB_1426 by new 
	{ 
		el_L5TE_GSAfWB_1426.CMN_BPT_EMP_EmployeeID,

	}
	into gfunct_L5TE_GSAfWB_1426
	select new L5TE_GSAfWB_1426
	{     
		CMN_BPT_EMP_EmployeeID = gfunct_L5TE_GSAfWB_1426.Key.CMN_BPT_EMP_EmployeeID ,
		BusinessParticipantID = gfunct_L5TE_GSAfWB_1426.FirstOrDefault().BusinessParticipantID ,

		Offices = 
		(
			from el_Offices in gfunct_L5TE_GSAfWB_1426.Where(element => !EqualsDefaultValue(element.OfficeID)).ToArray()
		...
		Skills = 
		(
			from el_Skills in gfunct_L5TE_GSAfWB_1426.Where(element => !EqualsDefaultValue(element.SkillID)).ToArray()
		...
		Professions = 
		(
			from el_Professions in gfunct_L5TE_GSAfWB_1426.Where(element => !EqualsDefaultValue(element.Profession_RefID)).ToArray()
			...
			select new L5TE_GSAfWB_1426_Profession
			{     
		...
		Availability = 
		(
			from el_Availability in gfunct_L5TE_GSAfWB_1426.Where(element => !EqualsDefaultValue(element.CMN_BPT_BusinessParticipant_AvailabilityID)).ToArray()
			...
			select new L5TE_GSAfWB_1426_Availability
			{     
	...
	[Serializable]
	public class FR_L5TE_GSAfWB_1426_Array : FR_Base
	{
		public L5TE_GSAfWB_1426[] Result	{ get; set; } 
		public FR_L5TE_GSAfWB_1426_Array() : base() {}

		public FR_L5TE_GSAfWB_1426_Array(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass P_L5TE_GSAfWB_1426 for attribute P_L5TE_GSAfWB_1426
		[DataContract]
		public class P_L5TE_GSAfWB_1426 
		{
		...
		#endregion
		#region SClass L5TE_GSAfWB_1426 for attribute L5TE_GSAfWB_1426
		[DataContract]
		public class L5TE_GSAfWB_1426 
		{
			[DataMember]
			...
			[DataMember]
			public L5TE_GSAfWB_1426_Profession[] Professions { get; set; }
			[DataMember]
			public L5TE_GSAfWB_1426_Availability[] Availability { get; set; }
		...
		#endregion
		#region SClass L5TE_GSAfWB_1426_Profession for attribute Professions
		[DataContract]
		public class L5TE_GSAfWB_1426_Profession 
		{
			//Standard type parameters
			[DataMember]
		...
		#endregion
		#region SClass L5TE_GSAfWB_1426_Availability for attribute Availability
		[DataContract]
		public class L5TE_GSAfWB_1426_Availability 
		{
			//Standard type parameters
			[DataMember]
...
[OperationContract]
FR_L5TE_GSAfWB_1426_Array cls_Get_Staff_Available_for_WebBooking(,P_L5TE_GSAfWB_1426 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_L5TE_GSAfWB_1426_Array invocationResult = cls_Get_Staff_Available_for_WebBooking.Invoke(connectionString,P_L5TE_GSAfWB_1426 Parameter,securityTicket);
...
var parameter = new CL5_MyHealthClub_TimeAndException.Atomic.Retrieval.P_L5TE_GSAfWB_1426();

...
From
  ...
  cmn_cal_events On cmn_cal_ava_dates.CMN_CAL_Event_RefID =
    cmn_cal_events.CMN_CAL_EventID And cmn_cal_events.IsDeleted = 0 And cmn_cal_events.Tenant_RefID = @TenantID
  Left Join
...
Where
  ...
  pps_dev_device_instance_availabilities.DeviceInstance_RefID =
  @DeviceInstanceID

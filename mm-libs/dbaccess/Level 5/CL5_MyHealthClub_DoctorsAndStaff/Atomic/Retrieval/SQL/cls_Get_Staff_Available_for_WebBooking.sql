	...
	From
	  ...
	  cmn_cal_ava_availabilities On cmn_cal_ava_availabilities.IsDeleted = 0 And
	    cmn_cal_ava_availabilities.Tenant_RefID = @TenantID And
	    cmn_cal_ava_availabilities.IsAvailabilityExclusionItem = 0 And
	    cmn_bpt_businessparticipant_availabilities.CMN_CAL_AVA_Availability_RefID =

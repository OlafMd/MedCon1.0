/* 
 * Generated on 4/25/2014 12:00:10 PM
...
namespace CL5_APOAdmin_Catalogs.Complex.Manipulation
{
	...
	public class cls_Publish_NewCatalogVersion
	{
		...
		///<summary>
		public static FR_L5CA_PNCV_1603 Invoke(string ConnectionString,P_L5CA_PNCV_1603 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L5CA_PNCV_1603 Invoke(DbConnection Connection,P_L5CA_PNCV_1603 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L5CA_PNCV_1603 Invoke(DbConnection Connection, DbTransaction Transaction,P_L5CA_PNCV_1603 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L5CA_PNCV_1603 Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L5CA_PNCV_1603 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L5CA_PNCV_1603 functionReturn = new FR_L5CA_PNCV_1603();
			try
			{
	...
	[Serializable]
	public class FR_L5CA_PNCV_1603 : FR_Base
	{
		public L5CA_PNCV_1603 Result	{ get; set; }

		public FR_L5CA_PNCV_1603() : base() {}

		public FR_L5CA_PNCV_1603(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass P_L5CA_PNCV_1603 for attribute P_L5CA_PNCV_1603
		[DataContract]
		public class P_L5CA_PNCV_1603 
		{
		...
		#endregion
		#region SClass L5CA_PNCV_1603 for attribute L5CA_PNCV_1603
		[DataContract]
		public class L5CA_PNCV_1603 
		{
			//Standard type parameters
			[DataMember]
...
[OperationContract]
FR_L5CA_PNCV_1603 cls_Publish_NewCatalogVersion(,P_L5CA_PNCV_1603 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_L5CA_PNCV_1603 invocationResult = cls_Publish_NewCatalogVersion.Invoke(connectionString,P_L5CA_PNCV_1603 Parameter,securityTicket);
...
var parameter = new CL5_APOAdmin_Catalogs.Complex.Manipulation.P_L5CA_PNCV_1603();

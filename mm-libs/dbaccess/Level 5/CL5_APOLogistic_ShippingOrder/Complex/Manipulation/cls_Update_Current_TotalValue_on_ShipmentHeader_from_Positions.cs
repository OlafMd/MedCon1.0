/* 
 * Generated on 4/1/2014 3:58:53 PM
...
namespace CL5_APOLogistic_ShippingOrder.Complex.Manipulation
{
    ...
    /// var result = cls_Update_Current_TotalValue_on_ShipmentHeader_from_Positions.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Update_Current_TotalValue_on_ShipmentHeader_from_Positions
	{
		...
		///<summary>
		public static FR_Guid Invoke(DbConnection Connection,P_L5SO_UCTVoSHfP_1549 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
	...
	#region Support Classes
		#region SClass P_L5SO_UCTVoSHfP_1549 for attribute P_L5SO_UCTVoSHfP_1549
		[DataContract]
		public class P_L5SO_UCTVoSHfP_1549 
		{
...
[OperationContract]
FR_Guid cls_Update_Current_TotalValue_on_ShipmentHeader_from_Positions(,P_L5SO_UCTVoSHfP_1549 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_Guid invocationResult = cls_Update_Current_TotalValue_on_ShipmentHeader_from_Positions.Invoke(connectionString,P_L5SO_UCTVoSHfP_1549 Parameter,securityTicket);
...
var parameter = new CL5_APOLogistic_ShippingOrder.Complex.Manipulation.P_L5SO_UCTVoSHfP_1549();

/* 
 * Generated on 28-Nov-13 14:06:07
...
namespace CL5_Plannico_Religions.Complex.Retrieval
{
    ...
    /// var result = cls_Get_Religion_For_Country.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Get_Religion_For_Country
	{
		...
		///<summary>
		public static FR_L5RL_GRFC_1352 Invoke(string ConnectionString,P_L5RL_GRFC_1352 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L5RL_GRFC_1352 Invoke(DbConnection Connection,P_L5RL_GRFC_1352 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L5RL_GRFC_1352 Invoke(DbConnection Connection, DbTransaction Transaction,P_L5RL_GRFC_1352 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L5RL_GRFC_1352 Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L5RL_GRFC_1352 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L5RL_GRFC_1352 functionReturn = new FR_L5RL_GRFC_1352();
			try
			{
	...
	[Serializable]
	public class FR_L5RL_GRFC_1352 : FR_Base
	{
		public L5RL_GRFC_1352 Result	{ get; set; }

		public FR_L5RL_GRFC_1352() : base() {}

		public FR_L5RL_GRFC_1352(Exception ex): base(ex) {}

/* 
 * Generated on 7/4/2013 3:28:41 PM
...
{
	[DataContract]
	public class cls_Get_Practices_For_Tenant
	{
		...
		///<summary>
		public static FR_L3MP_GPRAFT_1108_Array Invoke(string ConnectionString,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L3MP_GPRAFT_1108_Array Invoke(DbConnection Connection,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L3MP_GPRAFT_1108_Array Invoke(DbConnection Connection, DbTransaction Transaction,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L3MP_GPRAFT_1108_Array Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L3MP_GPRAFT_1108_Array functionReturn = new FR_L3MP_GPRAFT_1108_Array();
			try
			{
	...
	[Serializable]
	public class FR_L3MP_GPRAFT_1108_Array : FR_Base
	{
		public L3MP_GPRAFT_1108[] Result	{ get; set; } 
		public FR_L3MP_GPRAFT_1108_Array() : base() {}

		public FR_L3MP_GPRAFT_1108_Array(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass L3MP_GPRAFT_1108 for attribute L3MP_GPRAFT_1108
		[DataContract]
		public class L3MP_GPRAFT_1108 
		{

/* 
 * Generated on 8/26/2013 11:30:07 AM
...
namespace CL5_VacationPlanner_Contract.Atomic.Manipulation
{
    ...
    /// var result = cls_Save_Employee_AbsenceReason_TimeframeStatistic.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Save_Employee_AbsenceReason_TimeframeStatistic
	{
		...
		///<summary>
		public static FR_Guid Invoke(string ConnectionString,P_L5EM_SEARTFS_1356 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Guid Invoke(DbConnection Connection, DbTransaction Transaction,P_L5EM_SEARTFS_1356 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
...
[OperationContract]
FR_Guid cls_Save_Employee_AbsenceReason_TimeframeStatistic(P_L5EM_SEARTFS_1356 Parameter,string sessionToken = null)
{
	 var securityTicket = ...;
	 FR_Guid result = cls_Save_Employee_AbsenceReason_TimeframeStatistic.Invoke(connectionString,P_L5EM_SEARTFS_1356 Parameter,securityTicket);
	 return result;
}
*/
...
Where
  (pps_tsk_bok_availableresourcecombinations.IsAvailable = 1 or pps_tsk_bok_availableresourcecombinations.PPS_TSK_BOK_AvailableResourceCombinationID = @CombinationID) And

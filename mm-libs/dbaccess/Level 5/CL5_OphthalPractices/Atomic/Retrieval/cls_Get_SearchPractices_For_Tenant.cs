/* 
 * Generated on 9/3/2013 11:29:33 AM
...
namespace CL5_OphthalPractices.Atomic.Retrieval
{
	/// <summary>
    /// 
    /// <example>
	/// string connectionString = ...;
    /// var result = cls_Get_SearchPractices_For_Tenant.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Get_SearchPractices_For_Tenant
	{
		...
		protected static FR_L5OP_GSPRAFT_1020_Array Execute(DbConnection Connection,DbTransaction Transaction,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			var returnStatus = new FR_L5OP_GSPRAFT_1020_Array();

			DbCommand command = Connection.CreateCommand();
			command.Connection = Connection;
			command.Transaction = Transaction;
			var commandLocation = "CL5_OphthalPractices.Atomic.Retrieval.SQL.cls_Get_SearchPractices_For_Tenant.sql";
			command.CommandText = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream(commandLocation)).ReadToEnd();
			CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command,"ticket", securityTicket);
			command.CommandTimeout = QueryTimeout;

			List<L5OP_GSPRAFT_1020> results = new List<L5OP_GSPRAFT_1020>();
			...
			try
			{
				...
				while(reader.Read())
				{
					L5OP_GSPRAFT_1020 resultItem = new L5OP_GSPRAFT_1020();
			...
			{
				reader.Close();
				throw new Exception("Exception occured durng data retrieval in method cls_Get_SearchPractices_For_Tenant",ex);
			}
			reader.Close();
		...
		///<summary>
		public static FR_L5OP_GSPRAFT_1020_Array Invoke(string ConnectionString,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L5OP_GSPRAFT_1020_Array Invoke(DbConnection Connection,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L5OP_GSPRAFT_1020_Array Invoke(DbConnection Connection, DbTransaction Transaction,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L5OP_GSPRAFT_1020_Array Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L5OP_GSPRAFT_1020_Array functionReturn = new FR_L5OP_GSPRAFT_1020_Array();
			try
			{
			...
			catch (Exception ex)
			{
				...
				throw new Exception("Exception occured in method cls_Get_SearchPractices_For_Tenant",ex);
			}
	...
	[Serializable]
	public class FR_L5OP_GSPRAFT_1020_Array : FR_Base
	{
		public L5OP_GSPRAFT_1020[] Result	{ get; set; } 
		public FR_L5OP_GSPRAFT_1020_Array() : base() {}

		public FR_L5OP_GSPRAFT_1020_Array(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass L5OP_GSPRAFT_1020 for attribute L5OP_GSPRAFT_1020
		[DataContract]
		public class L5OP_GSPRAFT_1020 
		{
...
[OperationContract]
FR_L5OP_GSPRAFT_1020_Array cls_Get_SearchPractices_For_Tenant(string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_L5OP_GSPRAFT_1020_Array invocationResult = cls_Get_SearchPractices_For_Tenant.Invoke(connectionString,securityTicket);

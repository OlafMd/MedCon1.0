/* 
 * Generated on 15/04/2014 15:39:18
...
namespace CL5_Plannico_DailyWorkSchedules.Complex.Retrieval
{
    ...
    /// var result = cls_Get_DailyWorkSchedules_WithDetails_For_Date.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Get_DailyWorkSchedules_WithDetails_For_Date
	{
		public static readonly int QueryTimeout = 60;

		#region Method Execution
		protected static FR_L5DWS_GDWSWDFT_0946_Array Execute(DbConnection Connection,DbTransaction Transaction,P_L5DWS_GDWSWDFT_0946 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			#region UserCode 
            var returnValue = new FR_L5DWS_GDWSWDFT_0946_Array();
			//Put your code here
            ...
            scheduleQuery.WorkSheduleDate = Parameter.WorkSheduleDate.Date;
            ...
            foreach (var workSchedule in workSechedules)
            {
                ...
                param.currentDate = Parameter.WorkSheduleDate.Date;                
 
                scheduleList.Add(resultItem);
            }
            returnValue.Result = scheduleList.ToArray();
			return returnValue;
			#endregion UserCode
		}
		#endregion
		...
		///<summary>
		public static FR_L5DWS_GDWSWDFT_0946_Array Invoke(string ConnectionString,P_L5DWS_GDWSWDFT_0946 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L5DWS_GDWSWDFT_0946_Array Invoke(DbConnection Connection,P_L5DWS_GDWSWDFT_0946 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L5DWS_GDWSWDFT_0946_Array Invoke(DbConnection Connection, DbTransaction Transaction,P_L5DWS_GDWSWDFT_0946 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L5DWS_GDWSWDFT_0946_Array Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L5DWS_GDWSWDFT_0946 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L5DWS_GDWSWDFT_0946_Array functionReturn = new FR_L5DWS_GDWSWDFT_0946_Array();
			try
			{
			...
			catch (Exception ex)
			{
				...
				throw new Exception("Exception occured in method cls_Get_DailyWorkSchedules_WithDetails_For_Date",ex);
			}
	...
	[Serializable]
	public class FR_L5DWS_GDWSWDFT_0946_Array : FR_Base
	{
		public L5DWS_GDWSWDFT_0946[] Result	{ get; set; } 
		public FR_L5DWS_GDWSWDFT_0946_Array() : base() {}

		public FR_L5DWS_GDWSWDFT_0946_Array(Exception ex): base(ex) {}
...
[OperationContract]
FR_L5DWS_GDWSWDFT_0946_Array cls_Get_DailyWorkSchedules_WithDetails_For_Date(,P_L5DWS_GDWSWDFT_0946 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_L5DWS_GDWSWDFT_0946_Array invocationResult = cls_Get_DailyWorkSchedules_WithDetails_For_Date.Invoke(connectionString,P_L5DWS_GDWSWDFT_0946 Parameter,securityTicket);
...
var parameter = new CL5_Plannico_DailyWorkSchedules.Complex.Retrieval.P_L5DWS_GDWSWDFT_0946();

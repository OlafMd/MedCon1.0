/* 
 * Generated on 09-May-14 12:12:32
...
namespace CL5_Plannico_DailyWorkSchedules.Complex.Retrieval
{
    ...
    /// var result = cls_Get_EffectiveWorkTimes_For_Date.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Get_EffectiveWorkTimes_For_Date
	{
		public static readonly int QueryTimeout = 60;

		#region Method Execution
		protected static FR_L5DWS_GEWTFD_1648_Array Execute(DbConnection Connection,DbTransaction Transaction,P_L5DWS_GEWTFD_1648 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			#region UserCode 
            var returnValue = new FR_L5DWS_GEWTFD_1648_Array();
            ...
            var effectiveWorkTimeHeaders = ORM_CMN_BPT_EMP_EffectiveWorkTime_Header.Query.Search(Connection, Transaction, effectiveWorkTimeHeaderQuery);

            List<L5DWS_GEWTFD_1648> resultList = new List<L5DWS_GEWTFD_1648>();

            foreach (var header in effectiveWorkTimeHeaders)
            {
		...
		///<summary>
		public static FR_L5DWS_GEWTFD_1648_Array Invoke(string ConnectionString,P_L5DWS_GEWTFD_1648 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L5DWS_GEWTFD_1648_Array Invoke(DbConnection Connection,P_L5DWS_GEWTFD_1648 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L5DWS_GEWTFD_1648_Array Invoke(DbConnection Connection, DbTransaction Transaction,P_L5DWS_GEWTFD_1648 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L5DWS_GEWTFD_1648_Array Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L5DWS_GEWTFD_1648 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L5DWS_GEWTFD_1648_Array functionReturn = new FR_L5DWS_GEWTFD_1648_Array();
			try
			{
	...
	[Serializable]
	public class FR_L5DWS_GEWTFD_1648_Array : FR_Base
	{
		public L5DWS_GEWTFD_1648[] Result	{ get; set; } 
		public FR_L5DWS_GEWTFD_1648_Array() : base() {}

		public FR_L5DWS_GEWTFD_1648_Array(Exception ex): base(ex) {}

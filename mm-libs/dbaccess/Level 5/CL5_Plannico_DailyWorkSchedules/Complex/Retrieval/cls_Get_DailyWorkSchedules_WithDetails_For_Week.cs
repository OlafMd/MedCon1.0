/* 
 * Generated on 11-Apr-14 10:38:02
...
namespace CL5_Plannico_DailyWorkSchedules.Complex.Retrieval
{
    ...
    /// var result = cls_Get_DailyWorkSchedules_WithDetails_For_Week.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Get_DailyWorkSchedules_WithDetails_For_Week
	{
		public static readonly int QueryTimeout = 60;

		#region Method Execution
		protected static FR_L5DWS_GDWSWDFW_1030 Execute(DbConnection Connection,DbTransaction Transaction,P_L5DWS_GDWSWDFW_1030 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			//Leave UserCode region to enable user code saving
			#region UserCode 
			var returnValue = new FR_L5DWS_GDWSWDFW_1030();
			//Put your code here
            ...
            for (var i = 0; i < 7; i++)
            {
                ...
                scheduleQuery.WorkSheduleDate = Parameter.WeekStartDate.Date.AddDays(i);
            ...
            returnValue.Result = new L5DWS_GDWSWDFW_1030();
		...
		///<summary>
		public static FR_L5DWS_GDWSWDFW_1030 Invoke(string ConnectionString,P_L5DWS_GDWSWDFW_1030 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L5DWS_GDWSWDFW_1030 Invoke(DbConnection Connection,P_L5DWS_GDWSWDFW_1030 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L5DWS_GDWSWDFW_1030 Invoke(DbConnection Connection, DbTransaction Transaction,P_L5DWS_GDWSWDFW_1030 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L5DWS_GDWSWDFW_1030 Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L5DWS_GDWSWDFW_1030 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L5DWS_GDWSWDFW_1030 functionReturn = new FR_L5DWS_GDWSWDFW_1030();
			try
			{
	...
	[Serializable]
	public class FR_L5DWS_GDWSWDFW_1030 : FR_Base
	{
		public L5DWS_GDWSWDFW_1030 Result	{ get; set; }

		public FR_L5DWS_GDWSWDFW_1030() : base() {}

		public FR_L5DWS_GDWSWDFW_1030(Exception ex): base(ex) {}

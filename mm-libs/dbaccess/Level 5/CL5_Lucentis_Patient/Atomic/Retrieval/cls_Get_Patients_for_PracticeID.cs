/* 
 * Generated on 11/14/2013 10:26:22 AM
...
namespace CL5_Lucentis_Patient.Atomic.Retrieval
{
    ...
    /// var result = cls_Get_Patients_for_PracticeID.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Get_Patients_for_PracticeID
	{
		public static readonly int QueryTimeout = 60;

		#region Method Execution
		protected static FR_L5PA_GPfP_1242_Array Execute(DbConnection Connection,DbTransaction Transaction,P_L5PA_GPfP_1242 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			var returnStatus = new FR_L5PA_GPfP_1242_Array();

			DbCommand command = Connection.CreateCommand();
			command.Connection = Connection;
			command.Transaction = Transaction;
			var commandLocation = "CL5_Lucentis_Patient.Atomic.Retrieval.SQL.cls_Get_Patients_for_PracticeID.sql";
			...
			List<L5PA_GPfP_1242_raw> results = new List<L5PA_GPfP_1242_raw>();
			...
			try
			{
				...
				while(reader.Read())
				{
					L5PA_GPfP_1242_raw resultItem = new L5PA_GPfP_1242_raw();
			...
			{
				reader.Close();
				throw new Exception("Exception occured durng data retrieval in method cls_Get_Patients_for_PracticeID",ex);
			}
			reader.Close();
			//Load all the dictionaries from the datatables
			loader.Load();

			returnStatus.Result = L5PA_GPfP_1242_raw.Convert(results).ToArray();
			return returnStatus;
		}
		#endregion
		...
		///<summary>
		public static FR_L5PA_GPfP_1242_Array Invoke(string ConnectionString,P_L5PA_GPfP_1242 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L5PA_GPfP_1242_Array Invoke(DbConnection Connection,P_L5PA_GPfP_1242 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L5PA_GPfP_1242_Array Invoke(DbConnection Connection, DbTransaction Transaction,P_L5PA_GPfP_1242 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L5PA_GPfP_1242_Array Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L5PA_GPfP_1242 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L5PA_GPfP_1242_Array functionReturn = new FR_L5PA_GPfP_1242_Array();
			try
			{
			...
			catch (Exception ex)
			{
				...
				throw new Exception("Exception occured in method cls_Get_Patients_for_PracticeID",ex);
			}
	...
	[Serializable]
	public class L5PA_GPfP_1242_raw 
	{
		...
		public static L5PA_GPfP_1242[] Convert(List<L5PA_GPfP_1242_raw> rawResult)
		{	
		    var gfunct_rawResult = rawResult;
			var groupResult = from el_L5PA_GPfP_1242 in gfunct_rawResult.Where(element => !EqualsDefaultValue(element.HEC_PatientID)).ToArray()
	group el_L5PA_GPfP_1242 by new 
	{ 
		el_L5PA_GPfP_1242.HEC_PatientID,

	}
	into gfunct_L5PA_GPfP_1242
	select new L5PA_GPfP_1242
	{     
		HEC_PatientID = gfunct_L5PA_GPfP_1242.Key.HEC_PatientID ,
		PracticeID = gfunct_L5PA_GPfP_1242.FirstOrDefault().PracticeID ,
		FirstName = gfunct_L5PA_GPfP_1242.FirstOrDefault().FirstName ,
		LastName = gfunct_L5PA_GPfP_1242.FirstOrDefault().LastName ,
		BirthDate = gfunct_L5PA_GPfP_1242.FirstOrDefault().BirthDate ,

		Treatments = 
		(
			from el_Treatments in gfunct_L5PA_GPfP_1242.Where(element => !EqualsDefaultValue(element.HEC_Patient_TreatmentID)).ToArray()
	...
	[Serializable]
	public class FR_L5PA_GPfP_1242_Array : FR_Base
	{
		public L5PA_GPfP_1242[] Result	{ get; set; } 
		public FR_L5PA_GPfP_1242_Array() : base() {}

		public FR_L5PA_GPfP_1242_Array(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass P_L5PA_GPfP_1242 for attribute P_L5PA_GPfP_1242
		[DataContract]
		public class P_L5PA_GPfP_1242 
		{
		...
		#endregion
		#region SClass L5PA_GPfP_1242 for attribute L5PA_GPfP_1242
		[DataContract]
		public class L5PA_GPfP_1242 
		{
			[DataMember]
			public L5PA_GPfP_1242a[] Treatments { get; set; }
		...
		#endregion
		#region SClass L5PA_GPfP_1242a for attribute Treatments
		[DataContract]
		public class L5PA_GPfP_1242a 
		{
			[DataMember]
			public L5PA_GPfP_1242b[] FollowUp { get; set; }
			[DataMember]
			public L5PA_GPfP_1242c[] Articles { get; set; }
		...
		#endregion
		#region SClass L5PA_GPfP_1242b for attribute FollowUp
		[DataContract]
		public class L5PA_GPfP_1242b 
		{
			//Standard type parameters
			[DataMember]
		...
		#endregion
		#region SClass L5PA_GPfP_1242c for attribute Articles
		[DataContract]
		public class L5PA_GPfP_1242c 
		{
			//Standard type parameters
			[DataMember]
...
[OperationContract]
FR_L5PA_GPfP_1242_Array cls_Get_Patients_for_PracticeID(,P_L5PA_GPfP_1242 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_L5PA_GPfP_1242_Array invocationResult = cls_Get_Patients_for_PracticeID.Invoke(connectionString,P_L5PA_GPfP_1242 Parameter,securityTicket);
...
var parameter = new CL5_Lucentis_Patient.Atomic.Retrieval.P_L5PA_GPfP_1242();

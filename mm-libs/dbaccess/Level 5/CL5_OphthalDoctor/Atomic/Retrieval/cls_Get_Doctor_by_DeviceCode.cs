/* 
 * Generated on 8/30/2013 11:22:41 AM
...
namespace CL5_OphthalDoctors.Atomic.Retrieval
{
	...
	public class cls_Get_Doctor_by_DeviceCode
	{
		...
		protected static FR_L5OD_GDDC_0928 Execute(DbConnection Connection,DbTransaction Transaction,P_L5OD_GDDC_0928 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			var returnStatus = new FR_L5OD_GDDC_0928();

			DbCommand command = Connection.CreateCommand();
			command.Connection = Connection;
			command.Transaction = Transaction;
			var commandLocation = "CL5_OphthalDoctors.Atomic.Retrieval.SQL.cls_Get_Doctor_by_DeviceCode.sql";
			...
			List<L5OD_GDDC_0928> results = new List<L5OD_GDDC_0928>();
			...
			try
			{
				...
				while(reader.Read())
				{
					L5OD_GDDC_0928 resultItem = new L5OD_GDDC_0928();
		...
		///<summary>
		public static FR_L5OD_GDDC_0928 Invoke(string ConnectionString,P_L5OD_GDDC_0928 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L5OD_GDDC_0928 Invoke(DbConnection Connection,P_L5OD_GDDC_0928 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L5OD_GDDC_0928 Invoke(DbConnection Connection, DbTransaction Transaction,P_L5OD_GDDC_0928 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L5OD_GDDC_0928 Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L5OD_GDDC_0928 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L5OD_GDDC_0928 functionReturn = new FR_L5OD_GDDC_0928();
			try
			{
	...
	[Serializable]
	public class FR_L5OD_GDDC_0928 : FR_Base
	{
		public L5OD_GDDC_0928 Result	{ get; set; }

		public FR_L5OD_GDDC_0928() : base() {}

		public FR_L5OD_GDDC_0928(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass P_L5OD_GDDC_0928 for attribute P_L5OD_GDDC_0928
		[DataContract]
		public class P_L5OD_GDDC_0928 
		{
		...
		#endregion
		#region SClass L5OD_GDDC_0928 for attribute L5OD_GDDC_0928
		[DataContract]
		public class L5OD_GDDC_0928 
		{
			//Standard type parameters
			[DataMember]
...
[OperationContract]
FR_L5OD_GDDC_0928 cls_Get_Doctor_by_DeviceCode(,P_L5OD_GDDC_0928 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_L5OD_GDDC_0928 invocationResult = cls_Get_Doctor_by_DeviceCode.Invoke(connectionString,P_L5OD_GDDC_0928 Parameter,securityTicket);
...
var parameter = new CL5_OphthalDoctors.Atomic.Retrieval.P_L5OD_GDDC_0928();

/* 
 * Generated on 1/16/2015 9:24:19 AM
...
namespace CL5_MyHealthClub_Actions.Atomic.Retrieval
{
    ...
    /// var result = cls_Get_DiagnosesStatistics_for_DoctorID.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Get_DiagnosesStatistics_for_DoctorID
	{
		...
		///<summary>
		public static FR_L5AC_GDSfDID_1214_Array Invoke(string ConnectionString,P_L5AC_GDSfDID_1214 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L5AC_GDSfDID_1214_Array Invoke(DbConnection Connection,P_L5AC_GDSfDID_1214 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L5AC_GDSfDID_1214_Array Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L5AC_GDSfDID_1214 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L5AC_GDSfDID_1214_Array functionReturn = new FR_L5AC_GDSfDID_1214_Array();
			try
			{
			...
			catch (Exception ex)
			{
				...
				throw new Exception("Exception occured in method cls_Get_DiagnosesStatistics_for_DoctorID",ex);
			}
	...
	[Serializable]
	public class FR_L5AC_GDSfDID_1214_Array : FR_Base
	{
		public L5AC_GDSfDID_1214[] Result	{ get; set; } 
		public FR_L5AC_GDSfDID_1214_Array() : base() {}

		public FR_L5AC_GDSfDID_1214_Array(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass P_L5AC_GDSfDID_1214 for attribute P_L5AC_GDSfDID_1214
		[DataContract]
		public class P_L5AC_GDSfDID_1214 
		{
		...
		#endregion
		#region SClass L5AC_GDSfDID_1214 for attribute L5AC_GDSfDID_1214
		[DataContract]
		public class L5AC_GDSfDID_1214 
		{
			//Standard type parameters
			[DataMember]
...
[OperationContract]
FR_L5AC_GDSfDID_1214_Array cls_Get_DiagnosesStatistics_for_DoctorID(,P_L5AC_GDSfDID_1214 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_L5AC_GDSfDID_1214_Array invocationResult = cls_Get_DiagnosesStatistics_for_DoctorID.Invoke(connectionString,P_L5AC_GDSfDID_1214 Parameter,securityTicket);
...
var parameter = new CL5_MyHealthClub_Actions.Atomic.Retrieval.P_L5AC_GDSfDID_1214();

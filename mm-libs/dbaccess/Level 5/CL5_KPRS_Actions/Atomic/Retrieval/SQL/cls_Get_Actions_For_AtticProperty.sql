...
From
  ...
  res_str_attic_property_availableactions On res_act_action.RES_ACT_ActionID =
    res_str_attic_property_availableactions.RES_ACT_Action_RefID
Where
  res_str_attic_property_availableactions.IsDeleted = 0 And
  res_act_action.IsDeleted = 0 And
  res_act_action.Tenant_RefID = @TenantID And
  res_act_action_version.IsDeleted = 0 And
  res_str_attic_property_availableactions.RES_STR_Attic_Property_RefID =
  @PropertyID

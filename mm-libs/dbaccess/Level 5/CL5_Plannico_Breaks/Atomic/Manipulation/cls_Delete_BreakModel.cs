/* 
 * Generated on 11/14/2013 4:18:19 PM
...
namespace CL5_Plannico_HealthInsurances.Atomic.Manipulation
{
    ...
    /// var result = cls_Delete_BreakModel.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Delete_BreakModel
	{
		...
		///<summary>
		public static FR_Base Invoke(string ConnectionString,P_L5BR_DBM_1608 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Base Invoke(DbConnection Connection,P_L5BR_DBM_1608 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Base Invoke(DbConnection Connection, DbTransaction Transaction,P_L5BR_DBM_1608 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_Base Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L5BR_DBM_1608 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			...
			catch (Exception ex)
			{
				...
				throw new Exception("Exception occured in method cls_Delete_BreakModel",ex);
			}
...
[OperationContract]
FR_Base cls_Delete_BreakModel(,P_L5BR_DBM_1608 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_Base invocationResult = cls_Delete_BreakModel.Invoke(connectionString,P_L5BR_DBM_1608 Parameter,securityTicket);
...
var parameter = new CL5_Plannico_HealthInsurances.Atomic.Manipulation.P_L5BR_DBM_1608();

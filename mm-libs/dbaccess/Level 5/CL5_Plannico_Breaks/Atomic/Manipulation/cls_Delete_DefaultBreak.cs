/* 
 * Generated on 06-Jan-14 16:36:15
...
namespace CL5_Plannico_HealthInsurances.Atomic.Manipulation
{
    ...
    /// var result = cls_Delete_DefaultBreak.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Delete_DefaultBreak
	{
		...
		///<summary>
		public static FR_Base Invoke(string ConnectionString,P_L5BR_DDB_1243 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Base Invoke(DbConnection Connection,P_L5BR_DDB_1243 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Base Invoke(DbConnection Connection, DbTransaction Transaction,P_L5BR_DDB_1243 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_Base Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L5BR_DDB_1243 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{

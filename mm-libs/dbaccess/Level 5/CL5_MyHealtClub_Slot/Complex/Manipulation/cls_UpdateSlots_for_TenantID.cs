/* 
 * Generated on 13.10.2014 13:09:32
...
namespace CL5_MyHealthClub_Slot.Complex.Manipulation
{
    ...
    /// var result = cls_UpdateSlots_for_TenantID.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_UpdateSlots_for_TenantID
	{
		...
		protected static FR_Base Execute(DbConnection Connection,DbTransaction Transaction,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
            ...
            var offices = cls_Get_AllOfficess_for_TenantID.Invoke(Connection, Transaction, securityTicket).Result;
            foreach (var office in offices)
            {
                cls_CreateUpdate_Slots_for_Practice.Invoke(Connection, Transaction, new P_L5S_SUSfP_1708() { PracticeID = office.OfficeID }, securityTicket);
            }
		...
		protected static FR_Base Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			...
			catch (Exception ex)
			{
				...
				throw new Exception("Exception occured in method cls_UpdateSlots_for_TenantID",ex);
			}
...
[OperationContract]
FR_Base cls_UpdateSlots_for_TenantID(string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_Base invocationResult = cls_UpdateSlots_for_TenantID.Invoke(connectionString,securityTicket);

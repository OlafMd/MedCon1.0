/* 
 * Generated on 20.02.2015 15:09:51
...
namespace CL5_MyHealthClub_Statistics.Atomic.Manipulation
{
    ...
    /// var result = cls_UpdateDiagnosisStatistics_for_Doctor.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_UpdateDiagnosisStatistics_for_Doctor
	{
		...
		///<summary>
		public static FR_Int Invoke(string ConnectionString,P_L5ST_UDSfD_1010 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Int Invoke(DbConnection Connection,P_L5ST_UDSfD_1010 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Int Invoke(DbConnection Connection, DbTransaction Transaction,P_L5ST_UDSfD_1010 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
	...
	#region Support Classes
		#region SClass P_L5ST_UDSfD_1010 for attribute P_L5ST_UDSfD_1010
		[DataContract]
		public class P_L5ST_UDSfD_1010 
		{
...
[OperationContract]
FR_Int cls_UpdateDiagnosisStatistics_for_Doctor(,P_L5ST_UDSfD_1010 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_Int invocationResult = cls_UpdateDiagnosisStatistics_for_Doctor.Invoke(connectionString,P_L5ST_UDSfD_1010 Parameter,securityTicket);
...
var parameter = new CL5_MyHealthClub_Statistics.Atomic.Manipulation.P_L5ST_UDSfD_1010();
parameter.DoctorID = ...;

/* 
 * Generated on 23.03.2015 11:12:43
...
namespace CL5_MPC_Community.Atomic.Manipulation
{
    ...
    /// var result = cls_Approve_Request.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Approve_Request
	{
		public static readonly int QueryTimeout = 60;

		#region Method Execution
		protected static FR_Guid Execute(DbConnection Connection,DbTransaction Transaction,P_L5MC_AR_1111 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
            ...
            var roleRequest = ORM_HEC_CMT_OfferedRoles_2_GroupSubscriptionRequest.Query.Search(Connection, Transaction, new ORM_HEC_CMT_OfferedRoles_2_GroupSubscriptionRequest.Query()
            {
                Tenant_RefID = securityTicket.TenantID,
                IsDeleted = false,
            ...
            {
                Tenant_RefID = securityTicket.TenantID,
                Membership_RefID = request.Membership_RefID,
            ...
            {
                groupSubscription = new ORM_HEC_CMT_GroupSubscription()
                {
                    Tenant_RefID = securityTicket.TenantID,
                ...
                groupSubscription.Save(Connection, Transaction);
            }
            ...
            var selectedRole = roleToId.ToArray().Single(s => s.Value.HEC_CMT_OfferedRoleID == roleRequest.HEC_CMT_OfferedRole_RefID).Key;

            if (selectedRole == ECommunityRole.Consumer)
            {
            ...
            else if (selectedRole >= ECommunityRole.Administrator)
            {
            ...
            var roleSbs = new ORM_HEC_CMT_OfferedRoles_2_GroupSubscription()
            {
                ...
                HEC_CMT_GroupSubscription_RefID = groupSubscription.HEC_CMT_GroupSubscriptionID,
                HEC_CMT_OfferedRole_RefID = roleRequest.HEC_CMT_OfferedRole_RefID
            };
            roleSbs.Save(Connection, Transaction);


            request.IfApproved_GroupSubscription_RefID = groupSubscription.HEC_CMT_GroupSubscriptionID;
            request.IsApproved = true;
            request.IfApproved_ByMember_RefID = Parameter.By_HEC_CMT_MembershipID;
		...
		///<summary>
		public static FR_Guid Invoke(string ConnectionString,P_L5MC_AR_1111 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Guid Invoke(DbConnection Connection,P_L5MC_AR_1111 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Guid Invoke(DbConnection Connection, DbTransaction Transaction,P_L5MC_AR_1111 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_Guid Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L5MC_AR_1111 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			...
			catch (Exception ex)
			{
				...
				throw new Exception("Exception occured in method cls_Approve_Request",ex);
			}
	...
	#region Support Classes
		#region SClass P_L5MC_AR_1111 for attribute P_L5MC_AR_1111
		[DataContract]
		public class P_L5MC_AR_1111 
		{
...
[OperationContract]
FR_Guid cls_Approve_Request(,P_L5MC_AR_1111 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_Guid invocationResult = cls_Approve_Request.Invoke(connectionString,P_L5MC_AR_1111 Parameter,securityTicket);
...
var parameter = new CL5_MPC_Community.Atomic.Manipulation.P_L5MC_AR_1111();

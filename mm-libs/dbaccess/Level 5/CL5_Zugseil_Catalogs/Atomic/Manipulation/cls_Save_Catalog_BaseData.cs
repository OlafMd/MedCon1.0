/* 
 * Generated on 10/20/2014 9:25:27 AM
...
using CL1_CMN_PRO;
using CL5_Zugseil_Catalogs.Utils;
            ...
            * */
            if (Parameter.CatalogID == Guid.Empty)
            {
                ...
                * */
                ...
                /*
                * @save Default Catalog ProductGroup
                * */

                ORM_CMN_PRO_Catalog_ProductGroup defaultProductGroup = new ORM_CMN_PRO_Catalog_ProductGroup();
                defaultProductGroup.Catalog_Revision_RefID = rev.CMN_PRO_Catalog_RevisionID;
                defaultProductGroup.CMN_PRO_Catalog_ProductGroupID = Guid.NewGuid();
                defaultProductGroup.CatalogProductGroup_Name = Parameter.CatalogName_Dict.Contents.First().Content;
                defaultProductGroup.CatalogProductGroup_Parent_RefID = Guid.Empty;
                defaultProductGroup.Tenant_RefID = securityTicket.TenantID;
                defaultProductGroup.Save(Connection, Transaction);
            }
            else
            {
                /*
...
var parameter = new CL5_Zugseil_Catalogs.Atomic.Manipulation.P_L5SCBD_1454();
parameter.CatalogID = ...;

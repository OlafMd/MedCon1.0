/* 
 * Generated on 12/3/2014 8:03:01 PM
...
namespace CL5_Lucentis_Aftercare.Atomic.Retrieval
{
    ...
    /// var result = cls_Get_AftercareAllData.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Get_AftercareAllData
	{
		...
		///<summary>
		public static FR_L5AF_GAAD_1607_Array Invoke(string ConnectionString,P_L5AF_GAAD_1607 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L5AF_GAAD_1607_Array Invoke(DbConnection Connection,P_L5AF_GAAD_1607 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L5AF_GAAD_1607_Array Invoke(DbConnection Connection, DbTransaction Transaction,P_L5AF_GAAD_1607 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L5AF_GAAD_1607_Array Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L5AF_GAAD_1607 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L5AF_GAAD_1607_Array functionReturn = new FR_L5AF_GAAD_1607_Array();
			try
			{
			...
			catch (Exception ex)
			{
				...
				throw new Exception("Exception occured in method cls_Get_AftercareAllData",ex);
			}
	...
	[Serializable]
	public class FR_L5AF_GAAD_1607_Array : FR_Base
	{
		public L5AF_GAAD_1607[] Result	{ get; set; } 
		public FR_L5AF_GAAD_1607_Array() : base() {}

		public FR_L5AF_GAAD_1607_Array(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass P_L5AF_GAAD_1607 for attribute P_L5AF_GAAD_1607
		[DataContract]
		public class P_L5AF_GAAD_1607 
		{
		...
		#endregion
		#region SClass L5AF_GAAD_1607 for attribute L5AF_GAAD_1607
		[DataContract]
		public class L5AF_GAAD_1607 
		{
			//Standard type parameters
			[DataMember]
...
[OperationContract]
FR_L5AF_GAAD_1607_Array cls_Get_AftercareAllData(,P_L5AF_GAAD_1607 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_L5AF_GAAD_1607_Array invocationResult = cls_Get_AftercareAllData.Invoke(connectionString,P_L5AF_GAAD_1607 Parameter,securityTicket);
...
var parameter = new CL5_Lucentis_Aftercare.Atomic.Retrieval.P_L5AF_GAAD_1607();
parameter.OrderBy = ...;

/* 
 * Generated on 12/11/2013 2:16:26 PM
...
namespace CL5_Lucentis_WebShop.Atomic.Retrieval
{
	...
	public class cls_Get_ShoppingCart_Notes_for_ShoppingCartID
	{
		...
		protected static FR_L5AWSAR_GSCNfSC_1454_Array Execute(DbConnection Connection,DbTransaction Transaction,P_L5AWSAR_GSCNfSC_1454 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			...
			var commandLocation = "CL5_Lucentis_WebShop.Atomic.Retrieval.SQL.cls_Get_ShoppingCart_Notes_for_ShoppingCartID.sql";
			...
			try
			{
				reader.SetOrdinals(new string[] { "ShoppingCartID","ShoppingCartNoteID","CreatedBy_Account_RefID","FirstName","LastName","Memo_Text","UpdatedOn" });
				while(reader.Read())
				{
...
var parameter = new CL5_Lucentis_WebShop.Atomic.Retrieval.P_L5AWSAR_GSCNfSC_1454();

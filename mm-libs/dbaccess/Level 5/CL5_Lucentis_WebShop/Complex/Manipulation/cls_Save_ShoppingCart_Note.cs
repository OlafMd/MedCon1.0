/* 
 * Generated on 12/11/2013 3:30:04 PM
...
namespace CL5_Lucentis_WebShop.Complex.Manipulation
{
	...
	public class cls_Save_ShoppingCart_Note
	{
		...
		///<summary>
		public static FR_Guid Invoke(string ConnectionString,P_L5WS_SSCN_1529 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Guid Invoke(DbConnection Connection,P_L5WS_SSCN_1529 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Guid Invoke(DbConnection Connection, DbTransaction Transaction,P_L5WS_SSCN_1529 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_Guid Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L5WS_SSCN_1529 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
	...
	#region Support Classes
		#region SClass P_L5WS_SSCN_1529 for attribute P_L5WS_SSCN_1529
		[DataContract]
		public class P_L5WS_SSCN_1529 
		{
...
[OperationContract]
FR_Guid cls_Save_ShoppingCart_Note(,P_L5WS_SSCN_1529 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_Guid invocationResult = cls_Save_ShoppingCart_Note.Invoke(connectionString,P_L5WS_SSCN_1529 Parameter,securityTicket);
...
var parameter = new CL5_Lucentis_WebShop.Complex.Manipulation.P_L5WS_SSCN_1529();

/* 
 * Generated on 6/25/2014 9:44:30 AM
...
namespace CL5_APOWebShop_ShoppingCart.Atomic.Retrieval
{
    ...
    /// var result = cls_Get_All_ShoppingCarts.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Get_All_ShoppingCarts
	{
		...
		///<summary>
		public static FR_L5AWSSC_GASC_1413_Array Invoke(string ConnectionString,P_L5AWSSC_GASC_1413 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L5AWSSC_GASC_1413_Array Invoke(DbConnection Connection,P_L5AWSSC_GASC_1413 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L5AWSSC_GASC_1413_Array Invoke(DbConnection Connection, DbTransaction Transaction,P_L5AWSSC_GASC_1413 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L5AWSSC_GASC_1413_Array Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L5AWSSC_GASC_1413 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L5AWSSC_GASC_1413_Array functionReturn = new FR_L5AWSSC_GASC_1413_Array();
			try
			{
			...
			catch (Exception ex)
			{
				...
				throw new Exception("Exception occured in method cls_Get_All_ShoppingCarts",ex);
			}
	...
	[Serializable]
	public class FR_L5AWSSC_GASC_1413_Array : FR_Base
	{
		public L5AWSSC_GASC_1413[] Result	{ get; set; } 
		public FR_L5AWSSC_GASC_1413_Array() : base() {}

		public FR_L5AWSSC_GASC_1413_Array(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass P_L5AWSSC_GASC_1413 for attribute P_L5AWSSC_GASC_1413
		[DataContract]
		public class P_L5AWSSC_GASC_1413 
		{
		...
		#endregion
		#region SClass L5AWSSC_GASC_1413 for attribute L5AWSSC_GASC_1413
		[DataContract]
		public class L5AWSSC_GASC_1413 
		{
			//Standard type parameters
			[DataMember]
...
[OperationContract]
FR_L5AWSSC_GASC_1413_Array cls_Get_All_ShoppingCarts(,P_L5AWSSC_GASC_1413 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_L5AWSSC_GASC_1413_Array invocationResult = cls_Get_All_ShoppingCarts.Invoke(connectionString,P_L5AWSSC_GASC_1413 Parameter,securityTicket);
...
var parameter = new CL5_APOWebShop_ShoppingCart.Atomic.Retrieval.P_L5AWSSC_GASC_1413();

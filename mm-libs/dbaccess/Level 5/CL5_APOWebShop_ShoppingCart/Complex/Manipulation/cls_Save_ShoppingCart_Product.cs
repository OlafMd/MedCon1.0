/* 
 * Generated on 4/2/2014 11:32:53 AM
...
namespace CL5_APOWebShop_ShoppingCart.Complex.Manipulation
{
	...
	public class cls_Save_ShoppingCart_Product
	{
		...
		protected static FR_Guid Execute(DbConnection Connection,DbTransaction Transaction,P_L5AWSAR_SSCP_1653 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
            #region UserCode
            ...
            foreach (var paramShoppingCart in Parameter.ShoppingCart)
            {
                ...
                if (paramShoppingCart.ORD_PRC_ShoppingCart_ProductID == Guid.Empty)
                {
                    ...
                    {
                        // Check does these products have same Comment
                        if (existingProduct.Comment == paramShoppingCart.Comment)
                        {
                ...
                item.Comment = paramShoppingCart.Comment;
                item.IsCanceled = paramShoppingCart.IsCanceled;
                item.IsProductReplacementAllowed = paramShoppingCart.IsProductReplacementAllowed;
		...
		///<summary>
		public static FR_Guid Invoke(string ConnectionString,P_L5AWSAR_SSCP_1653 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Guid Invoke(DbConnection Connection,P_L5AWSAR_SSCP_1653 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Guid Invoke(DbConnection Connection, DbTransaction Transaction,P_L5AWSAR_SSCP_1653 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_Guid Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L5AWSAR_SSCP_1653 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
	...
	#region Support Classes
		#region SClass P_L5AWSAR_SSCP_1653 for attribute P_L5AWSAR_SSCP_1653
		[DataContract]
		public class P_L5AWSAR_SSCP_1653 
		{
			[DataMember]
...
[OperationContract]
FR_Guid cls_Save_ShoppingCart_Product(,P_L5AWSAR_SSCP_1653 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_Guid invocationResult = cls_Save_ShoppingCart_Product.Invoke(connectionString,P_L5AWSAR_SSCP_1653 Parameter,securityTicket);
...
var parameter = new CL5_APOWebShop_ShoppingCart.Complex.Manipulation.P_L5AWSAR_SSCP_1653();

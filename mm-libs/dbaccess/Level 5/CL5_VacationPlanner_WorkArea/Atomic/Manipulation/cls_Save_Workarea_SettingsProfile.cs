/* 
 * Generated on 14-Nov-13 10:57:24
...
namespace CL5_VacationPlanner_WorkArea.Atomic.Manipulation
{
    ...
    /// var result = cls_Save_Workarea_SettingsProfile.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Save_Workarea_SettingsProfile
	{
		...
		///<summary>
		public static FR_Guid Invoke(string ConnectionString,P_L5WA_SWASP_1131 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Guid Invoke(DbConnection Connection,P_L5WA_SWASP_1131 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Guid Invoke(DbConnection Connection, DbTransaction Transaction,P_L5WA_SWASP_1131 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_Guid Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L5WA_SWASP_1131 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{

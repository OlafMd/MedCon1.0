...
Where
  ...
  pps_tsk_freeslotsfortasktemplates.TaskTemplate_RefID = @TypeID and
  pps_tsk_freeslotsfortasktemplates.FreeInterval_End <=@ToDate and
  pps_tsk_freeslotsfortasktemplates.FreeInterval_Start >=@FromDate

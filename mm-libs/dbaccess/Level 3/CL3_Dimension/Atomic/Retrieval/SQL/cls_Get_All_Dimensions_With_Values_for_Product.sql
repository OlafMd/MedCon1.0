...
Select
  ...
  cmn_pro_dimension_values.Creation_Timestamp As
  DimensionValue_Creation_Timestamp,
  cmn_pro_dimension_values.Modification_Timestamp As
  DimensionValue_Modification_Timestamp
From
  cmn_pro_dimensions Left Join
  cmn_pro_dimension_values On cmn_pro_dimensions.CMN_PRO_DimensionID =
...
Where
  cmn_pro_dimensions.Product_RefID = @ProductID And
  cmn_pro_dimensions.Tenant_RefID = @TenantID And
  cmn_pro_dimensions.IsDeleted = 0

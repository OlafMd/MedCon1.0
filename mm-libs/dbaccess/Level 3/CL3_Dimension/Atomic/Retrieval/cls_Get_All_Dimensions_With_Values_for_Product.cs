/* 
 * Generated on 10/28/2014 4:55:08 PM
...
namespace CL3_Dimension.Atomic.Retrieval
{
    ...
    /// var result = cls_Get_All_Dimensions_With_Values_for_Product.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Get_All_Dimensions_With_Values_for_Product
	{
		public static readonly int QueryTimeout = 60;

		#region Method Execution
		protected static FR_L2DM_GADWVfP_1431_Array Execute(DbConnection Connection,DbTransaction Transaction,P_L2DM_GADWVfP_1431 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			var returnStatus = new FR_L2DM_GADWVfP_1431_Array();

			DbCommand command = Connection.CreateCommand();
			command.Connection = Connection;
			command.Transaction = Transaction;
			var commandLocation = "CL3_Dimension.Atomic.Retrieval.SQL.cls_Get_All_Dimensions_With_Values_for_Product.sql";
			...
			List<L2DM_GADWVfP_1431_raw> results = new List<L2DM_GADWVfP_1431_raw>();
			...
			try
			{
				...
				while(reader.Read())
				{
					L2DM_GADWVfP_1431_raw resultItem = new L2DM_GADWVfP_1431_raw();
			...
			{
				reader.Close();
				throw new Exception("Exception occured durng data retrieval in method cls_Get_All_Dimensions_With_Values_for_Product",ex);
			}
			reader.Close();
			//Load all the dictionaries from the datatables
			loader.Load();

			returnStatus.Result = L2DM_GADWVfP_1431_raw.Convert(results).ToArray();
			return returnStatus;
		}
		#endregion
		...
		///<summary>
		public static FR_L2DM_GADWVfP_1431_Array Invoke(string ConnectionString,P_L2DM_GADWVfP_1431 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L2DM_GADWVfP_1431_Array Invoke(DbConnection Connection,P_L2DM_GADWVfP_1431 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L2DM_GADWVfP_1431_Array Invoke(DbConnection Connection, DbTransaction Transaction,P_L2DM_GADWVfP_1431 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L2DM_GADWVfP_1431_Array Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L2DM_GADWVfP_1431 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L2DM_GADWVfP_1431_Array functionReturn = new FR_L2DM_GADWVfP_1431_Array();
			try
			{
			...
			catch (Exception ex)
			{
				...
				throw new Exception("Exception occured in method cls_Get_All_Dimensions_With_Values_for_Product",ex);
			}
	...
	[Serializable]
	public class L2DM_GADWVfP_1431_raw 
	{
		...
		public static L2DM_GADWVfP_1431[] Convert(List<L2DM_GADWVfP_1431_raw> rawResult)
		{	
		    var gfunct_rawResult = rawResult;
			var groupResult = from el_L2DM_GADWVfP_1431 in gfunct_rawResult.Where(element => !EqualsDefaultValue(element.CMN_PRO_DimensionID)).ToArray()
	group el_L2DM_GADWVfP_1431 by new 
	{ 
		el_L2DM_GADWVfP_1431.CMN_PRO_DimensionID,

	}
	into gfunct_L2DM_GADWVfP_1431
	select new L2DM_GADWVfP_1431
	{     
		CMN_PRO_DimensionID = gfunct_L2DM_GADWVfP_1431.Key.CMN_PRO_DimensionID ,
		Product_RefID = gfunct_L2DM_GADWVfP_1431.FirstOrDefault().Product_RefID ,
		Abbreviation = gfunct_L2DM_GADWVfP_1431.FirstOrDefault().Abbreviation ,
		DimensionName = gfunct_L2DM_GADWVfP_1431.FirstOrDefault().DimensionName ,
		Dimension_Ordersequence = gfunct_L2DM_GADWVfP_1431.FirstOrDefault().Dimension_Ordersequence ,
		IsDimensionTemplate = gfunct_L2DM_GADWVfP_1431.FirstOrDefault().IsDimensionTemplate ,
		Dimension_Creation_Timestamp = gfunct_L2DM_GADWVfP_1431.FirstOrDefault().Dimension_Creation_Timestamp ,
		Dimension_Modification_Timestamp = gfunct_L2DM_GADWVfP_1431.FirstOrDefault().Dimension_Modification_Timestamp ,

		DimensionValues = 
		(
			from el_DimensionValues in gfunct_L2DM_GADWVfP_1431.Where(element => !EqualsDefaultValue(element.CMN_PRO_Dimension_ValueID)).ToArray()
	...
	[Serializable]
	public class FR_L2DM_GADWVfP_1431_Array : FR_Base
	{
		public L2DM_GADWVfP_1431[] Result	{ get; set; } 
		public FR_L2DM_GADWVfP_1431_Array() : base() {}

		public FR_L2DM_GADWVfP_1431_Array(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass P_L2DM_GADWVfP_1431 for attribute P_L2DM_GADWVfP_1431
		[DataContract]
		public class P_L2DM_GADWVfP_1431 
		{
		...
		#endregion
		#region SClass L2DM_GADWVfP_1431 for attribute L2DM_GADWVfP_1431
		[DataContract]
		public class L2DM_GADWVfP_1431 
		{
			[DataMember]
			public L2DM_GADWVfP_1431a[] DimensionValues { get; set; }
		...
		#endregion
		#region SClass L2DM_GADWVfP_1431a for attribute DimensionValues
		[DataContract]
		public class L2DM_GADWVfP_1431a 
		{
			//Standard type parameters
			[DataMember]
...
[OperationContract]
FR_L2DM_GADWVfP_1431_Array cls_Get_All_Dimensions_With_Values_for_Product(,P_L2DM_GADWVfP_1431 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_L2DM_GADWVfP_1431_Array invocationResult = cls_Get_All_Dimensions_With_Values_for_Product.Invoke(connectionString,P_L2DM_GADWVfP_1431 Parameter,securityTicket);
...
var parameter = new CL3_Dimension.Atomic.Retrieval.P_L2DM_GADWVfP_1431();
parameter.ProductID = ...;

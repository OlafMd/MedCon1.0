/* 
 * Generated on 11/24/2014 01:59:30
...
namespace CL3_Zugseil_Catalog.Atomic.Retrieval
{
	...
	public class cls_Get_Catalog_and_Revisions_for_CatalogID
	{
		...
		protected static FR_L3CA_GCaRfC_1351 Execute(DbConnection Connection,DbTransaction Transaction,P_L3CA_GCaRfC_1351 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			var returnStatus = new FR_L3CA_GCaRfC_1351();

			DbCommand command = Connection.CreateCommand();
			command.Connection = Connection;
			command.Transaction = Transaction;
			var commandLocation = "CL3_Zugseil_Catalog.Atomic.Retrieval.SQL.cls_Get_Catalog_and_Revisions_for_CatalogID.sql";
			...
			List<L3CA_GCaRfC_1351_raw> results = new List<L3CA_GCaRfC_1351_raw>();
			...
			try
			{
				...
				while(reader.Read())
				{
					L3CA_GCaRfC_1351_raw resultItem = new L3CA_GCaRfC_1351_raw();
			...
			returnStatus.Result = L3CA_GCaRfC_1351_raw.Convert(results).FirstOrDefault();
		...
		///<summary>
		public static FR_L3CA_GCaRfC_1351 Invoke(string ConnectionString,P_L3CA_GCaRfC_1351 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L3CA_GCaRfC_1351 Invoke(DbConnection Connection,P_L3CA_GCaRfC_1351 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L3CA_GCaRfC_1351 Invoke(DbConnection Connection, DbTransaction Transaction,P_L3CA_GCaRfC_1351 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L3CA_GCaRfC_1351 Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L3CA_GCaRfC_1351 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L3CA_GCaRfC_1351 functionReturn = new FR_L3CA_GCaRfC_1351();
			try
			{
	...
	[Serializable]
	public class L3CA_GCaRfC_1351_raw 
	{
		...
		public static L3CA_GCaRfC_1351[] Convert(List<L3CA_GCaRfC_1351_raw> rawResult)
		{	
		    var gfunct_rawResult = rawResult;
			var groupResult = from el_L3CA_GCaRfC_1351 in gfunct_rawResult.Where(element => !EqualsDefaultValue(element.CMN_PRO_CatalogID)).ToArray()
	group el_L3CA_GCaRfC_1351 by new 
	{ 
		el_L3CA_GCaRfC_1351.CMN_PRO_CatalogID,

	}
	into gfunct_L3CA_GCaRfC_1351
	select new L3CA_GCaRfC_1351
	{     
		CMN_PRO_CatalogID = gfunct_L3CA_GCaRfC_1351.Key.CMN_PRO_CatalogID ,
		Catalog_Currency_RefID = gfunct_L3CA_GCaRfC_1351.FirstOrDefault().Catalog_Currency_RefID ,
		Catalog_Language_RefID = gfunct_L3CA_GCaRfC_1351.FirstOrDefault().Catalog_Language_RefID ,
		IsPublicCatalog = gfunct_L3CA_GCaRfC_1351.FirstOrDefault().IsPublicCatalog ,
		CatalogCodeITL = gfunct_L3CA_GCaRfC_1351.FirstOrDefault().CatalogCodeITL ,
		Catalog_Name = gfunct_L3CA_GCaRfC_1351.FirstOrDefault().Catalog_Name ,

		Revisions = 
		(
			from el_Revisions in gfunct_L3CA_GCaRfC_1351.Where(element => !EqualsDefaultValue(element.CMN_PRO_Catalog_RevisionID)).ToArray()
	...
	[Serializable]
	public class FR_L3CA_GCaRfC_1351 : FR_Base
	{
		public L3CA_GCaRfC_1351 Result	{ get; set; }

		public FR_L3CA_GCaRfC_1351() : base() {}

		public FR_L3CA_GCaRfC_1351(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass P_L3CA_GCaRfC_1351 for attribute P_L3CA_GCaRfC_1351
		[DataContract]
		public class P_L3CA_GCaRfC_1351 
		{
		...
		#endregion
		#region SClass L3CA_GCaRfC_1351 for attribute L3CA_GCaRfC_1351
		[DataContract]
		public class L3CA_GCaRfC_1351 
		{
			[DataMember]
...
[OperationContract]
FR_L3CA_GCaRfC_1351 cls_Get_Catalog_and_Revisions_for_CatalogID(,P_L3CA_GCaRfC_1351 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_L3CA_GCaRfC_1351 invocationResult = cls_Get_Catalog_and_Revisions_for_CatalogID.Invoke(connectionString,P_L3CA_GCaRfC_1351 Parameter,securityTicket);
...
var parameter = new CL3_Zugseil_Catalog.Atomic.Retrieval.P_L3CA_GCaRfC_1351();
parameter.CatalogID = ...;

/* 
 * Generated on 11/15/2014 4:07:47 PM
...
namespace CL3_Zugseil_Catalog.Complex.Manipulation
{
	...
	public class cls_CreateOrUpdateSupplier_for_ImportedCatalog
	{
		...
		///<summary>
		public static FR_Guid Invoke(string ConnectionString,P_L3CA_CoUSfIC_1602 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Guid Invoke(DbConnection Connection,P_L3CA_CoUSfIC_1602 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Guid Invoke(DbConnection Connection, DbTransaction Transaction,P_L3CA_CoUSfIC_1602 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_Guid Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L3CA_CoUSfIC_1602 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
	...
	#region Support Classes
		#region SClass P_L3CA_CoUSfIC_1602 for attribute P_L3CA_CoUSfIC_1602
		[DataContract]
		public class P_L3CA_CoUSfIC_1602 
		{
...
[OperationContract]
FR_Guid cls_CreateOrUpdateSupplier_for_ImportedCatalog(,P_L3CA_CoUSfIC_1602 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_Guid invocationResult = cls_CreateOrUpdateSupplier_for_ImportedCatalog.Invoke(connectionString,P_L3CA_CoUSfIC_1602 Parameter,securityTicket);
...
var parameter = new CL3_Zugseil_Catalog.Complex.Manipulation.P_L3CA_CoUSfIC_1602();

/* 
 * Generated on 28.1.2015 10:19:36
...
namespace CL3_EconomicRegion.Atomic.Manipulation
{
    ...
    /// var result = cls_Save_EconomicRegion.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
    [DataContract]
    public class cls_Save_EconomicRegion
    {
        public static readonly int QueryTimeout = 60;

        #region Method Execution
        protected static FR_Guid Execute(DbConnection Connection, DbTransaction Transaction, P_L3ER_SER_1016 Parameter, CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
        {
        ...
        ///<summary>
        public static FR_Guid Invoke(string ConnectionString, P_L3ER_SER_1016 Parameter, CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
        {
        ...
        ///<summary>
        public static FR_Guid Invoke(DbConnection Connection, P_L3ER_SER_1016 Parameter, CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
        {
        ...
        ///<summary>
        public static FR_Guid Invoke(DbConnection Connection, DbTransaction Transaction, P_L3ER_SER_1016 Parameter, CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
        {
        ...
        ///<summary>
        protected static FR_Guid Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString, P_L3ER_SER_1016 Parameter, CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("Exception occured in method cls_Save_EconomicRegion", ex);
            }
    ...
    #region SClass P_L3ER_SER_1016 for attribute P_L3ER_SER_1016
    [DataContract]
    public class P_L3ER_SER_1016
    {
...
[OperationContract]
FR_Guid cls_Save_EconomicRegion(,P_L3ER_SER_1016 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_Guid invocationResult = cls_Save_EconomicRegion.Invoke(connectionString,P_L3ER_SER_1016 Parameter,securityTicket);
...
var parameter = new CL3_EconomicRegion.Atomic.Manipulation.P_L3ER_SER_1016();

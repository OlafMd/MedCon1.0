/* 
 * Generated on 9/3/2014 2:11:31 PM
...
namespace CL3_Price.Atomic.Retrieval
{
    ...
    /// var result = cls_Get_Pricelists_and_Prices_for_ArticleList_and_Currency_ID.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Get_Pricelists_and_Prices_for_ArticleList_and_Currency_ID
	{
		...
		///<summary>
		public static FR_L3PR_GPaPfALaCID_1409_Array Invoke(string ConnectionString,P_L3PR_GPaPfALaCID_1409 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L3PR_GPaPfALaCID_1409_Array Invoke(DbConnection Connection,P_L3PR_GPaPfALaCID_1409 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L3PR_GPaPfALaCID_1409_Array Invoke(DbConnection Connection, DbTransaction Transaction,P_L3PR_GPaPfALaCID_1409 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L3PR_GPaPfALaCID_1409_Array Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L3PR_GPaPfALaCID_1409 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L3PR_GPaPfALaCID_1409_Array functionReturn = new FR_L3PR_GPaPfALaCID_1409_Array();
			try
			{
			...
			catch (Exception ex)
			{
				...
				throw new Exception("Exception occured in method cls_Get_Pricelists_and_Prices_for_ArticleList_and_Currency_ID",ex);
			}
	...
	[Serializable]
	public class FR_L3PR_GPaPfALaCID_1409_Array : FR_Base
	{
		public L3PR_GPaPfALaCID_1409[] Result	{ get; set; } 
		public FR_L3PR_GPaPfALaCID_1409_Array() : base() {}

		public FR_L3PR_GPaPfALaCID_1409_Array(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass P_L3PR_GPaPfALaCID_1409 for attribute P_L3PR_GPaPfALaCID_1409
		[DataContract]
		public class P_L3PR_GPaPfALaCID_1409 
		{
		...
		#endregion
		#region SClass L3PR_GPaPfALaCID_1409 for attribute L3PR_GPaPfALaCID_1409
		[DataContract]
		public class L3PR_GPaPfALaCID_1409 
		{
			//Standard type parameters
			[DataMember]
...
[OperationContract]
FR_L3PR_GPaPfALaCID_1409_Array cls_Get_Pricelists_and_Prices_for_ArticleList_and_Currency_ID(,P_L3PR_GPaPfALaCID_1409 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_L3PR_GPaPfALaCID_1409_Array invocationResult = cls_Get_Pricelists_and_Prices_for_ArticleList_and_Currency_ID.Invoke(connectionString,P_L3PR_GPaPfALaCID_1409 Parameter,securityTicket);
...
var parameter = new CL3_Price.Atomic.Retrieval.P_L3PR_GPaPfALaCID_1409();
parameter.ArticleID = ...;

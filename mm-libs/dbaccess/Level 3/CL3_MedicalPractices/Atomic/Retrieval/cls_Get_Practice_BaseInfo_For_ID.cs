/* 
 * Generated on 8/30/2013 12:19:42 PM
...
namespace CL3_MedicalPractices.Atomic.Retrieval
{
    ...
    /// var result = cls_Get_Practice_BaseInfo_For_ID.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Get_Practice_BaseInfo_For_ID
	{
		public static readonly int QueryTimeout = 60;

		#region Method Execution
		protected static FR_L3MP_GPBIfID_1131 Execute(DbConnection Connection,DbTransaction Transaction,P_L3MP_GPBIfID_1131 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			var returnStatus = new FR_L3MP_GPBIfID_1131();

			DbCommand command = Connection.CreateCommand();
			command.Connection = Connection;
			command.Transaction = Transaction;
			var commandLocation = "CL3_MedicalPractices.Atomic.Retrieval.SQL.cls_Get_Practice_BaseInfo_For_ID.sql";
			...
			List<L3MP_GPBIfID_1131> results = new List<L3MP_GPBIfID_1131>();
			...
			try
			{
				...
				while(reader.Read())
				{
					L3MP_GPBIfID_1131 resultItem = new L3MP_GPBIfID_1131();
			...
			{
				reader.Close();
				throw new Exception("Exception occured durng data retrieval in method cls_Get_Practice_BaseInfo_For_ID",ex);
			}
			reader.Close();
		...
		///<summary>
		public static FR_L3MP_GPBIfID_1131 Invoke(string ConnectionString,P_L3MP_GPBIfID_1131 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L3MP_GPBIfID_1131 Invoke(DbConnection Connection,P_L3MP_GPBIfID_1131 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L3MP_GPBIfID_1131 Invoke(DbConnection Connection, DbTransaction Transaction,P_L3MP_GPBIfID_1131 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L3MP_GPBIfID_1131 Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L3MP_GPBIfID_1131 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L3MP_GPBIfID_1131 functionReturn = new FR_L3MP_GPBIfID_1131();
			try
			{
			...
			catch (Exception ex)
			{
				...
				throw new Exception("Exception occured in method cls_Get_Practice_BaseInfo_For_ID",ex);
			}
	...
	[Serializable]
	public class FR_L3MP_GPBIfID_1131 : FR_Base
	{
		public L3MP_GPBIfID_1131 Result	{ get; set; }

		public FR_L3MP_GPBIfID_1131() : base() {}

		public FR_L3MP_GPBIfID_1131(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass P_L3MP_GPBIfID_1131 for attribute P_L3MP_GPBIfID_1131
		[DataContract]
		public class P_L3MP_GPBIfID_1131 
		{
		...
		#endregion
		#region SClass L3MP_GPBIfID_1131 for attribute L3MP_GPBIfID_1131
		[DataContract]
		public class L3MP_GPBIfID_1131 
		{
			//Standard type parameters
			[DataMember]
...
[OperationContract]
FR_L3MP_GPBIfID_1131 cls_Get_Practice_BaseInfo_For_ID(,P_L3MP_GPBIfID_1131 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = VerifySessionToken(sessionToken);
		FR_L3MP_GPBIfID_1131 invocationResult = cls_Get_Practice_BaseInfo_For_ID.Invoke(connectionString,P_L3MP_GPBIfID_1131 Parameter,securityTicket);
...
var parameter = new CL3_MedicalPractices.Atomic.Retrieval.P_L3MP_GPBIfID_1131();

/* 
 * Generated on 2/2/2015 15:29:44
...
namespace CL3_Variant.Complex.Manipulation
{
    ...
    /// var result = cls_Save_AssortmentVariant_for_Product.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
    [DataContract]
    public class cls_Save_AssortmentVariant_for_Product
    {
        public static readonly int QueryTimeout = 60;

        #region Method Execution
        protected static FR_Base Execute(DbConnection Connection, DbTransaction Transaction, P_L3VA_SAVfP_1523 Parameter, CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
        {
            #region UserCode
            ...
            foreach (var variant in Parameter.Variants)
            {
                ...
                if (createNewVariant)
                {
                    ...
                    assortmentVariantToCreate.Ext_CMN_PRO_Product_Variant_RefID = variantToCreateUpdate.CMN_PRO_Product_VariantID;
        ...
        ///<summary>
        public static FR_Base Invoke(string ConnectionString, P_L3VA_SAVfP_1523 Parameter, CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
        {
        ...
        ///<summary>
        public static FR_Base Invoke(DbConnection Connection, P_L3VA_SAVfP_1523 Parameter, CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
        {
        ...
        ///<summary>
        public static FR_Base Invoke(DbConnection Connection, DbTransaction Transaction, P_L3VA_SAVfP_1523 Parameter, CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
        {
        ...
        ///<summary>
        protected static FR_Base Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString, P_L3VA_SAVfP_1523 Parameter, CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("Exception occured in method cls_Save_AssortmentVariant_for_Product", ex);
            }
    ...
    #region SClass P_L3VA_SAVfP_1523 for attribute P_L3VA_SAVfP_1523
    [DataContract]
    public class P_L3VA_SAVfP_1523
    {
        [DataMember]
        public P_L3VA_SAVfP_1523a[] Variants { get; set; }
        [DataMember]
        public P_L3VA_SAVfP_1523b[] Dimensions { get; set; }
        [DataMember]
        public P_L3VA_SAVfP_1523c[] DimensionValues { get; set; }
    ...
    #endregion
    #region SClass P_L3VA_SAVfP_1523a for attribute Variants
    [DataContract]
    public class P_L3VA_SAVfP_1523a
    {
        //Standard type parameters
        [DataMember]
    ...
    #endregion
    #region SClass P_L3VA_SAVfP_1523b for attribute Dimensions
    [DataContract]
    public class P_L3VA_SAVfP_1523b
    {
        //Standard type parameters
        [DataMember]
    ...
    #endregion
    #region SClass P_L3VA_SAVfP_1523c for attribute DimensionValues
    [DataContract]
    public class P_L3VA_SAVfP_1523c
    {
        //Standard type parameters
        [DataMember]
...
[OperationContract]
FR_Base cls_Save_AssortmentVariant_for_Product(,P_L3VA_SAVfP_1523 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_Base invocationResult = cls_Save_AssortmentVariant_for_Product.Invoke(connectionString,P_L3VA_SAVfP_1523 Parameter,securityTicket);
...
var parameter = new CL3_Variant.Complex.Manipulation.P_L3VA_SAVfP_1523();
parameter.Variants = ...;

/* 
 * Generated on 7/8/2013 11:03:30 AM
...
{
	/// <summary>
    /// Get Documents  for DocumentHeaderID
    /// <example>
	/// string connectionString = ...;
    /// var result = cls_Get_Documents_for_DHeaderID.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Get_Documents_for_DHeaderID
	{
		public static readonly int QueryTimeout = 60;

		#region Method Execution
		protected static FR_L3DO_GDfDH_1133_Array Execute(DbConnection Connection,DbTransaction Transaction,P_L3DO_GDfDH_1133 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			var returnStatus = new FR_L3DO_GDfDH_1133_Array();

			DbCommand command = Connection.CreateCommand();
			command.Connection = Connection;
			command.Transaction = Transaction;
			var commandLocation = "CL3_Document.Atomic.Retrieval.SQL.cls_Get_Documents_for_DHeaderID.sql";
			...
			List<L3DO_GDfDH_1133_raw> results = new List<L3DO_GDfDH_1133_raw>();
			...
			try
			{
				...
				while(reader.Read())
				{
					L3DO_GDfDH_1133_raw resultItem = new L3DO_GDfDH_1133_raw();
			...
			returnStatus.Result = L3DO_GDfDH_1133_raw.Convert(results).ToArray();
			return returnStatus;
		}
		#endregion
		...
		///<summary>
		public static FR_L3DO_GDfDH_1133_Array Invoke(string ConnectionString,P_L3DO_GDfDH_1133 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L3DO_GDfDH_1133_Array Invoke(DbConnection Connection,P_L3DO_GDfDH_1133 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L3DO_GDfDH_1133_Array Invoke(DbConnection Connection, DbTransaction Transaction,P_L3DO_GDfDH_1133 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L3DO_GDfDH_1133_Array Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L3DO_GDfDH_1133 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L3DO_GDfDH_1133_Array functionReturn = new FR_L3DO_GDfDH_1133_Array();
			try
			{
	...
	[Serializable]
	public class L3DO_GDfDH_1133_raw 
	{
		...
		public static L3DO_GDfDH_1133[] Convert(List<L3DO_GDfDH_1133_raw> rawResult)
		{	
		    var gfunct_rawResult = rawResult;
			var groupResult = from el_L3DO_GDfDH_1133 in gfunct_rawResult.Where(element => !EqualsDefaultValue(element.DOC_DocumentID)).ToArray()
	group el_L3DO_GDfDH_1133 by new 
	{ 
		el_L3DO_GDfDH_1133.DOC_DocumentID,

	}
	into gfunct_L3DO_GDfDH_1133
	select new L3DO_GDfDH_1133
	{     
		AssignmentID = gfunct_L3DO_GDfDH_1133.FirstOrDefault().AssignmentID ,
		Structure_RefID = gfunct_L3DO_GDfDH_1133.FirstOrDefault().Structure_RefID ,
		StructureHeader_RefID = gfunct_L3DO_GDfDH_1133.FirstOrDefault().StructureHeader_RefID ,
		DOC_DocumentID = gfunct_L3DO_GDfDH_1133.Key.DOC_DocumentID ,
		Alias = gfunct_L3DO_GDfDH_1133.FirstOrDefault().Alias ,
		PrimaryType = gfunct_L3DO_GDfDH_1133.FirstOrDefault().PrimaryType ,

		Revisions = 
		(
			from el_Revisions in gfunct_L3DO_GDfDH_1133.Where(element => !EqualsDefaultValue(element.DOC_DocumentRevisionID)).ToArray()
	...
	[Serializable]
	public class FR_L3DO_GDfDH_1133_Array : FR_Base
	{
		public L3DO_GDfDH_1133[] Result	{ get; set; } 
		public FR_L3DO_GDfDH_1133_Array() : base() {}

		public FR_L3DO_GDfDH_1133_Array(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass P_L3DO_GDfDH_1133 for attribute P_L3DO_GDfDH_1133
		[DataContract]
		public class P_L3DO_GDfDH_1133 
		{
		...
		#endregion
		#region SClass L3DO_GDfDH_1133 for attribute L3DO_GDfDH_1133
		[DataContract]
		public class L3DO_GDfDH_1133 
		{
			[DataMember]
			public L3DO_GDfDH_1133a[] Revisions { get; set; }
		...
		#endregion
		#region SClass L3DO_GDfDH_1133a for attribute Revisions
		[DataContract]
		public class L3DO_GDfDH_1133a 
		{
			//Standard type parameters
			[DataMember]

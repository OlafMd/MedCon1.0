/* 
 * Generated on 12/16/2014 09:51:32
...
namespace CL3_Document.Atomic.Retrieval
{
    ...
    /// var result = cls_Get_Documents_for_ProductVariantID.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Get_Documents_for_ProductVariantID
	{
		public static readonly int QueryTimeout = 60;

		#region Method Execution
		protected static FR_L3DO_GDfPVID_0854_Array Execute(DbConnection Connection,DbTransaction Transaction,P_L3DO_GDfPVID_0854 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			var returnStatus = new FR_L3DO_GDfPVID_0854_Array();

			DbCommand command = Connection.CreateCommand();
			command.Connection = Connection;
			command.Transaction = Transaction;
			var commandLocation = "CL3_Document.Atomic.Retrieval.SQL.cls_Get_Documents_for_ProductVariantID.sql";
			...
			List<L3DO_GDfPVID_0854_raw> results = new List<L3DO_GDfPVID_0854_raw>();
			...
			try
			{
				...
				while(reader.Read())
				{
					L3DO_GDfPVID_0854_raw resultItem = new L3DO_GDfPVID_0854_raw();
			...
			{
				reader.Close();
				throw new Exception("Exception occured durng data retrieval in method cls_Get_Documents_for_ProductVariantID",ex);
			}
			reader.Close();
			//Load all the dictionaries from the datatables
			loader.Load();

			returnStatus.Result = L3DO_GDfPVID_0854_raw.Convert(results).ToArray();
			return returnStatus;
		}
		#endregion
		...
		///<summary>
		public static FR_L3DO_GDfPVID_0854_Array Invoke(string ConnectionString,P_L3DO_GDfPVID_0854 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L3DO_GDfPVID_0854_Array Invoke(DbConnection Connection,P_L3DO_GDfPVID_0854 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L3DO_GDfPVID_0854_Array Invoke(DbConnection Connection, DbTransaction Transaction,P_L3DO_GDfPVID_0854 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L3DO_GDfPVID_0854_Array Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L3DO_GDfPVID_0854 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L3DO_GDfPVID_0854_Array functionReturn = new FR_L3DO_GDfPVID_0854_Array();
			try
			{
			...
			catch (Exception ex)
			{
				...
				throw new Exception("Exception occured in method cls_Get_Documents_for_ProductVariantID",ex);
			}
	...
	[Serializable]
	public class L3DO_GDfPVID_0854_raw 
	{
		...
		public static L3DO_GDfPVID_0854[] Convert(List<L3DO_GDfPVID_0854_raw> rawResult)
		{	
		    var gfunct_rawResult = rawResult;
			var groupResult = from el_L3DO_GDfPVID_0854 in gfunct_rawResult.Where(element => !EqualsDefaultValue(element.DOC_DocumentID)).ToArray()
	group el_L3DO_GDfPVID_0854 by new 
	{ 
		el_L3DO_GDfPVID_0854.DOC_DocumentID,

	}
	into gfunct_L3DO_GDfPVID_0854
	select new L3DO_GDfPVID_0854
	{     
		AssignmentID = gfunct_L3DO_GDfPVID_0854.FirstOrDefault().AssignmentID ,
		Structure_RefID = gfunct_L3DO_GDfPVID_0854.FirstOrDefault().Structure_RefID ,
		StructureHeader_RefID = gfunct_L3DO_GDfPVID_0854.FirstOrDefault().StructureHeader_RefID ,
		DOC_DocumentID = gfunct_L3DO_GDfPVID_0854.Key.DOC_DocumentID ,
		Alias = gfunct_L3DO_GDfPVID_0854.FirstOrDefault().Alias ,
		PrimaryType = gfunct_L3DO_GDfPVID_0854.FirstOrDefault().PrimaryType ,

		Revisions = 
		(
			from el_Revisions in gfunct_L3DO_GDfPVID_0854.Where(element => !EqualsDefaultValue(element.DOC_DocumentRevisionID)).ToArray()
	...
	[Serializable]
	public class FR_L3DO_GDfPVID_0854_Array : FR_Base
	{
		public L3DO_GDfPVID_0854[] Result	{ get; set; } 
		public FR_L3DO_GDfPVID_0854_Array() : base() {}

		public FR_L3DO_GDfPVID_0854_Array(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass P_L3DO_GDfPVID_0854 for attribute P_L3DO_GDfPVID_0854
		[DataContract]
		public class P_L3DO_GDfPVID_0854 
		{
		...
		#endregion
		#region SClass L3DO_GDfPVID_0854 for attribute L3DO_GDfPVID_0854
		[DataContract]
		public class L3DO_GDfPVID_0854 
		{
			[DataMember]
			public L3DO_GDfPVID_0854a[] Revisions { get; set; }
		...
		#endregion
		#region SClass L3DO_GDfPVID_0854a for attribute Revisions
		[DataContract]
		public class L3DO_GDfPVID_0854a 
		{
			//Standard type parameters
			[DataMember]
...
[OperationContract]
FR_L3DO_GDfPVID_0854_Array cls_Get_Documents_for_ProductVariantID(,P_L3DO_GDfPVID_0854 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_L3DO_GDfPVID_0854_Array invocationResult = cls_Get_Documents_for_ProductVariantID.Invoke(connectionString,P_L3DO_GDfPVID_0854 Parameter,securityTicket);
...
var parameter = new CL3_Document.Atomic.Retrieval.P_L3DO_GDfPVID_0854();
parameter.ID = ...;

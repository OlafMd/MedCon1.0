/* 
 * Generated on 12/16/2014 11:30:41
...
namespace CL3_Document.Atomic.Retrieval
{
    ...
    /// var result = cls_Get_Documents_for_CommentID.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Get_Documents_for_CommentID
	{
		public static readonly int QueryTimeout = 60;

		#region Method Execution
		protected static FR_L3DO_GDfCID_0848_Array Execute(DbConnection Connection,DbTransaction Transaction,P_L3DO_GDfCID_0848 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			var returnStatus = new FR_L3DO_GDfCID_0848_Array();

			DbCommand command = Connection.CreateCommand();
			command.Connection = Connection;
			command.Transaction = Transaction;
			var commandLocation = "CL3_Document.Atomic.Retrieval.SQL.cls_Get_Documents_for_CommentID.sql";
			...
			List<L3DO_GDfCID_0848_raw> results = new List<L3DO_GDfCID_0848_raw>();
			...
			try
			{
				...
				while(reader.Read())
				{
					L3DO_GDfCID_0848_raw resultItem = new L3DO_GDfCID_0848_raw();
			...
			{
				reader.Close();
				throw new Exception("Exception occured durng data retrieval in method cls_Get_Documents_for_CommentID",ex);
			}
			reader.Close();
			//Load all the dictionaries from the datatables
			loader.Load();

			returnStatus.Result = L3DO_GDfCID_0848_raw.Convert(results).ToArray();
			return returnStatus;
		}
		#endregion
		...
		///<summary>
		public static FR_L3DO_GDfCID_0848_Array Invoke(string ConnectionString,P_L3DO_GDfCID_0848 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L3DO_GDfCID_0848_Array Invoke(DbConnection Connection,P_L3DO_GDfCID_0848 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L3DO_GDfCID_0848_Array Invoke(DbConnection Connection, DbTransaction Transaction,P_L3DO_GDfCID_0848 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L3DO_GDfCID_0848_Array Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L3DO_GDfCID_0848 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L3DO_GDfCID_0848_Array functionReturn = new FR_L3DO_GDfCID_0848_Array();
			try
			{
			...
			catch (Exception ex)
			{
				...
				throw new Exception("Exception occured in method cls_Get_Documents_for_CommentID",ex);
			}
	...
	[Serializable]
	public class L3DO_GDfCID_0848_raw 
	{
		...
		public static L3DO_GDfCID_0848[] Convert(List<L3DO_GDfCID_0848_raw> rawResult)
		{	
		    var gfunct_rawResult = rawResult;
			var groupResult = from el_L3DO_GDfCID_0848 in gfunct_rawResult.Where(element => !EqualsDefaultValue(element.DOC_DocumentID)).ToArray()
	group el_L3DO_GDfCID_0848 by new 
	{ 
		el_L3DO_GDfCID_0848.DOC_DocumentID,

	}
	into gfunct_L3DO_GDfCID_0848
	select new L3DO_GDfCID_0848
	{     
		AssignmentID = gfunct_L3DO_GDfCID_0848.FirstOrDefault().AssignmentID ,
		Structure_RefID = gfunct_L3DO_GDfCID_0848.FirstOrDefault().Structure_RefID ,
		StructureHeader_RefID = gfunct_L3DO_GDfCID_0848.FirstOrDefault().StructureHeader_RefID ,
		DOC_DocumentID = gfunct_L3DO_GDfCID_0848.Key.DOC_DocumentID ,
		Alias = gfunct_L3DO_GDfCID_0848.FirstOrDefault().Alias ,
		PrimaryType = gfunct_L3DO_GDfCID_0848.FirstOrDefault().PrimaryType ,

		Revisions = 
		(
			from el_Revisions in gfunct_L3DO_GDfCID_0848.Where(element => !EqualsDefaultValue(element.DOC_DocumentRevisionID)).ToArray()
	...
	[Serializable]
	public class FR_L3DO_GDfCID_0848_Array : FR_Base
	{
		public L3DO_GDfCID_0848[] Result	{ get; set; } 
		public FR_L3DO_GDfCID_0848_Array() : base() {}

		public FR_L3DO_GDfCID_0848_Array(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass P_L3DO_GDfCID_0848 for attribute P_L3DO_GDfCID_0848
		[DataContract]
		public class P_L3DO_GDfCID_0848 
		{
		...
		#endregion
		#region SClass L3DO_GDfCID_0848 for attribute L3DO_GDfCID_0848
		[DataContract]
		public class L3DO_GDfCID_0848 
		{
			[DataMember]
			public L3DO_GDfCID_0848a[] Revisions { get; set; }
		...
		#endregion
		#region SClass L3DO_GDfCID_0848a for attribute Revisions
		[DataContract]
		public class L3DO_GDfCID_0848a 
		{
			//Standard type parameters
			[DataMember]
...
[OperationContract]
FR_L3DO_GDfCID_0848_Array cls_Get_Documents_for_CommentID(,P_L3DO_GDfCID_0848 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_L3DO_GDfCID_0848_Array invocationResult = cls_Get_Documents_for_CommentID.Invoke(connectionString,P_L3DO_GDfCID_0848 Parameter,securityTicket);
...
var parameter = new CL3_Document.Atomic.Retrieval.P_L3DO_GDfCID_0848();
parameter.ID = ...;

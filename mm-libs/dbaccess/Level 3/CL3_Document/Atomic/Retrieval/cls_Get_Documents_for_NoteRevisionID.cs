/* 
 * Generated on 12/16/2014 11:10:20
...
namespace CL3_Document.Atomic.Retrieval
{
    ...
    /// var result = cls_Get_Documents_for_NoteRevisionID.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Get_Documents_for_NoteRevisionID
	{
		public static readonly int QueryTimeout = 60;

		#region Method Execution
		protected static FR_L3DO_GDfNRID_1110_Array Execute(DbConnection Connection,DbTransaction Transaction,P_L3DO_GDfNRID_1110 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			var returnStatus = new FR_L3DO_GDfNRID_1110_Array();

			DbCommand command = Connection.CreateCommand();
			command.Connection = Connection;
			command.Transaction = Transaction;
			var commandLocation = "CL3_Document.Atomic.Retrieval.SQL.cls_Get_Documents_for_NoteRevisionID.sql";
			...
			List<L3DO_GDfNRID_1110_raw> results = new List<L3DO_GDfNRID_1110_raw>();
			...
			try
			{
				...
				while(reader.Read())
				{
					L3DO_GDfNRID_1110_raw resultItem = new L3DO_GDfNRID_1110_raw();
			...
			{
				reader.Close();
				throw new Exception("Exception occured durng data retrieval in method cls_Get_Documents_for_NoteRevisionID",ex);
			}
			reader.Close();
			//Load all the dictionaries from the datatables
			loader.Load();

			returnStatus.Result = L3DO_GDfNRID_1110_raw.Convert(results).ToArray();
			return returnStatus;
		}
		#endregion
		...
		///<summary>
		public static FR_L3DO_GDfNRID_1110_Array Invoke(string ConnectionString,P_L3DO_GDfNRID_1110 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L3DO_GDfNRID_1110_Array Invoke(DbConnection Connection,P_L3DO_GDfNRID_1110 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L3DO_GDfNRID_1110_Array Invoke(DbConnection Connection, DbTransaction Transaction,P_L3DO_GDfNRID_1110 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L3DO_GDfNRID_1110_Array Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L3DO_GDfNRID_1110 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L3DO_GDfNRID_1110_Array functionReturn = new FR_L3DO_GDfNRID_1110_Array();
			try
			{
			...
			catch (Exception ex)
			{
				...
				throw new Exception("Exception occured in method cls_Get_Documents_for_NoteRevisionID",ex);
			}
	...
	[Serializable]
	public class L3DO_GDfNRID_1110_raw 
	{
		...
		public static L3DO_GDfNRID_1110[] Convert(List<L3DO_GDfNRID_1110_raw> rawResult)
		{	
		    var gfunct_rawResult = rawResult;
			var groupResult = from el_L3DO_GDfNRID_1110 in gfunct_rawResult.Where(element => !EqualsDefaultValue(element.DOC_DocumentID)).ToArray()
	group el_L3DO_GDfNRID_1110 by new 
	{ 
		el_L3DO_GDfNRID_1110.DOC_DocumentID,

	}
	into gfunct_L3DO_GDfNRID_1110
	select new L3DO_GDfNRID_1110
	{     
		AssignmentID = gfunct_L3DO_GDfNRID_1110.FirstOrDefault().AssignmentID ,
		Structure_RefID = gfunct_L3DO_GDfNRID_1110.FirstOrDefault().Structure_RefID ,
		StructureHeader_RefID = gfunct_L3DO_GDfNRID_1110.FirstOrDefault().StructureHeader_RefID ,
		DOC_DocumentID = gfunct_L3DO_GDfNRID_1110.Key.DOC_DocumentID ,
		Alias = gfunct_L3DO_GDfNRID_1110.FirstOrDefault().Alias ,
		PrimaryType = gfunct_L3DO_GDfNRID_1110.FirstOrDefault().PrimaryType ,

		Revisions = 
		(
			from el_Revisions in gfunct_L3DO_GDfNRID_1110.Where(element => !EqualsDefaultValue(element.DOC_DocumentRevisionID)).ToArray()
	...
	[Serializable]
	public class FR_L3DO_GDfNRID_1110_Array : FR_Base
	{
		public L3DO_GDfNRID_1110[] Result	{ get; set; } 
		public FR_L3DO_GDfNRID_1110_Array() : base() {}

		public FR_L3DO_GDfNRID_1110_Array(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass P_L3DO_GDfNRID_1110 for attribute P_L3DO_GDfNRID_1110
		[DataContract]
		public class P_L3DO_GDfNRID_1110 
		{
		...
		#endregion
		#region SClass L3DO_GDfNRID_1110 for attribute L3DO_GDfNRID_1110
		[DataContract]
		public class L3DO_GDfNRID_1110 
		{
			[DataMember]
			public L3DO_GDfNRID_1110a[] Revisions { get; set; }
		...
		#endregion
		#region SClass L3DO_GDfNRID_1110a for attribute Revisions
		[DataContract]
		public class L3DO_GDfNRID_1110a 
		{
			//Standard type parameters
			[DataMember]
...
[OperationContract]
FR_L3DO_GDfNRID_1110_Array cls_Get_Documents_for_NoteRevisionID(,P_L3DO_GDfNRID_1110 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_L3DO_GDfNRID_1110_Array invocationResult = cls_Get_Documents_for_NoteRevisionID.Invoke(connectionString,P_L3DO_GDfNRID_1110 Parameter,securityTicket);
...
var parameter = new CL3_Document.Atomic.Retrieval.P_L3DO_GDfNRID_1110();
parameter.ID = ...;

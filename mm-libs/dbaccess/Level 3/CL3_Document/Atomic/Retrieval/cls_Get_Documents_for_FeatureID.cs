/* 
 * Generated on 12/16/2014 09:51:21
...
namespace CL3_Document.Atomic.Retrieval
{
    ...
    /// var result = cls_Get_Documents_for_FeatureID.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Get_Documents_for_FeatureID
	{
		public static readonly int QueryTimeout = 60;

		#region Method Execution
		protected static FR_L3DO_GDfFID_0843_Array Execute(DbConnection Connection,DbTransaction Transaction,P_L3DO_GDfFID_0843 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			var returnStatus = new FR_L3DO_GDfFID_0843_Array();

			DbCommand command = Connection.CreateCommand();
			command.Connection = Connection;
			command.Transaction = Transaction;
			var commandLocation = "CL3_Document.Atomic.Retrieval.SQL.cls_Get_Documents_for_FeatureID.sql";
			...
			List<L3DO_GDfFID_0843_raw> results = new List<L3DO_GDfFID_0843_raw>();
			...
			try
			{
				...
				while(reader.Read())
				{
					L3DO_GDfFID_0843_raw resultItem = new L3DO_GDfFID_0843_raw();
			...
			{
				reader.Close();
				throw new Exception("Exception occured durng data retrieval in method cls_Get_Documents_for_FeatureID",ex);
			}
			reader.Close();
			//Load all the dictionaries from the datatables
			loader.Load();

			returnStatus.Result = L3DO_GDfFID_0843_raw.Convert(results).ToArray();
			return returnStatus;
		}
		#endregion
		...
		///<summary>
		public static FR_L3DO_GDfFID_0843_Array Invoke(string ConnectionString,P_L3DO_GDfFID_0843 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L3DO_GDfFID_0843_Array Invoke(DbConnection Connection,P_L3DO_GDfFID_0843 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_L3DO_GDfFID_0843_Array Invoke(DbConnection Connection, DbTransaction Transaction,P_L3DO_GDfFID_0843 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_L3DO_GDfFID_0843_Array Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L3DO_GDfFID_0843 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			bool cleanupConnection = Connection == null;
			bool cleanupTransaction = Transaction == null;

			FR_L3DO_GDfFID_0843_Array functionReturn = new FR_L3DO_GDfFID_0843_Array();
			try
			{
			...
			catch (Exception ex)
			{
				...
				throw new Exception("Exception occured in method cls_Get_Documents_for_FeatureID",ex);
			}
	...
	[Serializable]
	public class L3DO_GDfFID_0843_raw 
	{
		...
		public static L3DO_GDfFID_0843[] Convert(List<L3DO_GDfFID_0843_raw> rawResult)
		{	
		    var gfunct_rawResult = rawResult;
			var groupResult = from el_L3DO_GDfFID_0843 in gfunct_rawResult.Where(element => !EqualsDefaultValue(element.DOC_DocumentID)).ToArray()
	group el_L3DO_GDfFID_0843 by new 
	{ 
		el_L3DO_GDfFID_0843.DOC_DocumentID,

	}
	into gfunct_L3DO_GDfFID_0843
	select new L3DO_GDfFID_0843
	{     
		AssignmentID = gfunct_L3DO_GDfFID_0843.FirstOrDefault().AssignmentID ,
		Structure_RefID = gfunct_L3DO_GDfFID_0843.FirstOrDefault().Structure_RefID ,
		StructureHeader_RefID = gfunct_L3DO_GDfFID_0843.FirstOrDefault().StructureHeader_RefID ,
		DOC_DocumentID = gfunct_L3DO_GDfFID_0843.Key.DOC_DocumentID ,
		Alias = gfunct_L3DO_GDfFID_0843.FirstOrDefault().Alias ,
		PrimaryType = gfunct_L3DO_GDfFID_0843.FirstOrDefault().PrimaryType ,

		Revisions = 
		(
			from el_Revisions in gfunct_L3DO_GDfFID_0843.Where(element => !EqualsDefaultValue(element.DOC_DocumentRevisionID)).ToArray()
	...
	[Serializable]
	public class FR_L3DO_GDfFID_0843_Array : FR_Base
	{
		public L3DO_GDfFID_0843[] Result	{ get; set; } 
		public FR_L3DO_GDfFID_0843_Array() : base() {}

		public FR_L3DO_GDfFID_0843_Array(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass P_L3DO_GDfFID_0843 for attribute P_L3DO_GDfFID_0843
		[DataContract]
		public class P_L3DO_GDfFID_0843 
		{
		...
		#endregion
		#region SClass L3DO_GDfFID_0843 for attribute L3DO_GDfFID_0843
		[DataContract]
		public class L3DO_GDfFID_0843 
		{
			[DataMember]
			public L3DO_GDfFID_0843a[] Revisions { get; set; }
		...
		#endregion
		#region SClass L3DO_GDfFID_0843a for attribute Revisions
		[DataContract]
		public class L3DO_GDfFID_0843a 
		{
			//Standard type parameters
			[DataMember]
...
[OperationContract]
FR_L3DO_GDfFID_0843_Array cls_Get_Documents_for_FeatureID(,P_L3DO_GDfFID_0843 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_L3DO_GDfFID_0843_Array invocationResult = cls_Get_Documents_for_FeatureID.Invoke(connectionString,P_L3DO_GDfFID_0843 Parameter,securityTicket);
...
var parameter = new CL3_Document.Atomic.Retrieval.P_L3DO_GDfFID_0843();
parameter.ID = ...;

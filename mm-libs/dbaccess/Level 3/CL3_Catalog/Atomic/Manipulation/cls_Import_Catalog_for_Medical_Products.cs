/* 
 * Generated on 1/17/2014 3:13:29 PM
...
namespace CL3_Catalog.Atomic.Manipulation
{
    ...
    /// var result = cls_Import_Catalog_for_Medical_Products.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Import_Catalog_for_Medical_Products
	{
		...
		///<summary>
		public static FR_Guid Invoke(string ConnectionString,P_L3ICafMP_1134 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Guid Invoke(DbConnection Connection,P_L3ICafMP_1134 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_Guid Invoke(DbConnection Connection, DbTransaction Transaction,P_L3ICafMP_1134 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		protected static FR_Guid Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_L3ICafMP_1134 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			...
			catch (Exception ex)
			{
				...
				throw new Exception("Exception occured in method cls_Import_Catalog_for_Medical_Products",ex);
			}
	...
	#region Support Classes
		#region SClass P_L3ICafMP_1134 for attribute P_L3ICafMP_1134
		[DataContract]
		public class P_L3ICafMP_1134 
		{
			[DataMember]
			public P_L3ICafMP_1134_Products[] Products { get; set; }
			[DataMember]
			public P_L3ICafMP_1134_SupplierData SupplierData { get; set; }
		...
		#endregion
		#region SClass P_L3ICafMP_1134_Products for attribute Products
		[DataContract]
		public class P_L3ICafMP_1134_Products 
		{
			//Standard type parameters
			[DataMember]
		...
		#endregion
		#region SClass P_L3ICafMP_1134_SupplierData for attribute SupplierData
		[DataContract]
		public class P_L3ICafMP_1134_SupplierData 
		{
			//Standard type parameters
			[DataMember]
...
[OperationContract]
FR_Guid cls_Import_Catalog_for_Medical_Products(,P_L3ICafMP_1134 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_Guid invocationResult = cls_Import_Catalog_for_Medical_Products.Invoke(connectionString,P_L3ICafMP_1134 Parameter,securityTicket);
...
var parameter = new CL3_Catalog.Atomic.Manipulation.P_L3ICafMP_1134();
parameter.Products = ...;

/* 
 * Generated on 2.2.2015 16:31:35
...
namespace CL3_DistributionArea.Atomic.Retrieval
{
    ...
    /// var result = cls_Get_All_DistributionArea2Country_Assignments.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Get_All_DistributionArea2Country_Assignments
	{
		...
		protected static FR_Guids Execute(DbConnection Connection,DbTransaction Transaction,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			...
			var commandLocation = "CL3_DistributionArea.Atomic.Retrieval.SQL.cls_Get_All_DistributionArea2Country_Assignments.sql";
			...
			{
				reader.Close();
				throw new Exception("Exception occured durng data retrieval in method cls_Get_All_DistributionArea2Country_Assignments",ex);
			}
		...
		protected static FR_Guids Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			...
			catch (Exception ex)
			{
				...
				throw new Exception("Exception occured in method cls_Get_All_DistributionArea2Country_Assignments",ex);
			}
...
[OperationContract]
FR_Guids cls_Get_All_DistributionArea2Country_Assignments(string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_Guids invocationResult = cls_Get_All_DistributionArea2Country_Assignments.Invoke(connectionString,securityTicket);

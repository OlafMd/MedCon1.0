...
{
	[Serializable]
	public class ORM_BIL_BillPosition_2_Product
	{
		public static readonly string TableName = "bil_billposition_2_product";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_BIL_BillPosition_2_Product()
		{
		...
		private String _Quantity = default(String);
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_BIL.BIL_BillPosition_2_Product.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_BIL.BIL_BillPosition_2_Product.SQL.Insert.sql")).ReadToEnd();
					}
		...
		private FR_Base Load(DbConnection Connection, DbTransaction Transaction, Guid ObjectID, string ConnectionString)
		{
			...
			try
			{
				...
				string SelectQuery = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_BIL.BIL_BillPosition_2_Product.SQL.Select.sql")).ReadToEnd();
				...
				try
				{
					...
					reader.SetOrdinals(new string[] { "AssignmentID","BIL_BillPosition_RefID","CMN_PRO_Product_RefID","CMN_PRO_Product_Variant_RefID","CMN_PRO_Product_Release_RefID","LOG_ProductTrackingInstance_RefID","Quantity","Comment","Creation_Timestamp","Tenant_RefID","IsDeleted" });
					if (reader.HasRows == true)
					{
						...
						//5:Parameter LOG_ProductTrackingInstance_RefID of type Guid
						_LOG_ProductTrackingInstance_RefID = reader.GetGuid(5);
						//6:Parameter Quantity of type String
						_Quantity = reader.GetString(6);
		...
		public class Query : CSV2Core_MySQL.BaseFilterQuery<Query>
        {
			...
			#region Search
			public static List<ORM_BIL_BillPosition_2_Product> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_BIL_BillPosition_2_Product> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_BIL_BillPosition_2_Product> Search(DbConnection connection, DbTransaction transaction, Query query)
			{
			    return Query.Search(query, null, connection, transaction);
			}

			private static List<ORM_BIL_BillPosition_2_Product> Search(Query query, string connectionString, DbConnection connection, DbTransaction transaction)
			{
				CSV2Core.Core.Interfaces.IManagedConnection managedConnection = new CSV2Core_MySQL.MySQLManagedConnection();
			    List<ORM_BIL_BillPosition_2_Product> items;
				...
				try
			    {
			        ...
			        items = new List<ORM_BIL_BillPosition_2_Product>();

			        var reader = new CSV2Core_MySQL.Support.DBSQLReader(command.ExecuteReader());
					reader.SetOrdinals(new string[] { "AssignmentID","BIL_BillPosition_RefID","CMN_PRO_Product_RefID","CMN_PRO_Product_Variant_RefID","CMN_PRO_Product_Release_RefID","LOG_ProductTrackingInstance_RefID","Quantity","Comment","Creation_Timestamp","Tenant_RefID","IsDeleted" });
			        while (reader.Read())
			        {
			            ORM_BIL_BillPosition_2_Product item = new ORM_BIL_BillPosition_2_Product();
						//0:Parameter AssignmentID of type Guid
						...
						//5:Parameter LOG_ProductTrackingInstance_RefID of type Guid
						item.LOG_ProductTrackingInstance_RefID = reader.GetGuid(5);
						//6:Parameter Quantity of type String
						item.Quantity = reader.GetString(6);
						//7:Parameter Comment of type String

/* 
 * Generated on 8/27/2014 2:12:23 PM
...
{
	[Serializable]
	public class ORM_ORD_CUO_RFP_IssuedProposalResponse_Position
	{
		public static readonly string TableName = "ord_cuo_rfp_issuedproposalresponse_positions";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_ORD_CUO_RFP_IssuedProposalResponse_Position()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_ORD_CUO_RFP_IssuedProposalResponse_PositionID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _ORD_CUO_RFP_IssuedProposalResponse_PositionID = default(Guid);
		...
		public Guid ORD_CUO_RFP_IssuedProposalResponse_PositionID { 
			get {
				return _ORD_CUO_RFP_IssuedProposalResponse_PositionID;
			}
			set {
				if(_ORD_CUO_RFP_IssuedProposalResponse_PositionID != value){
					_ORD_CUO_RFP_IssuedProposalResponse_PositionID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		private FR_Base Load(DbConnection Connection, DbTransaction Transaction, Guid ObjectID, string ConnectionString)
		{
			...
			try
			{
				...
				string SelectQuery = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_ORD_CUO_RFP.ORD_CUO_RFP_IssuedProposalResponse_Position.SQL.Select.sql")).ReadToEnd();
				...
				_ORD_CUO_RFP_IssuedProposalResponse_PositionID = Guid.Empty;
				CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command,"ORD_CUO_RFP_IssuedProposalResponse_PositionID", ObjectID );
				...
				try
				{
					...
					reader.SetOrdinals(new string[] { "ORD_CUO_RFP_IssuedProposalResponse_PositionID","ProposalResponsePositionITPL","IssuedProposalResponseHeader_RefID","CMN_PRO_Product_RefID","CMN_PRO_Product_Variant_RefID","CMN_PRO_Product_Release_RefID","CreatedFrom_RequestForProposal_Position_RefID","Quantity","TotalPrice_WithoutTax","TotalPrice_IncludingTax","PricePerUnit_WithoutTax","PricePerUnit_IncludingTax","IsReplacementProduct","Creation_Timestamp","Tenant_RefID","IsDeleted" });
					if (reader.HasRows == true)
					{
						reader.Read(); //Single result only
						//0:Parameter ORD_CUO_RFP_IssuedProposalResponse_PositionID of type Guid
						_ORD_CUO_RFP_IssuedProposalResponse_PositionID = reader.GetGuid(0);
					...
					if(_ORD_CUO_RFP_IssuedProposalResponse_PositionID != Guid.Empty){
						//Successfully loaded
						Status_IsAlreadySaved = true;
						Status_IsDirty = false;
					} else {
        ...
        {
			public Guid? ORD_CUO_RFP_IssuedProposalResponse_PositionID {	get; set; }
			...
			#region Search
			public static List<ORM_ORD_CUO_RFP_IssuedProposalResponse_Position> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_ORD_CUO_RFP_IssuedProposalResponse_Position> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_ORD_CUO_RFP_IssuedProposalResponse_Position> Search(DbConnection connection, DbTransaction transaction, Query query)
			{
			    return Query.Search(query, null, connection, transaction);
			}

			private static List<ORM_ORD_CUO_RFP_IssuedProposalResponse_Position> Search(Query query, string connectionString, DbConnection connection, DbTransaction transaction)
			{
				CSV2Core.Core.Interfaces.IManagedConnection managedConnection = new CSV2Core_MySQL.MySQLManagedConnection();
			    List<ORM_ORD_CUO_RFP_IssuedProposalResponse_Position> items;
				...
				try
			    {
			        ...
			        items = new List<ORM_ORD_CUO_RFP_IssuedProposalResponse_Position>();

			        var reader = new CSV2Core_MySQL.Support.DBSQLReader(command.ExecuteReader());
					reader.SetOrdinals(new string[] { "ORD_CUO_RFP_IssuedProposalResponse_PositionID","ProposalResponsePositionITPL","IssuedProposalResponseHeader_RefID","CMN_PRO_Product_RefID","CMN_PRO_Product_Variant_RefID","CMN_PRO_Product_Release_RefID","CreatedFrom_RequestForProposal_Position_RefID","Quantity","TotalPrice_WithoutTax","TotalPrice_IncludingTax","PricePerUnit_WithoutTax","PricePerUnit_IncludingTax","IsReplacementProduct","Creation_Timestamp","Tenant_RefID","IsDeleted" });
			        while (reader.Read())
			        {
			            ORM_ORD_CUO_RFP_IssuedProposalResponse_Position item = new ORM_ORD_CUO_RFP_IssuedProposalResponse_Position();
						//0:Parameter ORD_CUO_RFP_IssuedProposalResponse_PositionID of type Guid
						item.ORD_CUO_RFP_IssuedProposalResponse_PositionID = reader.GetGuid(0);
						//1:Parameter ProposalResponsePositionITPL of type String

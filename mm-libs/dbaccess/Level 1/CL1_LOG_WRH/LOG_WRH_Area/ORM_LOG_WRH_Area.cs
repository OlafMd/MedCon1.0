/* 
 * Generated on 18/8/2014 01:45:44
...
{
	[Serializable]
	public class ORM_LOG_WRH_Area
	{
		public static readonly string TableName = "log_wrh_areas";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_LOG_WRH_Area()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_LOG_WRH_AreaID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _LOG_WRH_AreaID = default(Guid);
		private String _GlobalPropertyMatchingID = default(String);
		private String _CoordinateCode = default(String);
		private String _Area_Name = default(String);
		private Guid _Warehouse_RefID = default(Guid);
		private Boolean _IsStructureHidden = default(Boolean);
		private Boolean _IsConsignmentArea = default(Boolean);
		private Guid _IfConsignmentArea_DefaultOwningSupplier_RefID = default(Guid);
		private String _Rack_NamePrefix = default(String);
		private Boolean _IsPointOfSalesArea = default(Boolean);
		private Boolean _IsLongTermStorageArea = default(Boolean);
		private Boolean _IsCrossDockArea = default(Boolean);
		private Boolean _IsDefaultIntakeArea = default(Boolean);
		...
		public Guid LOG_WRH_AreaID { 
			get {
				return _LOG_WRH_AreaID;
			}
			set {
				if(_LOG_WRH_AreaID != value){
					_LOG_WRH_AreaID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		public Boolean IsConsignmentArea { 
			get {
				return _IsConsignmentArea;
			}
			set {
				if(_IsConsignmentArea != value){
					_IsConsignmentArea = value;
					Status_IsDirty = true;
				}
			}
		} 
		public Guid IfConsignmentArea_DefaultOwningSupplier_RefID { 
			get {
				return _IfConsignmentArea_DefaultOwningSupplier_RefID;
			}
			set {
				if(_IfConsignmentArea_DefaultOwningSupplier_RefID != value){
					_IfConsignmentArea_DefaultOwningSupplier_RefID = value;
					Status_IsDirty = true;
				}
			}
		} 
		public String Rack_NamePrefix { 
			get {
				return _Rack_NamePrefix;
			}
			set {
				if(_Rack_NamePrefix != value){
					_Rack_NamePrefix = value;
					Status_IsDirty = true;
				}
			}
		} 
		public Boolean IsPointOfSalesArea { 
			get {
				return _IsPointOfSalesArea;
			}
			set {
				if(_IsPointOfSalesArea != value){
					_IsPointOfSalesArea = value;
					Status_IsDirty = true;
				}
			}
		} 
		public Boolean IsLongTermStorageArea { 
			get {
				return _IsLongTermStorageArea;
			}
			set {
				if(_IsLongTermStorageArea != value){
					_IsLongTermStorageArea = value;
					Status_IsDirty = true;
				}
			}
		} 
		public Boolean IsCrossDockArea { 
			get {
				return _IsCrossDockArea;
			}
			set {
				if(_IsCrossDockArea != value){
					_IsCrossDockArea = value;
					Status_IsDirty = true;
				}
			}
		} 
		public Boolean IsDefaultIntakeArea { 
			get {
				return _IsDefaultIntakeArea;
			}
			set {
				if(_IsDefaultIntakeArea != value){
					_IsDefaultIntakeArea = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		public class Query : CSV2Core_MySQL.BaseFilterQuery<Query>
        {
			...
			public Boolean? IsCrossDockArea {	get; set; }
			...
			#region Search
			public static List<ORM_LOG_WRH_Area> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_LOG_WRH_Area> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_LOG_WRH_Area> Search(DbConnection connection, DbTransaction transaction, Query query)
			{
			    return Query.Search(query, null, connection, transaction);
			}

			private static List<ORM_LOG_WRH_Area> Search(Query query, string connectionString, DbConnection connection, DbTransaction transaction)
			{
				CSV2Core.Core.Interfaces.IManagedConnection managedConnection = new CSV2Core_MySQL.MySQLManagedConnection();
			    List<ORM_LOG_WRH_Area> items;
				...
				try
			    {
			        ...
			        items = new List<ORM_LOG_WRH_Area>();

			        var reader = new CSV2Core_MySQL.Support.DBSQLReader(command.ExecuteReader());
					reader.SetOrdinals(new string[] { "LOG_WRH_AreaID","GlobalPropertyMatchingID","CoordinateCode","Area_Name","Warehouse_RefID","IsStructureHidden","IsConsignmentArea","IfConsignmentArea_DefaultOwningSupplier_RefID","Rack_NamePrefix","IsPointOfSalesArea","IsLongTermStorageArea","IsCrossDockArea","IsDefaultIntakeArea","Creation_Timestamp","Tenant_RefID","IsDeleted" });
			        while (reader.Read())
			        {
			            ORM_LOG_WRH_Area item = new ORM_LOG_WRH_Area();
						//0:Parameter LOG_WRH_AreaID of type Guid
						item.LOG_WRH_AreaID = reader.GetGuid(0);
						//1:Parameter GlobalPropertyMatchingID of type String
						item.GlobalPropertyMatchingID = reader.GetString(1);
						//2:Parameter CoordinateCode of type String
						item.CoordinateCode = reader.GetString(2);
						//3:Parameter Area_Name of type String
						item.Area_Name = reader.GetString(3);
						//4:Parameter Warehouse_RefID of type Guid
						item.Warehouse_RefID = reader.GetGuid(4);
						//5:Parameter IsStructureHidden of type Boolean
						item.IsStructureHidden = reader.GetBoolean(5);
						//6:Parameter IsConsignmentArea of type Boolean
						item.IsConsignmentArea = reader.GetBoolean(6);
						//7:Parameter IfConsignmentArea_DefaultOwningSupplier_RefID of type Guid
						item.IfConsignmentArea_DefaultOwningSupplier_RefID = reader.GetGuid(7);
						//8:Parameter Rack_NamePrefix of type String
						item.Rack_NamePrefix = reader.GetString(8);
						//9:Parameter IsPointOfSalesArea of type Boolean
						item.IsPointOfSalesArea = reader.GetBoolean(9);
						//10:Parameter IsLongTermStorageArea of type Boolean
						item.IsLongTermStorageArea = reader.GetBoolean(10);
						//11:Parameter IsCrossDockArea of type Boolean
						item.IsCrossDockArea = reader.GetBoolean(11);
						//12:Parameter IsDefaultIntakeArea of type Boolean
						item.IsDefaultIntakeArea = reader.GetBoolean(12);
						//13:Parameter Creation_Timestamp of type DateTime

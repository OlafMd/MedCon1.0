/* 
 * Generated on 11/15/2013 4:31:51 PM
...
{
	[Serializable]
	public class ORM_LOG_WRH_Area_2_QuantityLevel
	{
		public static readonly string TableName = "log_wrh_area_2_quantitylevels";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_LOG_WRH_Area_2_QuantityLevel()
		{
		...
		private Guid _LOG_WRH_Area_RefID = default(Guid);
		...
		public Guid LOG_WRH_Area_RefID { 
			get {
				return _LOG_WRH_Area_RefID;
			}
			set {
				if(_LOG_WRH_Area_RefID != value){
					_LOG_WRH_Area_RefID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		public class Query : CSV2Core_MySQL.BaseFilterQuery<Query>
        {
			...
			public Guid? LOG_WRH_Area_RefID {	get; set; }
			...
			#region Search
			public static List<ORM_LOG_WRH_Area_2_QuantityLevel> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_LOG_WRH_Area_2_QuantityLevel> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_LOG_WRH_Area_2_QuantityLevel> Search(DbConnection connection, DbTransaction transaction, Query query)
			{
			    return Query.Search(query, null, connection, transaction);
			}

			private static List<ORM_LOG_WRH_Area_2_QuantityLevel> Search(Query query, string connectionString, DbConnection connection, DbTransaction transaction)
			{
				CSV2Core.Core.Interfaces.IManagedConnection managedConnection = new CSV2Core_MySQL.MySQLManagedConnection();
			    List<ORM_LOG_WRH_Area_2_QuantityLevel> items;
				...
				try
			    {
			        ...
			        items = new List<ORM_LOG_WRH_Area_2_QuantityLevel>();

			        var reader = new CSV2Core_MySQL.Support.DBSQLReader(command.ExecuteReader());
					reader.SetOrdinals(new string[] { "AssignmentID","LOG_WRH_Area_RefID","LOG_WRH_QuantityLevel_RefID","Creation_Timestamp","Tenant_RefID","IsDeleted" });
			        while (reader.Read())
			        {
			            ORM_LOG_WRH_Area_2_QuantityLevel item = new ORM_LOG_WRH_Area_2_QuantityLevel();
						//0:Parameter AssignmentID of type Guid
						item.AssignmentID = reader.GetGuid(0);
						//1:Parameter LOG_WRH_Area_RefID of type Guid
						item.LOG_WRH_Area_RefID = reader.GetGuid(1);
						//2:Parameter LOG_WRH_QuantityLevel_RefID of type Guid

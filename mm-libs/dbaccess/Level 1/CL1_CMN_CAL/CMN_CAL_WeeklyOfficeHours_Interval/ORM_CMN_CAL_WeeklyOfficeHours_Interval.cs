...
{
	[Serializable]
	public class ORM_CMN_CAL_WeeklyOfficeHours_Interval
	{
		public static readonly string TableName = "cmn_cal_weeklyofficehours_intervals";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_CMN_CAL_WeeklyOfficeHours_Interval()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_CMN_CAL_WeeklyOfficeHours_IntervalID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _CMN_CAL_WeeklyOfficeHours_IntervalID = default(Guid);
		private Guid _WeeklyOfficeHours_Template_RefID = default(Guid);
		private Boolean _IsWholeDay = default(Boolean);
		private long _TimeFrom_InMinutes = default(long);
		private long _TimeTo_InMinutes = default(long);
		...
		public Guid CMN_CAL_WeeklyOfficeHours_IntervalID { 
			get {
				return _CMN_CAL_WeeklyOfficeHours_IntervalID;
			}
			set {
				if(_CMN_CAL_WeeklyOfficeHours_IntervalID != value){
					_CMN_CAL_WeeklyOfficeHours_IntervalID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		public long TimeFrom_InMinutes { 
			get {
				return _TimeFrom_InMinutes;
			}
			set {
				if(_TimeFrom_InMinutes != value){
					_TimeFrom_InMinutes = value;
					Status_IsDirty = true;
				}
			}
		} 
		public long TimeTo_InMinutes { 
			get {
				return _TimeTo_InMinutes;
			}
			set {
				if(_TimeTo_InMinutes != value){
					_TimeTo_InMinutes = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_CMN_CAL.CMN_CAL_WeeklyOfficeHours_Interval.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_CMN_CAL.CMN_CAL_WeeklyOfficeHours_Interval.SQL.Insert.sql")).ReadToEnd();
					}
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "CMN_CAL_WeeklyOfficeHours_IntervalID", _CMN_CAL_WeeklyOfficeHours_IntervalID);
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "IsWholeDay", _IsWholeDay);
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "TimeFrom_InMinutes", _TimeFrom_InMinutes);
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "TimeTo_InMinutes", _TimeTo_InMinutes);
		...
		public class Query : CSV2Core_MySQL.BaseFilterQuery<Query>
        {
			...
			#region Search
			public static List<ORM_CMN_CAL_WeeklyOfficeHours_Interval> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_CMN_CAL_WeeklyOfficeHours_Interval> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_CMN_CAL_WeeklyOfficeHours_Interval> Search(DbConnection connection, DbTransaction transaction, Query query)
			{

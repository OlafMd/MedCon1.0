...
{
	[Serializable]
	public class ORM_IMO_QuestionnaireStatus_2_QuestionnaireAction
	{
		public static readonly string TableName = "imo_questionnairestatus_2_questionnaireaction";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_IMO_QuestionnaireStatus_2_QuestionnaireAction()
		{
		...
		private Guid _QuestionnaireAction_RefID = default(Guid);
		private Guid _QuestionnaireStatus_RefID = default(Guid);
		...
		public Guid QuestionnaireAction_RefID { 
			get {
				return _QuestionnaireAction_RefID;
			}
			set {
				if(_QuestionnaireAction_RefID != value){
					_QuestionnaireAction_RefID = value;
					Status_IsDirty = true;
				}
			}
		} 
		public Guid QuestionnaireStatus_RefID { 
			get {
				return _QuestionnaireStatus_RefID;
			}
			set {
				if(_QuestionnaireStatus_RefID != value){
					_QuestionnaireStatus_RefID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_IMO.IMO_QuestionnaireStatus_2_QuestionnaireAction.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_IMO.IMO_QuestionnaireStatus_2_QuestionnaireAction.SQL.Insert.sql")).ReadToEnd();
					}
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "QuestionnaireAction_RefID", _QuestionnaireAction_RefID);
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "QuestionnaireStatus_RefID", _QuestionnaireStatus_RefID);
		...
		private FR_Base Load(DbConnection Connection, DbTransaction Transaction, Guid ObjectID, string ConnectionString)
		{
			...
			try
			{
				...
				string SelectQuery = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_IMO.IMO_QuestionnaireStatus_2_QuestionnaireAction.SQL.Select.sql")).ReadToEnd();
				...
				try
				{
					...
					if (reader.HasRows == true)
					{
						...
						_QuestionnaireAction_RefID = reader.GetGuid(1);
						//2:Parameter QuestionnaireStatus_RefID of type Guid
						_QuestionnaireStatus_RefID = reader.GetGuid(2);
						//3:Parameter Default_Timeframe_RefID of type Guid
						_Default_Timeframe_RefID = reader.GetGuid(3);
		...
		public class Query : CSV2Core_MySQL.BaseFilterQuery<Query>
        {
			...
			public Guid? QuestionnaireAction_RefID {	get; set; }
			public Guid? QuestionnaireStatus_RefID {	get; set; }
			...
			#region Search
			public static List<ORM_IMO_QuestionnaireStatus_2_QuestionnaireAction> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_IMO_QuestionnaireStatus_2_QuestionnaireAction> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_IMO_QuestionnaireStatus_2_QuestionnaireAction> Search(DbConnection connection, DbTransaction transaction, Query query)
			{

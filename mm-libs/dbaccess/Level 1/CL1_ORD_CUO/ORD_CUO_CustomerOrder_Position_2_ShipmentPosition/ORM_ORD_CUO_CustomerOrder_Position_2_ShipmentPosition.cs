/* 
 * Generated on 4/7/2014 11:05:40 AM
...
{
	[Serializable]
	public class ORM_ORD_CUO_CustomerOrder_Position_2_ShipmentPosition
	{
		public static readonly string TableName = "ord_cuo_customerorder_position_2_shipmentposition";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_ORD_CUO_CustomerOrder_Position_2_ShipmentPosition()
		{
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_ORD_CUO.ORD_CUO_CustomerOrder_Position_2_ShipmentPosition.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_ORD_CUO.ORD_CUO_CustomerOrder_Position_2_ShipmentPosition.SQL.Insert.sql")).ReadToEnd();
					}
		...
		private FR_Base Load(DbConnection Connection, DbTransaction Transaction, Guid ObjectID, string ConnectionString)
		{
			...
			try
			{
				...
				string SelectQuery = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_ORD_CUO.ORD_CUO_CustomerOrder_Position_2_ShipmentPosition.SQL.Select.sql")).ReadToEnd();
				...
				try
				{
					...
					if (reader.HasRows == true)
					{
						...
						_ORD_CUO_CustomerOrder_Position_RefID = reader.GetGuid(1);
		...
		public class Query : CSV2Core_MySQL.BaseFilterQuery<Query>
        {
			...
			#region Search
			public static List<ORM_ORD_CUO_CustomerOrder_Position_2_ShipmentPosition> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_ORD_CUO_CustomerOrder_Position_2_ShipmentPosition> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_ORD_CUO_CustomerOrder_Position_2_ShipmentPosition> Search(DbConnection connection, DbTransaction transaction, Query query)
			{

/* 
 * Generated on 7/28/2014 2:42:18 PM
...
{
	[Serializable]
	public class ORM_ORD_CUO_CustomerOrder_Note
	{
		public static readonly string TableName = "ord_cuo_customerorder_notes";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_ORD_CUO_CustomerOrder_Note()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_ORD_CUO_CustomerOrder_NoteID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _ORD_CUO_CustomerOrder_NoteID = default(Guid);
		...
		public Guid ORD_CUO_CustomerOrder_NoteID { 
			get {
				return _ORD_CUO_CustomerOrder_NoteID;
			}
			set {
				if(_ORD_CUO_CustomerOrder_NoteID != value){
					_ORD_CUO_CustomerOrder_NoteID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_ORD_CUO.ORD_CUO_CustomerOrder_Note.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_ORD_CUO.ORD_CUO_CustomerOrder_Note.SQL.Insert.sql")).ReadToEnd();
					}
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "ORD_CUO_CustomerOrder_NoteID", _ORD_CUO_CustomerOrder_NoteID);
		...
		public class Query : CSV2Core_MySQL.BaseFilterQuery<Query>
        {
			...
			#region Search
			public static List<ORM_ORD_CUO_CustomerOrder_Note> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_ORD_CUO_CustomerOrder_Note> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_ORD_CUO_CustomerOrder_Note> Search(DbConnection connection, DbTransaction transaction, Query query)
			{

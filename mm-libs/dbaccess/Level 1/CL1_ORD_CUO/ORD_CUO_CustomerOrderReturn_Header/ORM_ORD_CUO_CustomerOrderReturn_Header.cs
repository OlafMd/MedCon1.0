/* 
 * Generated on 6/3/2014 3:58:09 PM
...
{
	[Serializable]
	public class ORM_ORD_CUO_CustomerOrderReturn_Header
	{
		public static readonly string TableName = "ord_cuo_customerorderreturn_headers";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_ORD_CUO_CustomerOrderReturn_Header()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_ORD_CUO_CustomerOrderReturn_HeaderID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _ORD_CUO_CustomerOrderReturn_HeaderID = default(Guid);
		private Guid _Customer_RefID = default(Guid);
		private Guid _CorrespondingReceiptHeader_RefID = default(Guid);
		private DateTime _DateOfCustomerReturn = default(DateTime);
		private String _CustomerOrderReturnNumber = default(String);
		private Guid _Currency_RefID = default(Guid);
		private Decimal _TotalValueBeforeTax = default(Decimal);
		private Guid _Customer_BillingAddressUCD_RefID = default(Guid);
		...
		public Guid ORD_CUO_CustomerOrderReturn_HeaderID { 
			get {
				return _ORD_CUO_CustomerOrderReturn_HeaderID;
			}
			set {
				if(_ORD_CUO_CustomerOrderReturn_HeaderID != value){
					_ORD_CUO_CustomerOrderReturn_HeaderID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		public Guid CorrespondingReceiptHeader_RefID { 
			get {
				return _CorrespondingReceiptHeader_RefID;
			}
			set {
				if(_CorrespondingReceiptHeader_RefID != value){
					_CorrespondingReceiptHeader_RefID = value;
					Status_IsDirty = true;
				}
			}
		} 
		public DateTime DateOfCustomerReturn { 
			get {
				return _DateOfCustomerReturn;
			}
			set {
				if(_DateOfCustomerReturn != value){
					_DateOfCustomerReturn = value;
					Status_IsDirty = true;
				}
			}
		} 
		public String CustomerOrderReturnNumber { 
			get {
				return _CustomerOrderReturnNumber;
			}
			set {
				if(_CustomerOrderReturnNumber != value){
					_CustomerOrderReturnNumber = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		public Decimal TotalValueBeforeTax { 
			get {
				return _TotalValueBeforeTax;
			}
			set {
				if(_TotalValueBeforeTax != value){
					_TotalValueBeforeTax = value;
					Status_IsDirty = true;
				}
			}
		} 
		public Guid Customer_BillingAddressUCD_RefID { 
			get {
				return _Customer_BillingAddressUCD_RefID;
			}
			set {
				if(_Customer_BillingAddressUCD_RefID != value){
					_Customer_BillingAddressUCD_RefID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		public class Query : CSV2Core_MySQL.BaseFilterQuery<Query>
        {
			...
			public Guid? CorrespondingReceiptHeader_RefID {	get; set; }
			...
			#region Search
			public static List<ORM_ORD_CUO_CustomerOrderReturn_Header> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_ORD_CUO_CustomerOrderReturn_Header> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_ORD_CUO_CustomerOrderReturn_Header> Search(DbConnection connection, DbTransaction transaction, Query query)
			{
			    return Query.Search(query, null, connection, transaction);
			}

			private static List<ORM_ORD_CUO_CustomerOrderReturn_Header> Search(Query query, string connectionString, DbConnection connection, DbTransaction transaction)
			{
				CSV2Core.Core.Interfaces.IManagedConnection managedConnection = new CSV2Core_MySQL.MySQLManagedConnection();
			    List<ORM_ORD_CUO_CustomerOrderReturn_Header> items;
				...
				try
			    {
			        ...
			        items = new List<ORM_ORD_CUO_CustomerOrderReturn_Header>();

			        var reader = new CSV2Core_MySQL.Support.DBSQLReader(command.ExecuteReader());
					reader.SetOrdinals(new string[] { "ORD_CUO_CustomerOrderReturn_HeaderID","Customer_RefID","CorrespondingReceiptHeader_RefID","DateOfCustomerReturn","CustomerOrderReturnNumber","Currency_RefID","TotalValueBeforeTax","Customer_BillingAddressUCD_RefID","Creation_Timestamp","Tenant_RefID","IsDeleted" });
			        while (reader.Read())
			        {
			            ORM_ORD_CUO_CustomerOrderReturn_Header item = new ORM_ORD_CUO_CustomerOrderReturn_Header();
						//0:Parameter ORD_CUO_CustomerOrderReturn_HeaderID of type Guid
						item.ORD_CUO_CustomerOrderReturn_HeaderID = reader.GetGuid(0);
						//1:Parameter Customer_RefID of type Guid
						item.Customer_RefID = reader.GetGuid(1);
						//2:Parameter CorrespondingReceiptHeader_RefID of type Guid
						item.CorrespondingReceiptHeader_RefID = reader.GetGuid(2);
						//3:Parameter DateOfCustomerReturn of type DateTime
						item.DateOfCustomerReturn = reader.GetDate(3);
						//4:Parameter CustomerOrderReturnNumber of type String
						item.CustomerOrderReturnNumber = reader.GetString(4);
						//5:Parameter Currency_RefID of type Guid
						item.Currency_RefID = reader.GetGuid(5);
						//6:Parameter TotalValueBeforeTax of type Decimal
						item.TotalValueBeforeTax = reader.GetDecimal(6);
						//7:Parameter Customer_BillingAddressUCD_RefID of type Guid
						item.Customer_BillingAddressUCD_RefID = reader.GetGuid(7);
						//8:Parameter Creation_Timestamp of type DateTime

...
{
	[Serializable]
	public class ORM_ORD_CUO_CustomerOrder_Position
	{
		public static readonly string TableName = "ord_cuo_customerorder_positions";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_ORD_CUO_CustomerOrder_Position()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_ORD_CUO_CustomerOrder_PositionID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _ORD_CUO_CustomerOrder_PositionID = default(Guid);
		private String _CustomerProcurementOrderPositionITL = default(String);
		...
		public Guid ORD_CUO_CustomerOrder_PositionID { 
			get {
				return _ORD_CUO_CustomerOrder_PositionID;
			}
			set {
				if(_ORD_CUO_CustomerOrder_PositionID != value){
					_ORD_CUO_CustomerOrder_PositionID = value;
					Status_IsDirty = true;
				}
			}
		} 
		public String CustomerProcurementOrderPositionITL { 
			get {
				return _CustomerProcurementOrderPositionITL;
			}
			set {
				if(_CustomerProcurementOrderPositionITL != value){
					_CustomerProcurementOrderPositionITL = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_ORD_CUO.ORD_CUO_CustomerOrder_Position.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_ORD_CUO.ORD_CUO_CustomerOrder_Position.SQL.Insert.sql")).ReadToEnd();
					}
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "ORD_CUO_CustomerOrder_PositionID", _ORD_CUO_CustomerOrder_PositionID);
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "CustomerProcurementOrderPositionITL", _CustomerProcurementOrderPositionITL);
		...
		public class Query : CSV2Core_MySQL.BaseFilterQuery<Query>
        {
			...
			public String CustomerProcurementOrderPositionITL {	get; set; }
			...
			#region Search
			public static List<ORM_ORD_CUO_CustomerOrder_Position> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_ORD_CUO_CustomerOrder_Position> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_ORD_CUO_CustomerOrder_Position> Search(DbConnection connection, DbTransaction transaction, Query query)
			{

/* 
 * Generated on 2/17/2015 4:12:07 PM
...
{
	[Serializable]
	public class ORM_DOC_DocumentTemplate_2_BusinessParticipant
	{
		public static readonly string TableName = "doc_documenttemplate_2_businessparticipant";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_DOC_DocumentTemplate_2_BusinessParticipant()
		{
		...
		public class Query : CSV2Core_MySQL.BaseFilterQuery<Query>
        {
			...
			#region Search
			public static List<ORM_DOC_DocumentTemplate_2_BusinessParticipant> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_DOC_DocumentTemplate_2_BusinessParticipant> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_DOC_DocumentTemplate_2_BusinessParticipant> Search(DbConnection connection, DbTransaction transaction, Query query)
			{
			    return Query.Search(query, null, connection, transaction);
			}

			private static List<ORM_DOC_DocumentTemplate_2_BusinessParticipant> Search(Query query, string connectionString, DbConnection connection, DbTransaction transaction)
			{
				CSV2Core.Core.Interfaces.IManagedConnection managedConnection = new CSV2Core_MySQL.MySQLManagedConnection();
			    List<ORM_DOC_DocumentTemplate_2_BusinessParticipant> items;
				...
				try
			    {
			        ...
			        items = new List<ORM_DOC_DocumentTemplate_2_BusinessParticipant>();

			        var reader = new CSV2Core_MySQL.Support.DBSQLReader(command.ExecuteReader());
					reader.SetOrdinals(new string[] { "AssignmentID","DOC_DocumentTemplate_Instance_RefID","CMN_BPT_BusinessParticipant_RefID","Creation_Timestamp","Tenant_RefID","IsDeleted","Modification_Timestamp" });
			        while (reader.Read())
			        {
			            ORM_DOC_DocumentTemplate_2_BusinessParticipant item = new ORM_DOC_DocumentTemplate_2_BusinessParticipant();
						//0:Parameter AssignmentID of type Guid

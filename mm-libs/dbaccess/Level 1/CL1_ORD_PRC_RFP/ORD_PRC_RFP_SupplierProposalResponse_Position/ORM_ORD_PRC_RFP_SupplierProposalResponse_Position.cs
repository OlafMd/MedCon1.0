/* 
 * Generated on 8/5/2014 1:47:17 PM
...
{
	[Serializable]
	public class ORM_ORD_PRC_RFP_SupplierProposalResponse_Position
	{
		public static readonly string TableName = "ord_prc_rfp_supplierproposalresponse_positions";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_ORD_PRC_RFP_SupplierProposalResponse_Position()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_ORD_PRC_RFP_SupplierProposalResponse_PositionID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _ORD_PRC_RFP_SupplierProposalResponse_PositionID = default(Guid);
		private String _ProposalResponsePositionITPL = default(String);
		private Guid _SupplierProposalResponseHeader_RefID = default(Guid);
		...
		public Guid ORD_PRC_RFP_SupplierProposalResponse_PositionID { 
			get {
				return _ORD_PRC_RFP_SupplierProposalResponse_PositionID;
			}
			set {
				if(_ORD_PRC_RFP_SupplierProposalResponse_PositionID != value){
					_ORD_PRC_RFP_SupplierProposalResponse_PositionID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		public Guid SupplierProposalResponseHeader_RefID { 
			get {
				return _SupplierProposalResponseHeader_RefID;
			}
			set {
				if(_SupplierProposalResponseHeader_RefID != value){
					_SupplierProposalResponseHeader_RefID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_ORD_PRC_RFP.ORD_PRC_RFP_SupplierProposalResponse_Position.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_ORD_PRC_RFP.ORD_PRC_RFP_SupplierProposalResponse_Position.SQL.Insert.sql")).ReadToEnd();
					}
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "ORD_PRC_RFP_SupplierProposalResponse_PositionID", _ORD_PRC_RFP_SupplierProposalResponse_PositionID);
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "ProposalResponsePositionITPL", _ProposalResponsePositionITPL);
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "SupplierProposalResponseHeader_RefID", _SupplierProposalResponseHeader_RefID);
		...
		private FR_Base Load(DbConnection Connection, DbTransaction Transaction, Guid ObjectID, string ConnectionString)
		{
			...
			try
			{
				...
				string SelectQuery = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_ORD_PRC_RFP.ORD_PRC_RFP_SupplierProposalResponse_Position.SQL.Select.sql")).ReadToEnd();
				...
				_ORD_PRC_RFP_SupplierProposalResponse_PositionID = Guid.Empty;
				CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command,"ORD_PRC_RFP_SupplierProposalResponse_PositionID", ObjectID );
				...
				try
				{
					...
					if (reader.HasRows == true)
					{
						...
						_ORD_PRC_RFP_SupplierProposalResponse_PositionID = reader.GetGuid(0);
						...
						_SupplierProposalResponseHeader_RefID = reader.GetGuid(2);
					...
					if(_ORD_PRC_RFP_SupplierProposalResponse_PositionID != Guid.Empty){
						//Successfully loaded
						Status_IsAlreadySaved = true;
						Status_IsDirty = false;
					} else {
        ...
        {
			public Guid? ORD_PRC_RFP_SupplierProposalResponse_PositionID {	get; set; }
			public String ProposalResponsePositionITPL {	get; set; }
			public Guid? SupplierProposalResponseHeader_RefID {	get; set; }
			...
			#region Search
			public static List<ORM_ORD_PRC_RFP_SupplierProposalResponse_Position> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_ORD_PRC_RFP_SupplierProposalResponse_Position> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_ORD_PRC_RFP_SupplierProposalResponse_Position> Search(DbConnection connection, DbTransaction transaction, Query query)
			{

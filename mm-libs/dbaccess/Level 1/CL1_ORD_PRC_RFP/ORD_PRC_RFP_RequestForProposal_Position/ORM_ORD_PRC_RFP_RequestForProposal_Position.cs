/* 
 * Generated on 8/5/2014 1:47:48 PM
...
{
	[Serializable]
	public class ORM_ORD_PRC_RFP_RequestForProposal_Position
	{
		public static readonly string TableName = "ord_prc_rfp_requestforproposal_positions";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_ORD_PRC_RFP_RequestForProposal_Position()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_ORD_PRC_RFP_RequestForProposal_PositionID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _ORD_PRC_RFP_RequestForProposal_PositionID = default(Guid);
		...
		public Guid ORD_PRC_RFP_RequestForProposal_PositionID { 
			get {
				return _ORD_PRC_RFP_RequestForProposal_PositionID;
			}
			set {
				if(_ORD_PRC_RFP_RequestForProposal_PositionID != value){
					_ORD_PRC_RFP_RequestForProposal_PositionID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_ORD_PRC_RFP.ORD_PRC_RFP_RequestForProposal_Position.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_ORD_PRC_RFP.ORD_PRC_RFP_RequestForProposal_Position.SQL.Insert.sql")).ReadToEnd();
					}
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "ORD_PRC_RFP_RequestForProposal_PositionID", _ORD_PRC_RFP_RequestForProposal_PositionID);
		...
		private FR_Base Load(DbConnection Connection, DbTransaction Transaction, Guid ObjectID, string ConnectionString)
		{
			...
			try
			{
				...
				string SelectQuery = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_ORD_PRC_RFP.ORD_PRC_RFP_RequestForProposal_Position.SQL.Select.sql")).ReadToEnd();
				...
				_ORD_PRC_RFP_RequestForProposal_PositionID = Guid.Empty;
				CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command,"ORD_PRC_RFP_RequestForProposal_PositionID", ObjectID );
				...
				try
				{
					...
					if (reader.HasRows == true)
					{
						...
						_ORD_PRC_RFP_RequestForProposal_PositionID = reader.GetGuid(0);
					...
					if(_ORD_PRC_RFP_RequestForProposal_PositionID != Guid.Empty){
						//Successfully loaded
						Status_IsAlreadySaved = true;
						Status_IsDirty = false;
					} else {
		...
		public class Query : CSV2Core_MySQL.BaseFilterQuery<Query>
        {
			...
			#region Search
			public static List<ORM_ORD_PRC_RFP_RequestForProposal_Position> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_ORD_PRC_RFP_RequestForProposal_Position> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_ORD_PRC_RFP_RequestForProposal_Position> Search(DbConnection connection, DbTransaction transaction, Query query)
			{

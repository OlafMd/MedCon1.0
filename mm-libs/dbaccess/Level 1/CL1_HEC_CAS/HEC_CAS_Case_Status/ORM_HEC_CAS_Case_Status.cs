/* 
 * Generated on 05/19/15 18:02:58
...
{
	[Serializable]
	public class ORM_HEC_CAS_Case_Status
	{
		public static readonly string TableName = "hec_cas_case_statuses";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_HEC_CAS_Case_Status()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_HEC_CAS_Case_StatusID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _HEC_CAS_Case_StatusID = default(Guid);
		...
		public Guid HEC_CAS_Case_StatusID { 
			get {
				return _HEC_CAS_Case_StatusID;
			}
			set {
				if(_HEC_CAS_Case_StatusID != value){
					_HEC_CAS_Case_StatusID = value;
					Status_IsDirty = true;
				}
			}
		} 
        ...
        {
			public Guid? HEC_CAS_Case_StatusID {	get; set; }
			...
			#region Search
			public static List<ORM_HEC_CAS_Case_Status> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_HEC_CAS_Case_Status> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_HEC_CAS_Case_Status> Search(DbConnection connection, DbTransaction transaction, Query query)
			{
			    return Query.Search(query, null, connection, transaction);
			}

			private static List<ORM_HEC_CAS_Case_Status> Search(Query query, string connectionString, DbConnection connection, DbTransaction transaction)
			{
				CSV2Core.Core.Interfaces.IManagedConnection managedConnection = new CSV2Core_MySQL.MySQLManagedConnection();
			    List<ORM_HEC_CAS_Case_Status> items;
				...
				try
			    {
			        ...
			        items = new List<ORM_HEC_CAS_Case_Status>();

			        var reader = new CSV2Core_MySQL.Support.DBSQLReader(command.ExecuteReader());
					reader.SetOrdinals(new string[] { "HEC_CAS_Case_StatusID","GlobalPropertyMatchingID","Status_Code","Status_Name_DictID","Creation_Timestamp","Tenant_RefID","IsDeleted","Modification_Timestamp" });
			        while (reader.Read())
			        {
			            ORM_HEC_CAS_Case_Status item = new ORM_HEC_CAS_Case_Status();
						//0:Parameter HEC_CAS_Case_StatusID of type Guid
						item.HEC_CAS_Case_StatusID = reader.GetGuid(0);
						//1:Parameter GlobalPropertyMatchingID of type String

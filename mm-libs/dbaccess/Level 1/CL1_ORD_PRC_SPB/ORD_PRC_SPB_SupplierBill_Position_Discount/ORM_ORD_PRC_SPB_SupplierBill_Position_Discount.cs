/* 
 * Generated on 2/27/2014 4:35:09 PM
	...
	public class ORM_ORD_PRC_SPB_SupplierBill_Position_Discount
	{
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_ORD_PRC_SPB.ORD_PRC_SPB_SupplierBill_Position_Discount.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_ORD_PRC_SPB.ORD_PRC_SPB_SupplierBill_Position_Discount.SQL.Insert.sql")).ReadToEnd();
					}
		...
		private FR_Base Load(DbConnection Connection, DbTransaction Transaction, Guid ObjectID, string ConnectionString)
		{
			...
			try
			{
				...
				string SelectQuery = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_ORD_PRC_SPB.ORD_PRC_SPB_SupplierBill_Position_Discount.SQL.Select.sql")).ReadToEnd();

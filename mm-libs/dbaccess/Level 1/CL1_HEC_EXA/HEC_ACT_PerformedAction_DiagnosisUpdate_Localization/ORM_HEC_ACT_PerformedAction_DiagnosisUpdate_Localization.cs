		...
		private FR_Base Load(DbConnection Connection, DbTransaction Transaction, Guid ObjectID, string ConnectionString)
		{
			...
			try
			{
				...
				try
				{
					...
					reader.SetOrdinals(new string[] { "HEC_ACT_PerformedAction_DiagnosisUpdate_LocalizationID","HEX_EXC_Action_DiagnosisUpdate_RefID","HEC_DIA_Diagnosis_Localization_RefID","Creation_Timestamp","Tenant_RefID","IsDeleted","Modification_Timestamp" });

/* 
 * Generated on 12/9/2014 11:06:05 AM
			...
			try
			{
				...
				try
				{
					...
					if (reader.HasRows == true)
					{
						...
						//2:Parameter HEC_Patient_Diagnosis_RefID of type Guid
						_HEC_Patient_Diagnosis_RefID = reader.GetGuid(2);
						//3:Parameter PotentialDiagnosis_RefID of type Guid
						_PotentialDiagnosis_RefID = reader.GetGuid(3);
						//4:Parameter DiagnosisState_RefID of type Guid
						_DiagnosisState_RefID = reader.GetGuid(4);
						//5:Parameter IsDiagnosisAssumed of type Boolean
						_IsDiagnosisAssumed = reader.GetBoolean(5);
						//6:Parameter IsDiagnosisConfirmed of type Boolean
						_IsDiagnosisConfirmed = reader.GetBoolean(6);
						//7:Parameter IsDiagnosisNegated of type Boolean
						_IsDiagnosisNegated = reader.GetBoolean(7);
						//8:Parameter IsDiagnosisCreated of type Boolean
						_IsDiagnosisCreated = reader.GetBoolean(8);
						//9:Parameter IsDiagnosisModified of type Boolean
						_IsDiagnosisModified = reader.GetBoolean(9);
						//10:Parameter IsDiagnosisDeactivated of type Boolean
						_IsDiagnosisDeactivated = reader.GetBoolean(10);
						//11:Parameter ScheduledExpiryDate of type DateTime
						_ScheduledExpiryDate = reader.GetDate(11);
						//12:Parameter Deactivated_OnDate of type DateTime
						_Deactivated_OnDate = reader.GetDate(12);
						//13:Parameter DeactivatedBy_Doctor_RefID of type Guid
						_DeactivatedBy_Doctor_RefID = reader.GetGuid(13);
						//14:Parameter DiagnosisUpdateComment of type String
						_DiagnosisUpdateComment = reader.GetString(14);
			...
			private static List<ORM_HEC_ACT_PerformedAction_DiagnosisUpdate> Search(Query query, string connectionString, DbConnection connection, DbTransaction transaction)
			{
				...
				try
			    {
			        ...
			        while (reader.Read())
			        {
						...
						//2:Parameter HEC_Patient_Diagnosis_RefID of type Guid
						item.HEC_Patient_Diagnosis_RefID = reader.GetGuid(2);
						//3:Parameter PotentialDiagnosis_RefID of type Guid
						item.PotentialDiagnosis_RefID = reader.GetGuid(3);
						//4:Parameter DiagnosisState_RefID of type Guid
						item.DiagnosisState_RefID = reader.GetGuid(4);
						//5:Parameter IsDiagnosisAssumed of type Boolean
						item.IsDiagnosisAssumed = reader.GetBoolean(5);
						//6:Parameter IsDiagnosisConfirmed of type Boolean
						item.IsDiagnosisConfirmed = reader.GetBoolean(6);
						//7:Parameter IsDiagnosisNegated of type Boolean
						item.IsDiagnosisNegated = reader.GetBoolean(7);
						//8:Parameter IsDiagnosisCreated of type Boolean
						item.IsDiagnosisCreated = reader.GetBoolean(8);
						//9:Parameter IsDiagnosisModified of type Boolean
						item.IsDiagnosisModified = reader.GetBoolean(9);
						//10:Parameter IsDiagnosisDeactivated of type Boolean
						item.IsDiagnosisDeactivated = reader.GetBoolean(10);
						//11:Parameter ScheduledExpiryDate of type DateTime
						item.ScheduledExpiryDate = reader.GetDate(11);
						//12:Parameter Deactivated_OnDate of type DateTime
						item.Deactivated_OnDate = reader.GetDate(12);
						//13:Parameter DeactivatedBy_Doctor_RefID of type Guid
						item.DeactivatedBy_Doctor_RefID = reader.GetGuid(13);
						//14:Parameter DiagnosisUpdateComment of type String
						item.DiagnosisUpdateComment = reader.GetString(14);
						//15:Parameter Creation_Timestamp of type DateTime

/* 
 * Generated on 2/19/2014 11:24:41 AM
...
{
	[Serializable]
	public class ORM_CMN_STR_PPS_Workplace
	{
		public static readonly string TableName = "cmn_str_pps_workplaces";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_CMN_STR_PPS_Workplace()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_CMN_STR_PPS_WorkplaceID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _CMN_STR_PPS_WorkplaceID = default(Guid);
		...
		public Guid CMN_STR_PPS_WorkplaceID { 
			get {
				return _CMN_STR_PPS_WorkplaceID;
			}
			set {
				if(_CMN_STR_PPS_WorkplaceID != value){
					_CMN_STR_PPS_WorkplaceID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_CMN_STR_PPS.CMN_STR_PPS_Workplace.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_CMN_STR_PPS.CMN_STR_PPS_Workplace.SQL.Insert.sql")).ReadToEnd();
					}
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "CMN_STR_PPS_WorkplaceID", _CMN_STR_PPS_WorkplaceID);
        ...
        {
			public Guid? CMN_STR_PPS_WorkplaceID {	get; set; }
			...
			#region Search
			public static List<ORM_CMN_STR_PPS_Workplace> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_CMN_STR_PPS_Workplace> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_CMN_STR_PPS_Workplace> Search(DbConnection connection, DbTransaction transaction, Query query)
			{

...
{
	[Serializable]
	public class ORM_HEC_DIA_STA_Diagnosis_ReferralUsageStatistic
	{
		public static readonly string TableName = "hec_dia_sta_diagnosis_referralusagestatistics";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_HEC_DIA_STA_Diagnosis_ReferralUsageStatistic()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_HEC_DIA_STA_Diagnosis_ReferralUsageStatisticsID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _HEC_DIA_STA_Diagnosis_ReferralUsageStatisticsID = default(Guid);
		private Guid _PotentialDiagnosis_RefID = default(Guid);
		private Guid _ReferredTo_MedicalPractice_RefID = default(Guid);
		...
		public Guid HEC_DIA_STA_Diagnosis_ReferralUsageStatisticsID { 
			get {
				return _HEC_DIA_STA_Diagnosis_ReferralUsageStatisticsID;
			}
			set {
				if(_HEC_DIA_STA_Diagnosis_ReferralUsageStatisticsID != value){
					_HEC_DIA_STA_Diagnosis_ReferralUsageStatisticsID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		public Guid ReferredTo_MedicalPractice_RefID { 
			get {
				return _ReferredTo_MedicalPractice_RefID;
			}
			set {
				if(_ReferredTo_MedicalPractice_RefID != value){
					_ReferredTo_MedicalPractice_RefID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_HEC_DIA_STA.HEC_DIA_STA_Diagnosis_ReferralUsageStatistic.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_HEC_DIA_STA.HEC_DIA_STA_Diagnosis_ReferralUsageStatistic.SQL.Insert.sql")).ReadToEnd();
					}
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "HEC_DIA_STA_Diagnosis_ReferralUsageStatisticsID", _HEC_DIA_STA_Diagnosis_ReferralUsageStatisticsID);
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "PotentialDiagnosis_RefID", _PotentialDiagnosis_RefID);
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "ReferredTo_MedicalPractice_RefID", _ReferredTo_MedicalPractice_RefID);
		...
		private FR_Base Load(DbConnection Connection, DbTransaction Transaction, Guid ObjectID, string ConnectionString)
		{
			...
			try
			{
				...
				string SelectQuery = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_HEC_DIA_STA.HEC_DIA_STA_Diagnosis_ReferralUsageStatistic.SQL.Select.sql")).ReadToEnd();
				...
				_HEC_DIA_STA_Diagnosis_ReferralUsageStatisticsID = Guid.Empty;
				CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command,"HEC_DIA_STA_Diagnosis_ReferralUsageStatisticsID", ObjectID );
				...
				try
				{
					...
					reader.SetOrdinals(new string[] { "HEC_DIA_STA_Diagnosis_ReferralUsageStatisticsID","PotentialDiagnosis_RefID","ReferredTo_MedicalPractice_RefID","NumberOfOccurences","IsStatistics_ForDoctor","IfStatistics_ForDoctor_Doctor_RefID","IsStatistics_ForHCG","IfStatistics_ForHCG_HealthcareCommunityGroup_RefID","StatisticsPeriod_From","StatisticsPeriod_Through","IsLatestStatisticsData","Creation_Timestamp","Tenant_RefID","IsDeleted","Modification_Timestamp" });
					if (reader.HasRows == true)
					{
						reader.Read(); //Single result only
						//0:Parameter HEC_DIA_STA_Diagnosis_ReferralUsageStatisticsID of type Guid
						_HEC_DIA_STA_Diagnosis_ReferralUsageStatisticsID = reader.GetGuid(0);
						//1:Parameter PotentialDiagnosis_RefID of type Guid
						_PotentialDiagnosis_RefID = reader.GetGuid(1);
						//2:Parameter ReferredTo_MedicalPractice_RefID of type Guid
						_ReferredTo_MedicalPractice_RefID = reader.GetGuid(2);
					...
					if(_HEC_DIA_STA_Diagnosis_ReferralUsageStatisticsID != Guid.Empty){
						//Successfully loaded
						Status_IsAlreadySaved = true;
						Status_IsDirty = false;
					} else {
        ...
        {
			public Guid? HEC_DIA_STA_Diagnosis_ReferralUsageStatisticsID {	get; set; }
			public Guid? PotentialDiagnosis_RefID {	get; set; }
			public Guid? ReferredTo_MedicalPractice_RefID {	get; set; }
			...
			#region Search
			public static List<ORM_HEC_DIA_STA_Diagnosis_ReferralUsageStatistic> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_HEC_DIA_STA_Diagnosis_ReferralUsageStatistic> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_HEC_DIA_STA_Diagnosis_ReferralUsageStatistic> Search(DbConnection connection, DbTransaction transaction, Query query)
			{
			    return Query.Search(query, null, connection, transaction);
			}

			private static List<ORM_HEC_DIA_STA_Diagnosis_ReferralUsageStatistic> Search(Query query, string connectionString, DbConnection connection, DbTransaction transaction)
			{
				CSV2Core.Core.Interfaces.IManagedConnection managedConnection = new CSV2Core_MySQL.MySQLManagedConnection();
			    List<ORM_HEC_DIA_STA_Diagnosis_ReferralUsageStatistic> items;
				...
				try
			    {
			        ...
			        items = new List<ORM_HEC_DIA_STA_Diagnosis_ReferralUsageStatistic>();

			        var reader = new CSV2Core_MySQL.Support.DBSQLReader(command.ExecuteReader());
					reader.SetOrdinals(new string[] { "HEC_DIA_STA_Diagnosis_ReferralUsageStatisticsID","PotentialDiagnosis_RefID","ReferredTo_MedicalPractice_RefID","NumberOfOccurences","IsStatistics_ForDoctor","IfStatistics_ForDoctor_Doctor_RefID","IsStatistics_ForHCG","IfStatistics_ForHCG_HealthcareCommunityGroup_RefID","StatisticsPeriod_From","StatisticsPeriod_Through","IsLatestStatisticsData","Creation_Timestamp","Tenant_RefID","IsDeleted","Modification_Timestamp" });
			        while (reader.Read())
			        {
			            ORM_HEC_DIA_STA_Diagnosis_ReferralUsageStatistic item = new ORM_HEC_DIA_STA_Diagnosis_ReferralUsageStatistic();
						//0:Parameter HEC_DIA_STA_Diagnosis_ReferralUsageStatisticsID of type Guid
						item.HEC_DIA_STA_Diagnosis_ReferralUsageStatisticsID = reader.GetGuid(0);
						//1:Parameter PotentialDiagnosis_RefID of type Guid
						item.PotentialDiagnosis_RefID = reader.GetGuid(1);
						//2:Parameter ReferredTo_MedicalPractice_RefID of type Guid
						item.ReferredTo_MedicalPractice_RefID = reader.GetGuid(2);
						//3:Parameter NumberOfOccurences of type int

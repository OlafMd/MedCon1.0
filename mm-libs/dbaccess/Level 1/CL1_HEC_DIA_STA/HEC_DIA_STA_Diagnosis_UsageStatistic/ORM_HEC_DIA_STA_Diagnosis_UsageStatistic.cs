/* 
 * Generated on 20.02.2015 15:18:43
...
{
	[Serializable]
	public class ORM_HEC_DIA_STA_Diagnosis_UsageStatistic
	{
		public static readonly string TableName = "hec_dia_sta_diagnosis_usagestatistics";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_HEC_DIA_STA_Diagnosis_UsageStatistic()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_HEC_DIA_STA_DiagnosisUsageStatisticsID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _HEC_DIA_STA_DiagnosisUsageStatisticsID = default(Guid);
		...
		public Guid HEC_DIA_STA_DiagnosisUsageStatisticsID { 
			get {
				return _HEC_DIA_STA_DiagnosisUsageStatisticsID;
			}
			set {
				if(_HEC_DIA_STA_DiagnosisUsageStatisticsID != value){
					_HEC_DIA_STA_DiagnosisUsageStatisticsID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_HEC_DIA_STA.HEC_DIA_STA_Diagnosis_UsageStatistic.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_HEC_DIA_STA.HEC_DIA_STA_Diagnosis_UsageStatistic.SQL.Insert.sql")).ReadToEnd();
					}
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "HEC_DIA_STA_DiagnosisUsageStatisticsID", _HEC_DIA_STA_DiagnosisUsageStatisticsID);
		...
		private FR_Base Load(DbConnection Connection, DbTransaction Transaction, Guid ObjectID, string ConnectionString)
		{
			...
			try
			{
				...
				string SelectQuery = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_HEC_DIA_STA.HEC_DIA_STA_Diagnosis_UsageStatistic.SQL.Select.sql")).ReadToEnd();
				...
				_HEC_DIA_STA_DiagnosisUsageStatisticsID = Guid.Empty;
				CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command,"HEC_DIA_STA_DiagnosisUsageStatisticsID", ObjectID );
				...
				try
				{
					...
					reader.SetOrdinals(new string[] { "HEC_DIA_STA_DiagnosisUsageStatisticsID","PotentialDiagnosis_RefID","NumberOfOccurences","IsStatistics_ForDoctor","IfStatistics_ForDoctor_Doctor_RefID","IsStatistics_ForHCG","IfStatistics_ForHCG_HealthcareCommunityGroup_RefID","StatisticsPeriod_From","StatisticsPeriod_Through","IsLatestStatisticsData","Creation_Timestamp","Tenant_RefID","IsDeleted","Modification_Timestamp" });
					if (reader.HasRows == true)
					{
						reader.Read(); //Single result only
						//0:Parameter HEC_DIA_STA_DiagnosisUsageStatisticsID of type Guid
						_HEC_DIA_STA_DiagnosisUsageStatisticsID = reader.GetGuid(0);
					...
					if(_HEC_DIA_STA_DiagnosisUsageStatisticsID != Guid.Empty){
						//Successfully loaded
						Status_IsAlreadySaved = true;
						Status_IsDirty = false;
					} else {
        ...
        {
			public Guid? HEC_DIA_STA_DiagnosisUsageStatisticsID {	get; set; }
			...
			#region Search
			public static List<ORM_HEC_DIA_STA_Diagnosis_UsageStatistic> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_HEC_DIA_STA_Diagnosis_UsageStatistic> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_HEC_DIA_STA_Diagnosis_UsageStatistic> Search(DbConnection connection, DbTransaction transaction, Query query)
			{
			    return Query.Search(query, null, connection, transaction);
			}

			private static List<ORM_HEC_DIA_STA_Diagnosis_UsageStatistic> Search(Query query, string connectionString, DbConnection connection, DbTransaction transaction)
			{
				CSV2Core.Core.Interfaces.IManagedConnection managedConnection = new CSV2Core_MySQL.MySQLManagedConnection();
			    List<ORM_HEC_DIA_STA_Diagnosis_UsageStatistic> items;
				...
				try
			    {
			        ...
			        items = new List<ORM_HEC_DIA_STA_Diagnosis_UsageStatistic>();

			        var reader = new CSV2Core_MySQL.Support.DBSQLReader(command.ExecuteReader());
					reader.SetOrdinals(new string[] { "HEC_DIA_STA_DiagnosisUsageStatisticsID","PotentialDiagnosis_RefID","NumberOfOccurences","IsStatistics_ForDoctor","IfStatistics_ForDoctor_Doctor_RefID","IsStatistics_ForHCG","IfStatistics_ForHCG_HealthcareCommunityGroup_RefID","StatisticsPeriod_From","StatisticsPeriod_Through","IsLatestStatisticsData","Creation_Timestamp","Tenant_RefID","IsDeleted","Modification_Timestamp" });
			        while (reader.Read())
			        {
			            ORM_HEC_DIA_STA_Diagnosis_UsageStatistic item = new ORM_HEC_DIA_STA_Diagnosis_UsageStatistic();
						//0:Parameter HEC_DIA_STA_DiagnosisUsageStatisticsID of type Guid
						item.HEC_DIA_STA_DiagnosisUsageStatisticsID = reader.GetGuid(0);
						//1:Parameter PotentialDiagnosis_RefID of type Guid

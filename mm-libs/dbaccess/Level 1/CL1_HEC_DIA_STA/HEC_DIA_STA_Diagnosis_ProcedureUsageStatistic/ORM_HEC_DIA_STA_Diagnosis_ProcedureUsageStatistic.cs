...
{
	[Serializable]
	public class ORM_HEC_DIA_STA_Diagnosis_ProcedureUsageStatistic
	{
		public static readonly string TableName = "hec_dia_sta_diagnosis_procedureusagestatistics";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_HEC_DIA_STA_Diagnosis_ProcedureUsageStatistic()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_HEC_DIA_STA_Diagnosis_ProcedureUsageStatisticsID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _HEC_DIA_STA_Diagnosis_ProcedureUsageStatisticsID = default(Guid);
		...
		public Guid HEC_DIA_STA_Diagnosis_ProcedureUsageStatisticsID { 
			get {
				return _HEC_DIA_STA_Diagnosis_ProcedureUsageStatisticsID;
			}
			set {
				if(_HEC_DIA_STA_Diagnosis_ProcedureUsageStatisticsID != value){
					_HEC_DIA_STA_Diagnosis_ProcedureUsageStatisticsID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		private FR_Base Load(DbConnection Connection, DbTransaction Transaction, Guid ObjectID, string ConnectionString)
		{
			...
			try
			{
				...
				string SelectQuery = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_HEC_DIA_STA.HEC_DIA_STA_Diagnosis_ProcedureUsageStatistic.SQL.Select.sql")).ReadToEnd();
				...
				_HEC_DIA_STA_Diagnosis_ProcedureUsageStatisticsID = Guid.Empty;
				CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command,"HEC_DIA_STA_Diagnosis_ProcedureUsageStatisticsID", ObjectID );
				...
				try
				{
					...
					reader.SetOrdinals(new string[] { "HEC_DIA_STA_Diagnosis_ProcedureUsageStatisticsID","PotentialProcedure_RefID","PotentialDiagnosis_RefID","NumberOfOccurences","IsStatistics_ForDoctor","IfStatistics_ForDoctor_Doctor_RefID","IsStatistics_ForHCG","IfStatistics_ForHCG_HealthcareCommunityGroup_RefID","StatisticsPeriod_From","StatisticsPeriod_Through","IsLatestStatisticsData","Creation_Timestamp","Tenant_RefID","IsDeleted","Modification_Timestamp" });
					if (reader.HasRows == true)
					{
						reader.Read(); //Single result only
						//0:Parameter HEC_DIA_STA_Diagnosis_ProcedureUsageStatisticsID of type Guid
						_HEC_DIA_STA_Diagnosis_ProcedureUsageStatisticsID = reader.GetGuid(0);
					...
					if(_HEC_DIA_STA_Diagnosis_ProcedureUsageStatisticsID != Guid.Empty){
						//Successfully loaded
						Status_IsAlreadySaved = true;
						Status_IsDirty = false;
					} else {
        ...
        {
			public Guid? HEC_DIA_STA_Diagnosis_ProcedureUsageStatisticsID {	get; set; }
			...
			#region Search
			public static List<ORM_HEC_DIA_STA_Diagnosis_ProcedureUsageStatistic> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_HEC_DIA_STA_Diagnosis_ProcedureUsageStatistic> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_HEC_DIA_STA_Diagnosis_ProcedureUsageStatistic> Search(DbConnection connection, DbTransaction transaction, Query query)
			{
			    return Query.Search(query, null, connection, transaction);
			}

			private static List<ORM_HEC_DIA_STA_Diagnosis_ProcedureUsageStatistic> Search(Query query, string connectionString, DbConnection connection, DbTransaction transaction)
			{
				CSV2Core.Core.Interfaces.IManagedConnection managedConnection = new CSV2Core_MySQL.MySQLManagedConnection();
			    List<ORM_HEC_DIA_STA_Diagnosis_ProcedureUsageStatistic> items;
				...
				try
			    {
			        ...
			        items = new List<ORM_HEC_DIA_STA_Diagnosis_ProcedureUsageStatistic>();

			        var reader = new CSV2Core_MySQL.Support.DBSQLReader(command.ExecuteReader());
					reader.SetOrdinals(new string[] { "HEC_DIA_STA_Diagnosis_ProcedureUsageStatisticsID","PotentialProcedure_RefID","PotentialDiagnosis_RefID","NumberOfOccurences","IsStatistics_ForDoctor","IfStatistics_ForDoctor_Doctor_RefID","IsStatistics_ForHCG","IfStatistics_ForHCG_HealthcareCommunityGroup_RefID","StatisticsPeriod_From","StatisticsPeriod_Through","IsLatestStatisticsData","Creation_Timestamp","Tenant_RefID","IsDeleted","Modification_Timestamp" });
			        while (reader.Read())
			        {
			            ORM_HEC_DIA_STA_Diagnosis_ProcedureUsageStatistic item = new ORM_HEC_DIA_STA_Diagnosis_ProcedureUsageStatistic();
						//0:Parameter HEC_DIA_STA_Diagnosis_ProcedureUsageStatisticsID of type Guid
						item.HEC_DIA_STA_Diagnosis_ProcedureUsageStatisticsID = reader.GetGuid(0);
						//1:Parameter PotentialProcedure_RefID of type Guid

/* 
 * Generated on 20.02.2015 15:18:41
...
{
	[Serializable]
	public class ORM_HEC_DIA_STA_Medication_UsageStatistic
	{
		public static readonly string TableName = "hec_dia_sta_medication_usagestatistics";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_HEC_DIA_STA_Medication_UsageStatistic()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_HEC_DIA_STA_Medication_UsageStatisticsID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _HEC_DIA_STA_Medication_UsageStatisticsID = default(Guid);
		...
		public Guid HEC_DIA_STA_Medication_UsageStatisticsID { 
			get {
				return _HEC_DIA_STA_Medication_UsageStatisticsID;
			}
			set {
				if(_HEC_DIA_STA_Medication_UsageStatisticsID != value){
					_HEC_DIA_STA_Medication_UsageStatisticsID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_HEC_DIA_STA.HEC_DIA_STA_Medication_UsageStatistic.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_HEC_DIA_STA.HEC_DIA_STA_Medication_UsageStatistic.SQL.Insert.sql")).ReadToEnd();
					}
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "HEC_DIA_STA_Medication_UsageStatisticsID", _HEC_DIA_STA_Medication_UsageStatisticsID);
		...
		private FR_Base Load(DbConnection Connection, DbTransaction Transaction, Guid ObjectID, string ConnectionString)
		{
			...
			try
			{
				...
				string SelectQuery = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_HEC_DIA_STA.HEC_DIA_STA_Medication_UsageStatistic.SQL.Select.sql")).ReadToEnd();
				...
				_HEC_DIA_STA_Medication_UsageStatisticsID = Guid.Empty;
				CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command,"HEC_DIA_STA_Medication_UsageStatisticsID", ObjectID );
				...
				try
				{
					...
					if (reader.HasRows == true)
					{
						...
						_HEC_DIA_STA_Medication_UsageStatisticsID = reader.GetGuid(0);
					...
					if(_HEC_DIA_STA_Medication_UsageStatisticsID != Guid.Empty){
						//Successfully loaded
						Status_IsAlreadySaved = true;
						Status_IsDirty = false;
					} else {
        ...
        {
			public Guid? HEC_DIA_STA_Medication_UsageStatisticsID {	get; set; }
			...
			#region Search
			public static List<ORM_HEC_DIA_STA_Medication_UsageStatistic> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_HEC_DIA_STA_Medication_UsageStatistic> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_HEC_DIA_STA_Medication_UsageStatistic> Search(DbConnection connection, DbTransaction transaction, Query query)
			{

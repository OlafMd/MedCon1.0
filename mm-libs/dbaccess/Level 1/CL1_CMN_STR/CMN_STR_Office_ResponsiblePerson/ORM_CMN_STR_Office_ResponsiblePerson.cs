/* 
 * Generated on 10/25/2013 2:33:44 PM
...
{
	[Serializable]
	public class ORM_CMN_STR_Office_ResponsiblePerson
	{
		public static readonly string TableName = "cmn_str_office_responsiblepersons";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_CMN_STR_Office_ResponsiblePerson()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_CMN_STR_Office_ResponsiblePersonID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _CMN_STR_Office_ResponsiblePersonID = default(Guid);
		...
		public Guid CMN_STR_Office_ResponsiblePersonID { 
			get {
				return _CMN_STR_Office_ResponsiblePersonID;
			}
			set {
				if(_CMN_STR_Office_ResponsiblePersonID != value){
					_CMN_STR_Office_ResponsiblePersonID = value;
					Status_IsDirty = true;
				}
			}
		} 
        ...
        {
			public Guid? CMN_STR_Office_ResponsiblePersonID {	get; set; }
			...
			#region Search
			public static List<ORM_CMN_STR_Office_ResponsiblePerson> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_CMN_STR_Office_ResponsiblePerson> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_CMN_STR_Office_ResponsiblePerson> Search(DbConnection connection, DbTransaction transaction, Query query)
			{
			    return Query.Search(query, null, connection, transaction);
			}

			private static List<ORM_CMN_STR_Office_ResponsiblePerson> Search(Query query, string connectionString, DbConnection connection, DbTransaction transaction)
			{
				CSV2Core.Core.Interfaces.IManagedConnection managedConnection = new CSV2Core_MySQL.MySQLManagedConnection();
			    List<ORM_CMN_STR_Office_ResponsiblePerson> items;
				...
				try
			    {
			        ...
			        items = new List<ORM_CMN_STR_Office_ResponsiblePerson>();

			        var reader = new CSV2Core_MySQL.Support.DBSQLReader(command.ExecuteReader());
					reader.SetOrdinals(new string[] { "CMN_STR_Office_ResponsiblePersonID","Office_RefID","CMN_BPT_EMP_Employee_RefID","Creation_Timestamp","IsDeleted","Tenant_RefID" });
			        while (reader.Read())
			        {
			            ORM_CMN_STR_Office_ResponsiblePerson item = new ORM_CMN_STR_Office_ResponsiblePerson();
						//0:Parameter CMN_STR_Office_ResponsiblePersonID of type Guid
						item.CMN_STR_Office_ResponsiblePersonID = reader.GetGuid(0);
						//1:Parameter Office_RefID of type Guid

/* 
 * Generated on 8/16/2013 10:48:51 AM
...
{
	[Serializable]
	public class ORM_RES_STR_Roof_RequiredAction
	{
		public static readonly string TableName = "res_str_roof_requiredactions";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_RES_STR_Roof_RequiredAction()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_RES_STR_Roof_RequiredActionID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _RES_STR_Roof_RequiredActionID = default(Guid);
		private Guid _RoofPropertyAssestment_RefID = default(Guid);
		...
		public Guid RES_STR_Roof_RequiredActionID { 
			get {
				return _RES_STR_Roof_RequiredActionID;
			}
			set {
				if(_RES_STR_Roof_RequiredActionID != value){
					_RES_STR_Roof_RequiredActionID = value;
					Status_IsDirty = true;
				}
			}
		} 
		public Guid RoofPropertyAssestment_RefID { 
			get {
				return _RoofPropertyAssestment_RefID;
			}
			set {
				if(_RoofPropertyAssestment_RefID != value){
					_RoofPropertyAssestment_RefID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_RES_STR.RES_STR_Roof_RequiredAction.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_RES_STR.RES_STR_Roof_RequiredAction.SQL.Insert.sql")).ReadToEnd();
					}
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "RES_STR_Roof_RequiredActionID", _RES_STR_Roof_RequiredActionID);
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "RoofPropertyAssestment_RefID", _RoofPropertyAssestment_RefID);
		...
		public class Query : CSV2Core_MySQL.BaseFilterQuery<Query>
        {
			...
			public Guid? RoofPropertyAssestment_RefID {	get; set; }
			...
			#region Search
			public static List<ORM_RES_STR_Roof_RequiredAction> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_RES_STR_Roof_RequiredAction> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_RES_STR_Roof_RequiredAction> Search(DbConnection connection, DbTransaction transaction, Query query)
			{

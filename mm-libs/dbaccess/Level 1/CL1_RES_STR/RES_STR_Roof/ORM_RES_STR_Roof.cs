...
{
	[Serializable]
	public class ORM_RES_STR_Roof
	{
		public static readonly string TableName = "res_str_roofs";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_RES_STR_Roof()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_RES_STR_RoofID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _RES_STR_RoofID = default(Guid);
		...
		public Guid RES_STR_RoofID { 
			get {
				return _RES_STR_RoofID;
			}
			set {
				if(_RES_STR_RoofID != value){
					_RES_STR_RoofID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_RES_STR.RES_STR_Roof.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_RES_STR.RES_STR_Roof.SQL.Insert.sql")).ReadToEnd();
					}
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "RES_STR_RoofID", _RES_STR_RoofID);
		...
		private FR_Base Load(DbConnection Connection, DbTransaction Transaction, Guid ObjectID, string ConnectionString)
		{
			...
			try
			{
				...
				string SelectQuery = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_RES_STR.RES_STR_Roof.SQL.Select.sql")).ReadToEnd();
				...
				_RES_STR_RoofID = Guid.Empty;
				CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command,"RES_STR_RoofID", ObjectID );
				...
				try
				{
					...
					reader.SetOrdinals(new string[] { "RES_STR_RoofID","DUD_Revision_RefID","RES_BLD_Roof_RefID","AverageRating_RefID","DocumentHeader_RefID","Comment","Creation_Timestamp","IsDeleted","Tenant_RefID" });
					if (reader.HasRows == true)
					{
						reader.Read(); //Single result only
						//0:Parameter RES_STR_RoofID of type Guid
						_RES_STR_RoofID = reader.GetGuid(0);
						...
						_RES_BLD_Roof_RefID = reader.GetGuid(2);
		...
		public class Query : CSV2Core_MySQL.BaseFilterQuery<Query>
        {
			...
			#region Search
			public static List<ORM_RES_STR_Roof> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_RES_STR_Roof> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_RES_STR_Roof> Search(DbConnection connection, DbTransaction transaction, Query query)
			{
			    return Query.Search(query, null, connection, transaction);
			}

			private static List<ORM_RES_STR_Roof> Search(Query query, string connectionString, DbConnection connection, DbTransaction transaction)
			{
				CSV2Core.Core.Interfaces.IManagedConnection managedConnection = new CSV2Core_MySQL.MySQLManagedConnection();
			    List<ORM_RES_STR_Roof> items;
				...
				try
			    {
			        ...
			        items = new List<ORM_RES_STR_Roof>();

			        var reader = new CSV2Core_MySQL.Support.DBSQLReader(command.ExecuteReader());
					reader.SetOrdinals(new string[] { "RES_STR_RoofID","DUD_Revision_RefID","RES_BLD_Roof_RefID","AverageRating_RefID","DocumentHeader_RefID","Comment","Creation_Timestamp","IsDeleted","Tenant_RefID" });
			        while (reader.Read())
			        {
			            ORM_RES_STR_Roof item = new ORM_RES_STR_Roof();
						//0:Parameter RES_STR_RoofID of type Guid
						item.RES_STR_RoofID = reader.GetGuid(0);
						//1:Parameter DUD_Revision_RefID of type Guid
						item.DUD_Revision_RefID = reader.GetGuid(1);
						//2:Parameter RES_BLD_Roof_RefID of type Guid
						item.RES_BLD_Roof_RefID = reader.GetGuid(2);
						//3:Parameter AverageRating_RefID of type Guid

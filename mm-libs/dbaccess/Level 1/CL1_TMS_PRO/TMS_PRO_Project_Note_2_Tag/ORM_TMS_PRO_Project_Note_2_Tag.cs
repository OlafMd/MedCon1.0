/* 
 * Generated on 10/13/2014 19:07:07
...
{
	[Serializable]
	public class ORM_TMS_PRO_Project_Note_2_Tag
	{
		public static readonly string TableName = "tms_pro_project_note_2_tag";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_TMS_PRO_Project_Note_2_Tag()
		{
		...
		private Guid _Project_Note_RefID = default(Guid);
		...
		public Guid Project_Note_RefID { 
			get {
				return _Project_Note_RefID;
			}
			set {
				if(_Project_Note_RefID != value){
					_Project_Note_RefID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		public class Query : CSV2Core_MySQL.BaseFilterQuery<Query>
        {
			...
			public Guid? Project_Note_RefID {	get; set; }
			...
			#region Search
			public static List<ORM_TMS_PRO_Project_Note_2_Tag> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_TMS_PRO_Project_Note_2_Tag> Search(DbConnection connection, Query query)
			{

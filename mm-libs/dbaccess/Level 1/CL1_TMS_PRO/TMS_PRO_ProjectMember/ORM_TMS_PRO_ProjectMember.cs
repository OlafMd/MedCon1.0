/* 
 * Generated on 10/29/2013 4:13:31 PM
...
{
	[Serializable]
	public class ORM_TMS_PRO_ProjectMember
	{
		public static readonly string TableName = "tms_pro_projectmembers";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_TMS_PRO_ProjectMember()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_TMS_PRO_ProjectMemberID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _TMS_PRO_ProjectMemberID = default(Guid);
		private Guid _Project_RefID = default(Guid);
		private Guid _USR_Account_RefID = default(Guid);
		private Guid _ProjectMember_Type_RefID = default(Guid);
		private Boolean _IsOwner = default(Boolean);
		...
		public Guid TMS_PRO_ProjectMemberID { 
			get {
				return _TMS_PRO_ProjectMemberID;
			}
			set {
				if(_TMS_PRO_ProjectMemberID != value){
					_TMS_PRO_ProjectMemberID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		public Guid USR_Account_RefID { 
			get {
				return _USR_Account_RefID;
			}
			set {
				if(_USR_Account_RefID != value){
					_USR_Account_RefID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_TMS_PRO.TMS_PRO_ProjectMember.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_TMS_PRO.TMS_PRO_ProjectMember.SQL.Insert.sql")).ReadToEnd();
					}
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "TMS_PRO_ProjectMemberID", _TMS_PRO_ProjectMemberID);
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "Project_RefID", _Project_RefID);
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "USR_Account_RefID", _USR_Account_RefID);
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "ProjectMember_Type_RefID", _ProjectMember_Type_RefID);
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "IsOwner", _IsOwner);
		...
		private FR_Base Load(DbConnection Connection, DbTransaction Transaction, Guid ObjectID, string ConnectionString)
		{
			...
			try
			{
				...
				string SelectQuery = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_TMS_PRO.TMS_PRO_ProjectMember.SQL.Select.sql")).ReadToEnd();
				...
				_TMS_PRO_ProjectMemberID = Guid.Empty;
				CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command,"TMS_PRO_ProjectMemberID", ObjectID );
				...
				try
				{
					...
					if (reader.HasRows == true)
					{
						...
						_ChargingLevel_RefID = reader.GetGuid(8);
					...
					if(_TMS_PRO_ProjectMemberID != Guid.Empty){
						//Successfully loaded
						Status_IsAlreadySaved = true;
						Status_IsDirty = false;
					} else {
		...
		public class Query : CSV2Core_MySQL.BaseFilterQuery<Query>
        {
			...
			#region Search
			public static List<ORM_TMS_PRO_ProjectMember> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_TMS_PRO_ProjectMember> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_TMS_PRO_ProjectMember> Search(DbConnection connection, DbTransaction transaction, Query query)
			{

...
{
	[Serializable]
	public class ORM_TMS_PRO_DeveloperTask_Priority
	{
		public static readonly string TableName = "tms_pro_developertask_priorities";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_TMS_PRO_DeveloperTask_Priority()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_TMS_PRO_DeveloperTask_PriorityID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _TMS_PRO_DeveloperTask_PriorityID = default(Guid);
		...
		private String _IconLocationURL = default(String);
		private String _Priority_Colour = default(String);
		private String _Groups = default(String);
		private int _PriorityLevel = default(int);
		...
		public Guid TMS_PRO_DeveloperTask_PriorityID { 
			get {
				return _TMS_PRO_DeveloperTask_PriorityID;
			}
			set {
				if(_TMS_PRO_DeveloperTask_PriorityID != value){
					_TMS_PRO_DeveloperTask_PriorityID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		public String IconLocationURL { 
			get {
				return _IconLocationURL;
			}
			set {
				if(_IconLocationURL != value){
					_IconLocationURL = value;
					Status_IsDirty = true;
				}
			}
		} 
		public String Priority_Colour { 
			get {
				return _Priority_Colour;
			}
			set {
				if(_Priority_Colour != value){
					_Priority_Colour = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_TMS_PRO.TMS_PRO_DeveloperTask_Priority.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_TMS_PRO.TMS_PRO_DeveloperTask_Priority.SQL.Insert.sql")).ReadToEnd();
					}
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "TMS_PRO_DeveloperTask_PriorityID", _TMS_PRO_DeveloperTask_PriorityID);
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "IconLocationURL", _IconLocationURL);
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "Priority_Colour", _Priority_Colour);
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "Groups", _Groups);
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "PriorityLevel", _PriorityLevel);
		...
		private FR_Base Load(DbConnection Connection, DbTransaction Transaction, Guid ObjectID, string ConnectionString)
		{
			...
			try
			{
				...
				string SelectQuery = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_TMS_PRO.TMS_PRO_DeveloperTask_Priority.SQL.Select.sql")).ReadToEnd();
				...
				_TMS_PRO_DeveloperTask_PriorityID = Guid.Empty;
				CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command,"TMS_PRO_DeveloperTask_PriorityID", ObjectID );
				...
				try
				{
					...
					if (reader.HasRows == true)
					{
						...
						_TMS_PRO_DeveloperTask_PriorityID = reader.GetGuid(0);
						...
						_IconLocationURL = reader.GetString(4);
						//5:Parameter Priority_Colour of type String
						_Priority_Colour = reader.GetString(5);
						//6:Parameter Groups of type String
						_Groups = reader.GetString(6);
						//7:Parameter PriorityLevel of type int
						_PriorityLevel = reader.GetInteger(7);
						//8:Parameter IsPersistent of type Boolean
						_IsPersistent = reader.GetBoolean(8);
					...
					if(_TMS_PRO_DeveloperTask_PriorityID != Guid.Empty){
						//Successfully loaded
						Status_IsAlreadySaved = true;
						Status_IsDirty = false;
					} else {
		...
		public class Query : CSV2Core_MySQL.BaseFilterQuery<Query>
        {
			...
			#region Search
			public static List<ORM_TMS_PRO_DeveloperTask_Priority> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_TMS_PRO_DeveloperTask_Priority> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_TMS_PRO_DeveloperTask_Priority> Search(DbConnection connection, DbTransaction transaction, Query query)
			{

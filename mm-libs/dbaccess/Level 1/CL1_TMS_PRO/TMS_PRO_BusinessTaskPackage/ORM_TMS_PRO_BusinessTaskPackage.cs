...
{
	[Serializable]
	public class ORM_TMS_PRO_BusinessTaskPackage
	{
		public static readonly string TableName = "tms_pro_businesstaskpackages";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_TMS_PRO_BusinessTaskPackage()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_TMS_PRO_BusinessTaskPackageID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _TMS_PRO_BusinessTaskPackageID = default(Guid);
		...
		public Guid TMS_PRO_BusinessTaskPackageID { 
			get {
				return _TMS_PRO_BusinessTaskPackageID;
			}
			set {
				if(_TMS_PRO_BusinessTaskPackageID != value){
					_TMS_PRO_BusinessTaskPackageID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_TMS_PRO.TMS_PRO_BusinessTaskPackage.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_TMS_PRO.TMS_PRO_BusinessTaskPackage.SQL.Insert.sql")).ReadToEnd();
					}
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "TMS_PRO_BusinessTaskPackageID", _TMS_PRO_BusinessTaskPackageID);
		...
		private FR_Base Load(DbConnection Connection, DbTransaction Transaction, Guid ObjectID, string ConnectionString)
		{
			...
			try
			{
				...
				string SelectQuery = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_TMS_PRO.TMS_PRO_BusinessTaskPackage.SQL.Select.sql")).ReadToEnd();
				...
				_TMS_PRO_BusinessTaskPackageID = Guid.Empty;
				CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command,"TMS_PRO_BusinessTaskPackageID", ObjectID );
				...
				try
				{
					...
					if (reader.HasRows == true)
					{
						...
						_TMS_PRO_BusinessTaskPackageID = reader.GetGuid(0);
						//1:Parameter Parent_RefID of type Guid
						_Parent_RefID = reader.GetGuid(1);
						...
						_Label = reader.GetString(4);
						//5:Parameter CreatedByAccount_RefID of type Guid
						_CreatedByAccount_RefID = reader.GetGuid(5);
					...
					if(_TMS_PRO_BusinessTaskPackageID != Guid.Empty){
						//Successfully loaded
						Status_IsAlreadySaved = true;
						Status_IsDirty = false;
					} else {
		...
		public class Query : CSV2Core_MySQL.BaseFilterQuery<Query>
        {
			...
			#region Search
			public static List<ORM_TMS_PRO_BusinessTaskPackage> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_TMS_PRO_BusinessTaskPackage> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_TMS_PRO_BusinessTaskPackage> Search(DbConnection connection, DbTransaction transaction, Query query)
			{

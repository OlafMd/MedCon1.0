/* 
 * Generated on 24.09.2014 11:23:06
...
{
	[Serializable]
	public class ORM_CMN_BPT_Customer_PromisedDeliveryTime
	{
		public static readonly string TableName = "cmn_bpt_customer_promiseddeliverytimes";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_CMN_BPT_Customer_PromisedDeliveryTime()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_CMN_BPT_Customer_PromisedDeliveryTimeID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _CMN_BPT_Customer_PromisedDeliveryTimeID = default(Guid);
		...
		private float _TimeToDelivery_in_min = default(float);
		...
		public Guid CMN_BPT_Customer_PromisedDeliveryTimeID { 
			get {
				return _CMN_BPT_Customer_PromisedDeliveryTimeID;
			}
			set {
				if(_CMN_BPT_Customer_PromisedDeliveryTimeID != value){
					_CMN_BPT_Customer_PromisedDeliveryTimeID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		public float TimeToDelivery_in_min { 
			get {
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_CMN_BPT.CMN_BPT_Customer_PromisedDeliveryTime.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_CMN_BPT.CMN_BPT_Customer_PromisedDeliveryTime.SQL.Insert.sql")).ReadToEnd();
					}
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "CMN_BPT_Customer_PromisedDeliveryTimeID", _CMN_BPT_Customer_PromisedDeliveryTimeID);
		...
		private FR_Base Load(DbConnection Connection, DbTransaction Transaction, Guid ObjectID, string ConnectionString)
		{
			...
			try
			{
				...
				string SelectQuery = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_CMN_BPT.CMN_BPT_Customer_PromisedDeliveryTime.SQL.Select.sql")).ReadToEnd();
				...
				_CMN_BPT_Customer_PromisedDeliveryTimeID = Guid.Empty;
				CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command,"CMN_BPT_Customer_PromisedDeliveryTimeID", ObjectID );
				...
				try
				{
					...
					reader.SetOrdinals(new string[] { "CMN_BPT_Customer_PromisedDeliveryTimeID","Customer_RefID","CRONExpression","Specified_Product_Group_RefID","Specified_Product_RefID","Specified_Product_Variant_RefID","Specified_Product_Release_RefID","TimeToDelivery_in_min","Creation_Timestamp","Tenant_RefID","IsDeleted" });
					if (reader.HasRows == true)
					{
						reader.Read(); //Single result only
						//0:Parameter CMN_BPT_Customer_PromisedDeliveryTimeID of type Guid
						_CMN_BPT_Customer_PromisedDeliveryTimeID = reader.GetGuid(0);
						...
						//7:Parameter TimeToDelivery_in_min of type float
						_TimeToDelivery_in_min = (float)reader.GetDouble(7);
					...
					if(_CMN_BPT_Customer_PromisedDeliveryTimeID != Guid.Empty){
						//Successfully loaded
						Status_IsAlreadySaved = true;
						Status_IsDirty = false;
					} else {
		...
		public class Query : CSV2Core_MySQL.BaseFilterQuery<Query>
        {
			...
			#region Search
			public static List<ORM_CMN_BPT_Customer_PromisedDeliveryTime> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_CMN_BPT_Customer_PromisedDeliveryTime> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_CMN_BPT_Customer_PromisedDeliveryTime> Search(DbConnection connection, DbTransaction transaction, Query query)
			{
			    return Query.Search(query, null, connection, transaction);
			}

			private static List<ORM_CMN_BPT_Customer_PromisedDeliveryTime> Search(Query query, string connectionString, DbConnection connection, DbTransaction transaction)
			{
				CSV2Core.Core.Interfaces.IManagedConnection managedConnection = new CSV2Core_MySQL.MySQLManagedConnection();
			    List<ORM_CMN_BPT_Customer_PromisedDeliveryTime> items;
				...
				try
			    {
			        ...
			        items = new List<ORM_CMN_BPT_Customer_PromisedDeliveryTime>();

			        var reader = new CSV2Core_MySQL.Support.DBSQLReader(command.ExecuteReader());
					reader.SetOrdinals(new string[] { "CMN_BPT_Customer_PromisedDeliveryTimeID","Customer_RefID","CRONExpression","Specified_Product_Group_RefID","Specified_Product_RefID","Specified_Product_Variant_RefID","Specified_Product_Release_RefID","TimeToDelivery_in_min","Creation_Timestamp","Tenant_RefID","IsDeleted" });
			        while (reader.Read())
			        {
			            ORM_CMN_BPT_Customer_PromisedDeliveryTime item = new ORM_CMN_BPT_Customer_PromisedDeliveryTime();
						//0:Parameter CMN_BPT_Customer_PromisedDeliveryTimeID of type Guid
						item.CMN_BPT_Customer_PromisedDeliveryTimeID = reader.GetGuid(0);
						//1:Parameter Customer_RefID of type Guid
						...
						//7:Parameter TimeToDelivery_in_min of type float
						item.TimeToDelivery_in_min = (float)reader.GetDouble(7);
						//8:Parameter Creation_Timestamp of type DateTime

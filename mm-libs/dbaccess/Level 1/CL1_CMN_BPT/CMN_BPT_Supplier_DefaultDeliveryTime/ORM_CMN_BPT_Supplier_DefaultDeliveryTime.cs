/* 
 * Generated on 9/26/2014 12:17:45 PM
...
{
	[Serializable]
	public class ORM_CMN_BPT_Supplier_DefaultDeliveryTime
	{
		public static readonly string TableName = "cmn_bpt_supplier_defaultdeliverytimes";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_CMN_BPT_Supplier_DefaultDeliveryTime()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_CMN_BPT_Supplier_DefaultDeliveryTimeID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _CMN_BPT_Supplier_DefaultDeliveryTimeID = default(Guid);
		...
		private Double _TimeToDelivery_in_min = default(Double);
		...
		public Guid CMN_BPT_Supplier_DefaultDeliveryTimeID { 
			get {
				return _CMN_BPT_Supplier_DefaultDeliveryTimeID;
			}
			set {
				if(_CMN_BPT_Supplier_DefaultDeliveryTimeID != value){
					_CMN_BPT_Supplier_DefaultDeliveryTimeID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		public Double TimeToDelivery_in_min { 
			get {
				return _TimeToDelivery_in_min;
			}
			set {
				if(_TimeToDelivery_in_min != value){
					_TimeToDelivery_in_min = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_CMN_BPT.CMN_BPT_Supplier_DefaultDeliveryTime.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_CMN_BPT.CMN_BPT_Supplier_DefaultDeliveryTime.SQL.Insert.sql")).ReadToEnd();
					}
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "CMN_BPT_Supplier_DefaultDeliveryTimeID", _CMN_BPT_Supplier_DefaultDeliveryTimeID);
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "TimeToDelivery_in_min", _TimeToDelivery_in_min);
		...
		private FR_Base Load(DbConnection Connection, DbTransaction Transaction, Guid ObjectID, string ConnectionString)
		{
			...
			try
			{
				...
				string SelectQuery = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_CMN_BPT.CMN_BPT_Supplier_DefaultDeliveryTime.SQL.Select.sql")).ReadToEnd();
				...
				_CMN_BPT_Supplier_DefaultDeliveryTimeID = Guid.Empty;
				CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command,"CMN_BPT_Supplier_DefaultDeliveryTimeID", ObjectID );
				...
				try
				{
					...
					reader.SetOrdinals(new string[] { "CMN_BPT_Supplier_DefaultDeliveryTimeID","Supplier_RefID","CRONExpression","Specified_Product_Group_RefID","Specified_Product_RefID","Specified_Product_Variant_RefID","Specified_Product_Release_RefID","TimeToDelivery_in_min","Creation_Timestamp","Tenant_RefID","IsDeleted" });
					if (reader.HasRows == true)
					{
						reader.Read(); //Single result only
						//0:Parameter CMN_BPT_Supplier_DefaultDeliveryTimeID of type Guid
						_CMN_BPT_Supplier_DefaultDeliveryTimeID = reader.GetGuid(0);
						...
						//7:Parameter TimeToDelivery_in_min of type Double
						_TimeToDelivery_in_min = reader.GetDouble(7);
					...
					if(_CMN_BPT_Supplier_DefaultDeliveryTimeID != Guid.Empty){
						//Successfully loaded
						Status_IsAlreadySaved = true;
						Status_IsDirty = false;
					} else {
		...
		public class Query : CSV2Core_MySQL.BaseFilterQuery<Query>
        {
			...
			public Double? TimeToDelivery_in_min {	get; set; }
			...
			#region Search
			public static List<ORM_CMN_BPT_Supplier_DefaultDeliveryTime> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_CMN_BPT_Supplier_DefaultDeliveryTime> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_CMN_BPT_Supplier_DefaultDeliveryTime> Search(DbConnection connection, DbTransaction transaction, Query query)
			{
			    return Query.Search(query, null, connection, transaction);
			}

			private static List<ORM_CMN_BPT_Supplier_DefaultDeliveryTime> Search(Query query, string connectionString, DbConnection connection, DbTransaction transaction)
			{
				CSV2Core.Core.Interfaces.IManagedConnection managedConnection = new CSV2Core_MySQL.MySQLManagedConnection();
			    List<ORM_CMN_BPT_Supplier_DefaultDeliveryTime> items;
				...
				try
			    {
			        ...
			        items = new List<ORM_CMN_BPT_Supplier_DefaultDeliveryTime>();

			        var reader = new CSV2Core_MySQL.Support.DBSQLReader(command.ExecuteReader());
					reader.SetOrdinals(new string[] { "CMN_BPT_Supplier_DefaultDeliveryTimeID","Supplier_RefID","CRONExpression","Specified_Product_Group_RefID","Specified_Product_RefID","Specified_Product_Variant_RefID","Specified_Product_Release_RefID","TimeToDelivery_in_min","Creation_Timestamp","Tenant_RefID","IsDeleted" });
			        while (reader.Read())
			        {
			            ORM_CMN_BPT_Supplier_DefaultDeliveryTime item = new ORM_CMN_BPT_Supplier_DefaultDeliveryTime();
						//0:Parameter CMN_BPT_Supplier_DefaultDeliveryTimeID of type Guid
						item.CMN_BPT_Supplier_DefaultDeliveryTimeID = reader.GetGuid(0);
						//1:Parameter Supplier_RefID of type Guid
						...
						//7:Parameter TimeToDelivery_in_min of type Double
						item.TimeToDelivery_in_min = reader.GetDouble(7);
						//8:Parameter Creation_Timestamp of type DateTime

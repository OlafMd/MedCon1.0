/* 
 * Generated on 12/25/2013 6:13:06 PM
...
{
	[Serializable]
	public class ORM_CMN_BPT_CTM_CatalogProductExtensionRequest_Product
	{
		public static readonly string TableName = "cmn_bpt_ctm_catalogproductextensionrequest_products";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_CMN_BPT_CTM_CatalogProductExtensionRequest_Product()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_CMN_BPT_CTM_CatalogProductExtensionRequest_ProductID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _CMN_BPT_CTM_CatalogProductExtensionRequest_ProductID = default(Guid);
		...
		private Guid _CatalogProductExtensionRequest_RefID = default(Guid);
		...
		public Guid CMN_BPT_CTM_CatalogProductExtensionRequest_ProductID { 
			get {
				return _CMN_BPT_CTM_CatalogProductExtensionRequest_ProductID;
			}
			set {
				if(_CMN_BPT_CTM_CatalogProductExtensionRequest_ProductID != value){
					_CMN_BPT_CTM_CatalogProductExtensionRequest_ProductID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		public Guid CatalogProductExtensionRequest_RefID { 
			get {
				return _CatalogProductExtensionRequest_RefID;
			}
			set {
				if(_CatalogProductExtensionRequest_RefID != value){
					_CatalogProductExtensionRequest_RefID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_CMN_BPT_CTM.CMN_BPT_CTM_CatalogProductExtensionRequest_Product.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_CMN_BPT_CTM.CMN_BPT_CTM_CatalogProductExtensionRequest_Product.SQL.Insert.sql")).ReadToEnd();
					}
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "CMN_BPT_CTM_CatalogProductExtensionRequest_ProductID", _CMN_BPT_CTM_CatalogProductExtensionRequest_ProductID);
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "CatalogProductExtensionRequest_RefID", _CatalogProductExtensionRequest_RefID);
		...
		private FR_Base Load(DbConnection Connection, DbTransaction Transaction, Guid ObjectID, string ConnectionString)
		{
			...
			try
			{
				...
				string SelectQuery = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_CMN_BPT_CTM.CMN_BPT_CTM_CatalogProductExtensionRequest_Product.SQL.Select.sql")).ReadToEnd();
				...
				_CMN_BPT_CTM_CatalogProductExtensionRequest_ProductID = Guid.Empty;
				CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command,"CMN_BPT_CTM_CatalogProductExtensionRequest_ProductID", ObjectID );
				...
				try
				{
					...
					if (reader.HasRows == true)
					{
						...
						_CMN_BPT_CTM_CatalogProductExtensionRequest_ProductID = reader.GetGuid(0);
						...
						_CatalogProductExtensionRequest_RefID = reader.GetGuid(4);
					...
					if(_CMN_BPT_CTM_CatalogProductExtensionRequest_ProductID != Guid.Empty){
						//Successfully loaded
						Status_IsAlreadySaved = true;
						Status_IsDirty = false;
					} else {
		...
		public class Query : CSV2Core_MySQL.BaseFilterQuery<Query>
        {
			...
			public Guid? CatalogProductExtensionRequest_RefID {	get; set; }
			...
			#region Search
			public static List<ORM_CMN_BPT_CTM_CatalogProductExtensionRequest_Product> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_CMN_BPT_CTM_CatalogProductExtensionRequest_Product> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_CMN_BPT_CTM_CatalogProductExtensionRequest_Product> Search(DbConnection connection, DbTransaction transaction, Query query)
			{

/* 
 * Generated on 9/2/2014 12:32:14 PM
...
{
	[Serializable]
	public class ORM_HEC_PotentialMedication
	{
		public static readonly string TableName = "hec_potentialmedications";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_HEC_PotentialMedication()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_HEC_PotentialMedicationID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _HEC_PotentialMedicationID = default(Guid);
		...
		private double _IfSubstance_Strength = default(double);
		private Guid _IfSubstance_Unit_RefID = default(Guid);
		private Guid _HEC_SUB_Substance_RefiD = default(Guid);
		private String _RecommendedDosage = default(String);
		...
		public Guid HEC_PotentialMedicationID { 
			get {
				return _HEC_PotentialMedicationID;
			}
			set {
				if(_HEC_PotentialMedicationID != value){
					_HEC_PotentialMedicationID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		public double IfSubstance_Strength { 
			get {
		...
		public String RecommendedDosage { 
			get {
				return _RecommendedDosage;
			}
			set {
				if(_RecommendedDosage != value){
					_RecommendedDosage = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_HEC.HEC_PotentialMedication.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_HEC.HEC_PotentialMedication.SQL.Insert.sql")).ReadToEnd();
					}
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "HEC_PotentialMedicationID", _HEC_PotentialMedicationID);
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "RecommendedDosage", _RecommendedDosage);
		...
		public class Query : CSV2Core_MySQL.BaseFilterQuery<Query>
        {
			...
			#region Search
			public static List<ORM_HEC_PotentialMedication> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_HEC_PotentialMedication> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_HEC_PotentialMedication> Search(DbConnection connection, DbTransaction transaction, Query query)
			{
			    return Query.Search(query, null, connection, transaction);
			}

			private static List<ORM_HEC_PotentialMedication> Search(Query query, string connectionString, DbConnection connection, DbTransaction transaction)
			{
				CSV2Core.Core.Interfaces.IManagedConnection managedConnection = new CSV2Core_MySQL.MySQLManagedConnection();
			    List<ORM_HEC_PotentialMedication> items;
				...
				try
			    {
			        ...
			        items = new List<ORM_HEC_PotentialMedication>();

			        var reader = new CSV2Core_MySQL.Support.DBSQLReader(command.ExecuteReader());
					reader.SetOrdinals(new string[] { "HEC_PotentialMedicationID","IsHealthcareProduct","HEC_Product_RefID","IsSubstance","IfSubstance_Strength","IfSubstance_Unit_RefID","HEC_SUB_Substance_RefiD","RecommendedDosage","Creation_Timestamp","Tenant_RefID","IsDeleted" });
			        while (reader.Read())
			        {
			            ORM_HEC_PotentialMedication item = new ORM_HEC_PotentialMedication();
						//0:Parameter HEC_PotentialMedicationID of type Guid
						item.HEC_PotentialMedicationID = reader.GetGuid(0);
						//1:Parameter IsHealthcareProduct of type Boolean
						...
						//4:Parameter IfSubstance_Strength of type double
						item.IfSubstance_Strength = reader.GetDouble(4);
						//5:Parameter IfSubstance_Unit_RefID of type Guid
						item.IfSubstance_Unit_RefID = reader.GetGuid(5);
						//6:Parameter HEC_SUB_Substance_RefiD of type Guid
						item.HEC_SUB_Substance_RefiD = reader.GetGuid(6);
						//7:Parameter RecommendedDosage of type String
						item.RecommendedDosage = reader.GetString(7);
						//8:Parameter Creation_Timestamp of type DateTime

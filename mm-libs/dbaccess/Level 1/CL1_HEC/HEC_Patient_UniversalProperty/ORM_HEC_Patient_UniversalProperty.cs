/* 
 * Generated on 10/21/16 11:50:41
...
{
	[Serializable]
	public class ORM_HEC_Patient_UniversalProperty
	{
		public static readonly string TableName = "hec_patient_universalproperties";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_HEC_Patient_UniversalProperty()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_HEC_Patient_UniversalPropertyID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _HEC_Patient_UniversalPropertyID = default(Guid);
		...
		private String _IfValue_String_DefaultValue = default(String);
		private Boolean _IsValue_Number = default(Boolean);
		private double _IfValue_Number_DefaultValue = default(double);
		private Boolean _IsValue_Boolean = default(Boolean);
		private Boolean _IfValue_Boolean_DefaultValue = default(Boolean);
		...
		public Guid HEC_Patient_UniversalPropertyID { 
			get {
				return _HEC_Patient_UniversalPropertyID;
			}
			set {
				if(_HEC_Patient_UniversalPropertyID != value){
					_HEC_Patient_UniversalPropertyID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		public String IfValue_String_DefaultValue { 
			get {
				return _IfValue_String_DefaultValue;
			}
			set {
				if(_IfValue_String_DefaultValue != value){
					_IfValue_String_DefaultValue = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		public double IfValue_Number_DefaultValue { 
			get {
				return _IfValue_Number_DefaultValue;
			}
			set {
				if(_IfValue_Number_DefaultValue != value){
					_IfValue_Number_DefaultValue = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		public Boolean IfValue_Boolean_DefaultValue { 
			get {
				return _IfValue_Boolean_DefaultValue;
			}
			set {
				if(_IfValue_Boolean_DefaultValue != value){
					_IfValue_Boolean_DefaultValue = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_HEC.HEC_Patient_UniversalProperty.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_HEC.HEC_Patient_UniversalProperty.SQL.Insert.sql")).ReadToEnd();
					}
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "HEC_Patient_UniversalPropertyID", _HEC_Patient_UniversalPropertyID);
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "IfValue_String_DefaultValue", _IfValue_String_DefaultValue);
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "IsValue_Number", _IsValue_Number);
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "IfValue_Number_DefaultValue", _IfValue_Number_DefaultValue);
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "IsValue_Boolean", _IsValue_Boolean);
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "IfValue_Boolean_DefaultValue", _IfValue_Boolean_DefaultValue);
		...
		private FR_Base Load(DbConnection Connection, DbTransaction Transaction, Guid ObjectID, string ConnectionString)
		{
			...
			try
			{
				...
				string SelectQuery = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_HEC.HEC_Patient_UniversalProperty.SQL.Select.sql")).ReadToEnd();
				...
				_HEC_Patient_UniversalPropertyID = Guid.Empty;
				CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command,"HEC_Patient_UniversalPropertyID", ObjectID );
				...
				try
				{
					...
					if (reader.HasRows == true)
					{
						...
						_HEC_Patient_UniversalPropertyID = reader.GetGuid(0);
						...
						_IfValue_String_DefaultValue = reader.GetString(4);
						//5:Parameter IsValue_Number of type Boolean
						_IsValue_Number = reader.GetBoolean(5);
						//6:Parameter IfValue_Number_DefaultValue of type double
						_IfValue_Number_DefaultValue = reader.GetDouble(6);
						//7:Parameter IsValue_Boolean of type Boolean
						_IsValue_Boolean = reader.GetBoolean(7);
						//8:Parameter IfValue_Boolean_DefaultValue of type Boolean
						_IfValue_Boolean_DefaultValue = reader.GetBoolean(8);
					...
					if(_HEC_Patient_UniversalPropertyID != Guid.Empty){
						//Successfully loaded
						Status_IsAlreadySaved = true;
						Status_IsDirty = false;
					} else {
        ...
        {
			public Guid? HEC_Patient_UniversalPropertyID {	get; set; }
			public String GlobalPropertyMatchingID {	get; set; }
			public String PropertyName {	get; set; }
			public Boolean? IsValue_String {	get; set; }
			public String IfValue_String_DefaultValue {	get; set; }
			public Boolean? IsValue_Number {	get; set; }
			public double? IfValue_Number_DefaultValue {	get; set; }
			public Boolean? IsValue_Boolean {	get; set; }
			public Boolean? IfValue_Boolean_DefaultValue {	get; set; }
			...
			#region Search
			public static List<ORM_HEC_Patient_UniversalProperty> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_HEC_Patient_UniversalProperty> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_HEC_Patient_UniversalProperty> Search(DbConnection connection, DbTransaction transaction, Query query)
			{

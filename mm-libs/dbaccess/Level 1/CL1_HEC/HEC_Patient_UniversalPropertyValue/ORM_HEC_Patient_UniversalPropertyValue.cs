/* 
 * Generated on 10/21/16 11:50:29
...
{
	[Serializable]
	public class ORM_HEC_Patient_UniversalPropertyValue
	{
		public static readonly string TableName = "hec_patient_universalpropertyvalues";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_HEC_Patient_UniversalPropertyValue()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_HEC_Patient_UniversalPropertyValueID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _HEC_Patient_UniversalPropertyValueID = default(Guid);
		private Guid _HEC_Patient_RefID = default(Guid);
		private Guid _HEC_Patient_UniversalProperty_RefID = default(Guid);
		...
		public Guid HEC_Patient_UniversalPropertyValueID { 
			get {
				return _HEC_Patient_UniversalPropertyValueID;
			}
			set {
				if(_HEC_Patient_UniversalPropertyValueID != value){
					_HEC_Patient_UniversalPropertyValueID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		public Guid HEC_Patient_UniversalProperty_RefID { 
			get {
				return _HEC_Patient_UniversalProperty_RefID;
			}
			set {
				if(_HEC_Patient_UniversalProperty_RefID != value){
					_HEC_Patient_UniversalProperty_RefID = value;
					Status_IsDirty = true;
				}
			}
		} 
        ...
        {
			public Guid? HEC_Patient_UniversalPropertyValueID {	get; set; }
			public Guid? HEC_Patient_RefID {	get; set; }
			public Guid? HEC_Patient_UniversalProperty_RefID {	get; set; }
			...
			#region Search
			public static List<ORM_HEC_Patient_UniversalPropertyValue> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_HEC_Patient_UniversalPropertyValue> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_HEC_Patient_UniversalPropertyValue> Search(DbConnection connection, DbTransaction transaction, Query query)
			{
			    return Query.Search(query, null, connection, transaction);
			}

			private static List<ORM_HEC_Patient_UniversalPropertyValue> Search(Query query, string connectionString, DbConnection connection, DbTransaction transaction)
			{
				CSV2Core.Core.Interfaces.IManagedConnection managedConnection = new CSV2Core_MySQL.MySQLManagedConnection();
			    List<ORM_HEC_Patient_UniversalPropertyValue> items;
				...
				try
			    {
			        ...
			        items = new List<ORM_HEC_Patient_UniversalPropertyValue>();

			        var reader = new CSV2Core_MySQL.Support.DBSQLReader(command.ExecuteReader());
					reader.SetOrdinals(new string[] { "HEC_Patient_UniversalPropertyValueID","HEC_Patient_RefID","HEC_Patient_UniversalProperty_RefID","Value_String","Value_Number","Value_Boolean","Creation_Timestamp","Tenant_RefID","IsDeleted","Modification_Timestamp" });
			        while (reader.Read())
			        {
			            ORM_HEC_Patient_UniversalPropertyValue item = new ORM_HEC_Patient_UniversalPropertyValue();
						//0:Parameter HEC_Patient_UniversalPropertyValueID of type Guid
						item.HEC_Patient_UniversalPropertyValueID = reader.GetGuid(0);
						//1:Parameter HEC_Patient_RefID of type Guid
						item.HEC_Patient_RefID = reader.GetGuid(1);
						//2:Parameter HEC_Patient_UniversalProperty_RefID of type Guid
						item.HEC_Patient_UniversalProperty_RefID = reader.GetGuid(2);
						//3:Parameter Value_String of type String

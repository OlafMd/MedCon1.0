/* 
 * Generated on 12/11/2014 3:26:36 PM
...
{
	[Serializable]
	public class ORM_HEC_Patient_Diagnosis_2_PatientMedication
	{
		public static readonly string TableName = "hec_patient_diagnosis_2_patientmedication";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_HEC_Patient_Diagnosis_2_PatientMedication()
		{
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_HEC.HEC_Patient_Diagnosis_2_PatientMedication.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_HEC.HEC_Patient_Diagnosis_2_PatientMedication.SQL.Insert.sql")).ReadToEnd();
					}
		...
		private FR_Base Load(DbConnection Connection, DbTransaction Transaction, Guid ObjectID, string ConnectionString)
		{
			...
			try
			{
				...
				string SelectQuery = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_HEC.HEC_Patient_Diagnosis_2_PatientMedication.SQL.Select.sql")).ReadToEnd();
				...
				try
				{
					...
					reader.SetOrdinals(new string[] { "AssignmentID","HEC_Patient_Diagnosis_RefID","HEC_Patient_Medication_RefID","Creation_Timestamp","Tenant_RefID","IsDeleted","Modification_Timestamp" });
					if (reader.HasRows == true)
					{
						...
						_HEC_Patient_Diagnosis_RefID = reader.GetGuid(1);
		...
		public class Query : CSV2Core_MySQL.BaseFilterQuery<Query>
        {
			...
			#region Search
			public static List<ORM_HEC_Patient_Diagnosis_2_PatientMedication> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_HEC_Patient_Diagnosis_2_PatientMedication> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_HEC_Patient_Diagnosis_2_PatientMedication> Search(DbConnection connection, DbTransaction transaction, Query query)
			{
			    return Query.Search(query, null, connection, transaction);
			}

			private static List<ORM_HEC_Patient_Diagnosis_2_PatientMedication> Search(Query query, string connectionString, DbConnection connection, DbTransaction transaction)
			{
				CSV2Core.Core.Interfaces.IManagedConnection managedConnection = new CSV2Core_MySQL.MySQLManagedConnection();
			    List<ORM_HEC_Patient_Diagnosis_2_PatientMedication> items;
				...
				try
			    {
			        ...
			        items = new List<ORM_HEC_Patient_Diagnosis_2_PatientMedication>();

			        var reader = new CSV2Core_MySQL.Support.DBSQLReader(command.ExecuteReader());
					reader.SetOrdinals(new string[] { "AssignmentID","HEC_Patient_Diagnosis_RefID","HEC_Patient_Medication_RefID","Creation_Timestamp","Tenant_RefID","IsDeleted","Modification_Timestamp" });
			        while (reader.Read())
			        {
			            ORM_HEC_Patient_Diagnosis_2_PatientMedication item = new ORM_HEC_Patient_Diagnosis_2_PatientMedication();
						//0:Parameter AssignmentID of type Guid
						item.AssignmentID = reader.GetGuid(0);
						//1:Parameter HEC_Patient_Diagnosis_RefID of type Guid
						item.HEC_Patient_Diagnosis_RefID = reader.GetGuid(1);
						//2:Parameter HEC_Patient_Medication_RefID of type Guid

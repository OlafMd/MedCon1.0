/* 
 * Generated on 2/10/2015 2:22:40 AM
...
{
	[Serializable]
	public class ORM_HEC_CMT_OPT_UploadedMedication
	{
		public static readonly string TableName = "hec_cmt_opt_uploadedmedications";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_HEC_CMT_OPT_UploadedMedication()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_HEC_CMT_OPT_UploadedMedicationID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _HEC_CMT_OPT_UploadedMedicationID = default(Guid);
		...
		public Guid HEC_CMT_OPT_UploadedMedicationID { 
			get {
				return _HEC_CMT_OPT_UploadedMedicationID;
			}
			set {
				if(_HEC_CMT_OPT_UploadedMedicationID != value){
					_HEC_CMT_OPT_UploadedMedicationID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_HEC_CMT_OPT.HEC_CMT_OPT_UploadedMedication.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_HEC_CMT_OPT.HEC_CMT_OPT_UploadedMedication.SQL.Insert.sql")).ReadToEnd();
					}
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "HEC_CMT_OPT_UploadedMedicationID", _HEC_CMT_OPT_UploadedMedicationID);
		...
		private FR_Base Load(DbConnection Connection, DbTransaction Transaction, Guid ObjectID, string ConnectionString)
		{
			...
			try
			{
				...
				string SelectQuery = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_HEC_CMT_OPT.HEC_CMT_OPT_UploadedMedication.SQL.Select.sql")).ReadToEnd();
				...
				_HEC_CMT_OPT_UploadedMedicationID = Guid.Empty;
				CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command,"HEC_CMT_OPT_UploadedMedicationID", ObjectID );
				...
				try
				{
					...
					reader.SetOrdinals(new string[] { "HEC_CMT_OPT_UploadedMedicationID","UploadedBy_Member_RefID","IsProduct","IfProduct_UploadedProductITL","IsSubstance","IfSubstance_Unit_ISOCode","IfSubstance_UploadedSubstanceITL","IfSubstance_Strength","DosageText","Creation_Timestamp","Tenant_RefID","IsDeleted","Modification_Timestamp" });
					if (reader.HasRows == true)
					{
						reader.Read(); //Single result only
						//0:Parameter HEC_CMT_OPT_UploadedMedicationID of type Guid
						_HEC_CMT_OPT_UploadedMedicationID = reader.GetGuid(0);
					...
					if(_HEC_CMT_OPT_UploadedMedicationID != Guid.Empty){
						//Successfully loaded
						Status_IsAlreadySaved = true;
						Status_IsDirty = false;
					} else {
        ...
        {
			public Guid? HEC_CMT_OPT_UploadedMedicationID {	get; set; }
			...
			#region Search
			public static List<ORM_HEC_CMT_OPT_UploadedMedication> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_HEC_CMT_OPT_UploadedMedication> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_HEC_CMT_OPT_UploadedMedication> Search(DbConnection connection, DbTransaction transaction, Query query)
			{
			    return Query.Search(query, null, connection, transaction);
			}

			private static List<ORM_HEC_CMT_OPT_UploadedMedication> Search(Query query, string connectionString, DbConnection connection, DbTransaction transaction)
			{
				CSV2Core.Core.Interfaces.IManagedConnection managedConnection = new CSV2Core_MySQL.MySQLManagedConnection();
			    List<ORM_HEC_CMT_OPT_UploadedMedication> items;
				...
				try
			    {
			        ...
			        items = new List<ORM_HEC_CMT_OPT_UploadedMedication>();

			        var reader = new CSV2Core_MySQL.Support.DBSQLReader(command.ExecuteReader());
					reader.SetOrdinals(new string[] { "HEC_CMT_OPT_UploadedMedicationID","UploadedBy_Member_RefID","IsProduct","IfProduct_UploadedProductITL","IsSubstance","IfSubstance_Unit_ISOCode","IfSubstance_UploadedSubstanceITL","IfSubstance_Strength","DosageText","Creation_Timestamp","Tenant_RefID","IsDeleted","Modification_Timestamp" });
			        while (reader.Read())
			        {
			            ORM_HEC_CMT_OPT_UploadedMedication item = new ORM_HEC_CMT_OPT_UploadedMedication();
						//0:Parameter HEC_CMT_OPT_UploadedMedicationID of type Guid
						item.HEC_CMT_OPT_UploadedMedicationID = reader.GetGuid(0);
						//1:Parameter UploadedBy_Member_RefID of type Guid

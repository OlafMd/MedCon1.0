/* 
 * Generated on 22-Oct-13 14:26:09
...
{
	[Serializable]
	public class ORM_CMN_BPT_EMP_WorkplaceAssignments_WorkPattern
	{
		public static readonly string TableName = "cmn_bpt_emp_workplaceassignments_workpatterns";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_CMN_BPT_EMP_WorkplaceAssignments_WorkPattern()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_CMN_BPT_EMP_WorkplaceAssignments_WorkPatternID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _CMN_BPT_EMP_WorkplaceAssignments_WorkPatternID = default(Guid);
		private Boolean _IsWeek_Even = default(Boolean);
		private Boolean _IsWeek_Odd = default(Boolean);
		private Guid _BoundTo_WorkplaceAssignment_RefID = default(Guid);
		...
		public Guid CMN_BPT_EMP_WorkplaceAssignments_WorkPatternID { 
			get {
				return _CMN_BPT_EMP_WorkplaceAssignments_WorkPatternID;
			}
			set {
				if(_CMN_BPT_EMP_WorkplaceAssignments_WorkPatternID != value){
					_CMN_BPT_EMP_WorkplaceAssignments_WorkPatternID = value;
					Status_IsDirty = true;
				}
			}
		} 
		public Boolean IsWeek_Even { 
			get {
				return _IsWeek_Even;
			}
			set {
				if(_IsWeek_Even != value){
					_IsWeek_Even = value;
					Status_IsDirty = true;
				}
			}
		} 
		public Boolean IsWeek_Odd { 
			get {
				return _IsWeek_Odd;
			}
			set {
				if(_IsWeek_Odd != value){
					_IsWeek_Odd = value;
					Status_IsDirty = true;
				}
			}
		} 
		public Guid BoundTo_WorkplaceAssignment_RefID { 
			get {
				return _BoundTo_WorkplaceAssignment_RefID;
			}
			set {
				if(_BoundTo_WorkplaceAssignment_RefID != value){
					_BoundTo_WorkplaceAssignment_RefID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_CMN_BPT_EMP.CMN_BPT_EMP_WorkplaceAssignments_WorkPattern.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_CMN_BPT_EMP.CMN_BPT_EMP_WorkplaceAssignments_WorkPattern.SQL.Insert.sql")).ReadToEnd();
					}
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "CMN_BPT_EMP_WorkplaceAssignments_WorkPatternID", _CMN_BPT_EMP_WorkplaceAssignments_WorkPatternID);
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "IsWeek_Even", _IsWeek_Even);
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "IsWeek_Odd", _IsWeek_Odd);
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "BoundTo_WorkplaceAssignment_RefID", _BoundTo_WorkplaceAssignment_RefID);
		...
		private FR_Base Load(DbConnection Connection, DbTransaction Transaction, Guid ObjectID, string ConnectionString)
		{
			...
			try
			{
				...
				string SelectQuery = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_CMN_BPT_EMP.CMN_BPT_EMP_WorkplaceAssignments_WorkPattern.SQL.Select.sql")).ReadToEnd();
				...
				_CMN_BPT_EMP_WorkplaceAssignments_WorkPatternID = Guid.Empty;
				CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command,"CMN_BPT_EMP_WorkplaceAssignments_WorkPatternID", ObjectID );
				...
				try
				{
					...
					if (reader.HasRows == true)
					{
						...
						_CMN_BPT_EMP_WorkplaceAssignments_WorkPatternID = reader.GetGuid(0);
						//1:Parameter IsWeek_Even of type Boolean
						_IsWeek_Even = reader.GetBoolean(1);
						//2:Parameter IsWeek_Odd of type Boolean
						_IsWeek_Odd = reader.GetBoolean(2);
						//3:Parameter BoundTo_WorkplaceAssignment_RefID of type Guid
						_BoundTo_WorkplaceAssignment_RefID = reader.GetGuid(3);
						//4:Parameter CMN_PPS_ShiftTemplate_RefID of type Guid
						_CMN_PPS_ShiftTemplate_RefID = reader.GetGuid(4);
					...
					if(_CMN_BPT_EMP_WorkplaceAssignments_WorkPatternID != Guid.Empty){
						//Successfully loaded
						Status_IsAlreadySaved = true;
						Status_IsDirty = false;
					} else {
        ...
        {
			public Guid? CMN_BPT_EMP_WorkplaceAssignments_WorkPatternID {	get; set; }
			public Boolean? IsWeek_Even {	get; set; }
			public Boolean? IsWeek_Odd {	get; set; }
			public Guid? BoundTo_WorkplaceAssignment_RefID {	get; set; }
			...
			#region Search
			public static List<ORM_CMN_BPT_EMP_WorkplaceAssignments_WorkPattern> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_CMN_BPT_EMP_WorkplaceAssignments_WorkPattern> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_CMN_BPT_EMP_WorkplaceAssignments_WorkPattern> Search(DbConnection connection, DbTransaction transaction, Query query)
			{

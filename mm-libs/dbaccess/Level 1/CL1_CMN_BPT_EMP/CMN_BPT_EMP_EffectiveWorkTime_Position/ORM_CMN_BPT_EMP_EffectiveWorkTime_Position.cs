/* 
 * Generated on 5/5/2014 3:14:17 PM
...
{
	[Serializable]
	public class ORM_CMN_BPT_EMP_EffectiveWorkTime_Position
	{
		public static readonly string TableName = "cmn_bpt_emp_effectiveworktime_positions";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_CMN_BPT_EMP_EffectiveWorkTime_Position()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_CMN_BPT_EMP_EffectiveWorkTime_PositionID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _CMN_BPT_EMP_EffectiveWorkTime_PositionID = default(Guid);
		...
		public Guid CMN_BPT_EMP_EffectiveWorkTime_PositionID { 
			get {
				return _CMN_BPT_EMP_EffectiveWorkTime_PositionID;
			}
			set {
				if(_CMN_BPT_EMP_EffectiveWorkTime_PositionID != value){
					_CMN_BPT_EMP_EffectiveWorkTime_PositionID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_CMN_BPT_EMP.CMN_BPT_EMP_EffectiveWorkTime_Position.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_CMN_BPT_EMP.CMN_BPT_EMP_EffectiveWorkTime_Position.SQL.Insert.sql")).ReadToEnd();
					}
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "CMN_BPT_EMP_EffectiveWorkTime_PositionID", _CMN_BPT_EMP_EffectiveWorkTime_PositionID);
		...
		private FR_Base Load(DbConnection Connection, DbTransaction Transaction, Guid ObjectID, string ConnectionString)
		{
			...
			try
			{
				...
				string SelectQuery = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_CMN_BPT_EMP.CMN_BPT_EMP_EffectiveWorkTime_Position.SQL.Select.sql")).ReadToEnd();
				...
				_CMN_BPT_EMP_EffectiveWorkTime_PositionID = Guid.Empty;
				CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command,"CMN_BPT_EMP_EffectiveWorkTime_PositionID", ObjectID );
				...
				try
				{
					...
					reader.SetOrdinals(new string[] { "CMN_BPT_EMP_EffectiveWorkTime_PositionID","EffectiveWorkTime_Header_RefID","CMN_BPT_EMP_Employe_RefID","Activity_RefID","Workplace_RefID","CMN_BPT_EMP_Employee_LeaveRequest_RefID","WorkTime_StartTime","WorkTime_Duration_in_sec","SourceOfEntry","Creation_Timestamp","Tenant_RefID","IsDeleted" });
					if (reader.HasRows == true)
					{
						reader.Read(); //Single result only
						//0:Parameter CMN_BPT_EMP_EffectiveWorkTime_PositionID of type Guid
						_CMN_BPT_EMP_EffectiveWorkTime_PositionID = reader.GetGuid(0);
						//1:Parameter EffectiveWorkTime_Header_RefID of type Guid
						_EffectiveWorkTime_Header_RefID = reader.GetGuid(1);
						//2:Parameter CMN_BPT_EMP_Employe_RefID of type Guid
						_CMN_BPT_EMP_Employe_RefID = reader.GetGuid(2);
					...
					if(_CMN_BPT_EMP_EffectiveWorkTime_PositionID != Guid.Empty){
						//Successfully loaded
						Status_IsAlreadySaved = true;
						Status_IsDirty = false;
					} else {
        ...
        {
			public Guid? CMN_BPT_EMP_EffectiveWorkTime_PositionID {	get; set; }
			...
			#region Search
			public static List<ORM_CMN_BPT_EMP_EffectiveWorkTime_Position> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_CMN_BPT_EMP_EffectiveWorkTime_Position> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_CMN_BPT_EMP_EffectiveWorkTime_Position> Search(DbConnection connection, DbTransaction transaction, Query query)
			{
			    return Query.Search(query, null, connection, transaction);
			}

			private static List<ORM_CMN_BPT_EMP_EffectiveWorkTime_Position> Search(Query query, string connectionString, DbConnection connection, DbTransaction transaction)
			{
				CSV2Core.Core.Interfaces.IManagedConnection managedConnection = new CSV2Core_MySQL.MySQLManagedConnection();
			    List<ORM_CMN_BPT_EMP_EffectiveWorkTime_Position> items;
				...
				try
			    {
			        ...
			        items = new List<ORM_CMN_BPT_EMP_EffectiveWorkTime_Position>();

			        var reader = new CSV2Core_MySQL.Support.DBSQLReader(command.ExecuteReader());
					reader.SetOrdinals(new string[] { "CMN_BPT_EMP_EffectiveWorkTime_PositionID","EffectiveWorkTime_Header_RefID","CMN_BPT_EMP_Employe_RefID","Activity_RefID","Workplace_RefID","CMN_BPT_EMP_Employee_LeaveRequest_RefID","WorkTime_StartTime","WorkTime_Duration_in_sec","SourceOfEntry","Creation_Timestamp","Tenant_RefID","IsDeleted" });
			        while (reader.Read())
			        {
			            ORM_CMN_BPT_EMP_EffectiveWorkTime_Position item = new ORM_CMN_BPT_EMP_EffectiveWorkTime_Position();
						//0:Parameter CMN_BPT_EMP_EffectiveWorkTime_PositionID of type Guid
						item.CMN_BPT_EMP_EffectiveWorkTime_PositionID = reader.GetGuid(0);
						//1:Parameter EffectiveWorkTime_Header_RefID of type Guid
						item.EffectiveWorkTime_Header_RefID = reader.GetGuid(1);
						//2:Parameter CMN_BPT_EMP_Employe_RefID of type Guid
						item.CMN_BPT_EMP_Employe_RefID = reader.GetGuid(2);
						//3:Parameter Activity_RefID of type Guid

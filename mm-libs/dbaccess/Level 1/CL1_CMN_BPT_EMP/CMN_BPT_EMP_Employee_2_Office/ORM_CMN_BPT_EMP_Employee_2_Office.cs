/* 
 * Generated on 1/17/2014 3:04:21 PM
...
{
	[Serializable]
	public class ORM_CMN_BPT_EMP_Employee_2_Office
	{
		public static readonly string TableName = "cmn_bpt_emp_employee_2_office";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_CMN_BPT_EMP_Employee_2_Office()
		{
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_CMN_BPT_EMP.CMN_BPT_EMP_Employee_2_Office.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_CMN_BPT_EMP.CMN_BPT_EMP_Employee_2_Office.SQL.Insert.sql")).ReadToEnd();
					}
		...
		private FR_Base Load(DbConnection Connection, DbTransaction Transaction, Guid ObjectID, string ConnectionString)
		{
			...
			try
			{
				...
				string SelectQuery = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_CMN_BPT_EMP.CMN_BPT_EMP_Employee_2_Office.SQL.Select.sql")).ReadToEnd();
				...
				try
				{
					...
					reader.SetOrdinals(new string[] { "AssignmentID","CMN_BPT_EMP_Employee_RefID","CMN_STR_Office_RefID","Creation_Timestamp","Tenant_RefID","IsDeleted" });
		...
		public class Query : CSV2Core_MySQL.BaseFilterQuery<Query>
        {
			...
			#region Search
			public static List<ORM_CMN_BPT_EMP_Employee_2_Office> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_CMN_BPT_EMP_Employee_2_Office> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_CMN_BPT_EMP_Employee_2_Office> Search(DbConnection connection, DbTransaction transaction, Query query)
			{
			    return Query.Search(query, null, connection, transaction);
			}

			private static List<ORM_CMN_BPT_EMP_Employee_2_Office> Search(Query query, string connectionString, DbConnection connection, DbTransaction transaction)
			{
				CSV2Core.Core.Interfaces.IManagedConnection managedConnection = new CSV2Core_MySQL.MySQLManagedConnection();
			    List<ORM_CMN_BPT_EMP_Employee_2_Office> items;
				...
				try
			    {
			        ...
			        items = new List<ORM_CMN_BPT_EMP_Employee_2_Office>();

			        var reader = new CSV2Core_MySQL.Support.DBSQLReader(command.ExecuteReader());
					reader.SetOrdinals(new string[] { "AssignmentID","CMN_BPT_EMP_Employee_RefID","CMN_STR_Office_RefID","Creation_Timestamp","Tenant_RefID","IsDeleted" });
			        while (reader.Read())
			        {
			            ORM_CMN_BPT_EMP_Employee_2_Office item = new ORM_CMN_BPT_EMP_Employee_2_Office();
						//0:Parameter AssignmentID of type Guid

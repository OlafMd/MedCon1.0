/* 
 * Generated on 5/5/2014 11:57:02 AM
...
{
	[Serializable]
	public class ORM_CMN_BPT_EMP_EffectiveWorkTime_Header
	{
		public static readonly string TableName = "cmn_bpt_emp_effectiveworktime_headers";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_CMN_BPT_EMP_EffectiveWorkTime_Header()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_CMN_STR_PPS_EffectiveWorkTime_HeaderID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _CMN_STR_PPS_EffectiveWorkTime_HeaderID = default(Guid);
		private Guid _Employee_RefID = default(Guid);
		private DateTime _EffectiveBusinessDay = default(DateTime);
		...
		private String _WorktimeComment = default(String);
		...
		public Guid CMN_STR_PPS_EffectiveWorkTime_HeaderID { 
			get {
				return _CMN_STR_PPS_EffectiveWorkTime_HeaderID;
			}
			set {
				if(_CMN_STR_PPS_EffectiveWorkTime_HeaderID != value){
					_CMN_STR_PPS_EffectiveWorkTime_HeaderID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		public DateTime EffectiveBusinessDay { 
			get {
				return _EffectiveBusinessDay;
			}
			set {
				if(_EffectiveBusinessDay != value){
					_EffectiveBusinessDay = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		public String WorktimeComment { 
			get {
				return _WorktimeComment;
			}
			set {
				if(_WorktimeComment != value){
					_WorktimeComment = value;
					Status_IsDirty = true;
				}
			}
		} 
        ...
        {
			public Guid? CMN_STR_PPS_EffectiveWorkTime_HeaderID {	get; set; }
			public Guid? Employee_RefID {	get; set; }
			public DateTime? EffectiveBusinessDay {	get; set; }
			...
			public String WorktimeComment {	get; set; }
			...
			#region Search
			public static List<ORM_CMN_BPT_EMP_EffectiveWorkTime_Header> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_CMN_BPT_EMP_EffectiveWorkTime_Header> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_CMN_BPT_EMP_EffectiveWorkTime_Header> Search(DbConnection connection, DbTransaction transaction, Query query)
			{
			    return Query.Search(query, null, connection, transaction);
			}

			private static List<ORM_CMN_BPT_EMP_EffectiveWorkTime_Header> Search(Query query, string connectionString, DbConnection connection, DbTransaction transaction)
			{
				CSV2Core.Core.Interfaces.IManagedConnection managedConnection = new CSV2Core_MySQL.MySQLManagedConnection();
			    List<ORM_CMN_BPT_EMP_EffectiveWorkTime_Header> items;
				...
				try
			    {
			        ...
			        items = new List<ORM_CMN_BPT_EMP_EffectiveWorkTime_Header>();

			        var reader = new CSV2Core_MySQL.Support.DBSQLReader(command.ExecuteReader());
					reader.SetOrdinals(new string[] { "CMN_STR_PPS_EffectiveWorkTime_HeaderID","Employee_RefID","EffectiveBusinessDay","SheduleBreakTemplate_RefID","IsBreakTimeManualySpecified","BreakDurationTime_in_sec","WorktimeComment","ContractWorkerText","Creation_Timestamp","Tenant_RefID","IsDeleted" });
			        while (reader.Read())
			        {
			            ORM_CMN_BPT_EMP_EffectiveWorkTime_Header item = new ORM_CMN_BPT_EMP_EffectiveWorkTime_Header();
						//0:Parameter CMN_STR_PPS_EffectiveWorkTime_HeaderID of type Guid
						item.CMN_STR_PPS_EffectiveWorkTime_HeaderID = reader.GetGuid(0);
						//1:Parameter Employee_RefID of type Guid
						item.Employee_RefID = reader.GetGuid(1);
						//2:Parameter EffectiveBusinessDay of type DateTime
						item.EffectiveBusinessDay = reader.GetDate(2);
						//3:Parameter SheduleBreakTemplate_RefID of type Guid
						item.SheduleBreakTemplate_RefID = reader.GetGuid(3);
						//4:Parameter IsBreakTimeManualySpecified of type Boolean
						item.IsBreakTimeManualySpecified = reader.GetBoolean(4);
						//5:Parameter BreakDurationTime_in_sec of type int
						item.BreakDurationTime_in_sec = reader.GetInteger(5);
						//6:Parameter WorktimeComment of type String
						item.WorktimeComment = reader.GetString(6);
						//7:Parameter ContractWorkerText of type String
						item.ContractWorkerText = reader.GetString(7);
						//8:Parameter Creation_Timestamp of type DateTime

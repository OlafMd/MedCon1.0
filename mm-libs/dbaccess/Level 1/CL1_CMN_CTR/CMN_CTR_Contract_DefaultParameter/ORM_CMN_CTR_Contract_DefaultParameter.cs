/* 
 * Generated on 21.4.2015 11:01:35
...
{
	[Serializable]
	public class ORM_CMN_CTR_Contract_DefaultParameter
	{
		public static readonly string TableName = "cmn_ctr_contract_defaultparameters";
		public bool Status_IsAlreadySaved { get; set; }
		public bool Status_IsDirty { get; set; }
		public static readonly int QueryTimeout = 60;

		#region Class Constructor
		public ORM_CMN_CTR_Contract_DefaultParameter()
		{
			Status_IsAlreadySaved = false;
			Status_IsDirty = false;
			//When creating a new class, generate a new UUID
			_CMN_CTR_Contract_DefaultParameterID = Guid.NewGuid();
			_IsDeleted = false;
		...
		private Guid _CMN_CTR_Contract_DefaultParameterID = default(Guid);
		...
		private String _IfStringValue_DefaultValue = default(String);
		private Boolean _IsNumericValue = default(Boolean);
		private double _IfNumericValue_DefaultValue = default(double);
		private Boolean _IsBooleanValue = default(Boolean);
		private Boolean _IfBooleanValue_DefaultValue = default(Boolean);
		...
		public Guid CMN_CTR_Contract_DefaultParameterID { 
			get {
				return _CMN_CTR_Contract_DefaultParameterID;
			}
			set {
				if(_CMN_CTR_Contract_DefaultParameterID != value){
					_CMN_CTR_Contract_DefaultParameterID = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		public String IfStringValue_DefaultValue { 
			get {
				return _IfStringValue_DefaultValue;
			}
			set {
				if(_IfStringValue_DefaultValue != value){
					_IfStringValue_DefaultValue = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		public double IfNumericValue_DefaultValue { 
			get {
				return _IfNumericValue_DefaultValue;
			}
			set {
				if(_IfNumericValue_DefaultValue != value){
					_IfNumericValue_DefaultValue = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		public Boolean IfBooleanValue_DefaultValue { 
			get {
				return _IfBooleanValue_DefaultValue;
			}
			set {
				if(_IfBooleanValue_DefaultValue != value){
					_IfBooleanValue_DefaultValue = value;
					Status_IsDirty = true;
				}
			}
		} 
		...
		protected FR_Base Save(DbConnection Connection, DbTransaction Transaction, string ConnectionString)
		{
			...
			try
			{
				...
				if (saveORMClass == true) { 
					...
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_CMN_CTR.CMN_CTR_Contract_DefaultParameter.SQL.Update.sql")).ReadToEnd();
					}
					else
					{
						Query = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_CMN_CTR.CMN_CTR_Contract_DefaultParameter.SQL.Insert.sql")).ReadToEnd();
					}
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "CMN_CTR_Contract_DefaultParameterID", _CMN_CTR_Contract_DefaultParameterID);
					...
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "IfStringValue_DefaultValue", _IfStringValue_DefaultValue);
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "IsNumericValue", _IsNumericValue);
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "IfNumericValue_DefaultValue", _IfNumericValue_DefaultValue);
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "IsBooleanValue", _IsBooleanValue);
					CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command, "IfBooleanValue_DefaultValue", _IfBooleanValue_DefaultValue);
		...
		private FR_Base Load(DbConnection Connection, DbTransaction Transaction, Guid ObjectID, string ConnectionString)
		{
			...
			try
			{
				...
				string SelectQuery = new System.IO.StreamReader(System.Reflection.Assembly.GetExecutingAssembly().GetManifestResourceStream("CL1_CMN_CTR.CMN_CTR_Contract_DefaultParameter.SQL.Select.sql")).ReadToEnd();
				...
				_CMN_CTR_Contract_DefaultParameterID = Guid.Empty;
				CSV2Core_MySQL.Support.DBSQLSupport.SetParameter(command,"CMN_CTR_Contract_DefaultParameterID", ObjectID );
				...
				try
				{
					...
					if (reader.HasRows == true)
					{
						...
						_CMN_CTR_Contract_DefaultParameterID = reader.GetGuid(0);
						...
						_IfStringValue_DefaultValue = reader.GetString(5);
						...
						_IfNumericValue_DefaultValue = reader.GetDouble(7);
						...
						_IfBooleanValue_DefaultValue = reader.GetBoolean(9);
					...
					if(_CMN_CTR_Contract_DefaultParameterID != Guid.Empty){
						//Successfully loaded
						Status_IsAlreadySaved = true;
						Status_IsDirty = false;
					} else {
        ...
        {
			public Guid? CMN_CTR_Contract_DefaultParameterID {	get; set; }
			public String GlobalPropertyMatchingID {	get; set; }
			public Guid? Contract_RefID {	get; set; }
			public String ParameterName {	get; set; }
			public Boolean? IsStringValue {	get; set; }
			public String IfStringValue_DefaultValue {	get; set; }
			public Boolean? IsNumericValue {	get; set; }
			public double? IfNumericValue_DefaultValue {	get; set; }
			public Boolean? IsBooleanValue {	get; set; }
			public Boolean? IfBooleanValue_DefaultValue {	get; set; }
			...
			#region Search
			public static List<ORM_CMN_CTR_Contract_DefaultParameter> Search(string connectionString, Query query)
			{
			    return Query.Search(query, connectionString, null, null);
			}

			public static List<ORM_CMN_CTR_Contract_DefaultParameter> Search(DbConnection connection, Query query)
			{
			    return Query.Search(query, null, connection, null);
			}

			public static List<ORM_CMN_CTR_Contract_DefaultParameter> Search(DbConnection connection, DbTransaction transaction, Query query)
			{

...
(function withAngular() {
    'use strict';
    angular.module('720kb.datepicker', []).directive('datepicker', ['$window', '$compile', '$locale', '$filter', function manageDirective($window, $compile, $locale, $filter) {
        ...
        return {
            ...
            'link': function linkingFunction($scope, element, attr) {
                ...
                var selector = attr.selector
                  ...
                  , htmlTemplate = '<div class="_720kb-datepicker-calendar" ng-class="{\'calendar-right\': isRight, \'calendar-left\': isLeft}" ng-blur="hideCalendar()">' +
                  //motnh+year header
                ...
                var GetMonthGer = function (monthStr) {
                    var mnth;
                    switch (monthStr) {
                        case "January":
                            mnth = "Januar";
                ...
                $scope.$watch('dateModel', function (newVal, oldVal) {
                    if (newVal !== undefined && newVal !== null && newVal.length === 10) {

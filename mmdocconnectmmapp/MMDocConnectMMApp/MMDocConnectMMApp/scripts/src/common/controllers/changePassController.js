...
define(['angularAMD'], function (angularAMD) {
    angularAMD.controller('changePassController', ['$scope', '$location', '$translate', 'ajaxService', '$rootScope', 'alertsServices', 'validationService','commonServices', function ($scope, $location, $translate, ajaxService, $rootScope, alertsServices, validationService, commonServices) {
        $scope.pass = {};

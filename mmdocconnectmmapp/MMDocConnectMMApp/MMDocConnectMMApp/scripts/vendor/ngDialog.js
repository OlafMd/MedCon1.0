...
define(['angularAMD'], function (angularAMD) {
    //  angularAMD .directive('ngDialog', ['$rootScope', function ($rootScope) {
    ...
    angularAMD.provider('ngDialog', function () {
    ...
    angularAMD.directive('ngDialog', ['ngDialog', function (ngDialog) {
        return {
            restrict: 'A',
            scope : {
                ngDialogScope : '='

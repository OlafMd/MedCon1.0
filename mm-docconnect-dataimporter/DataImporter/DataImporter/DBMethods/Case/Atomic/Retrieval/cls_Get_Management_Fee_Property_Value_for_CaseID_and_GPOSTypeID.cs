...
namespace DataImporter.DBMethods.Case.Atomic.Retrieval
{
    ...
    /// var result = cls_Get_Management_Fee_Property_Value_for_CaseID_and_GPOSTypeID.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Get_Management_Fee_Property_Value_for_CaseID_and_GPOSTypeID
	{
		...
		protected static FR_CAS_GMFPVfCIDaGPOSTID_1749 Execute(DbConnection Connection,DbTransaction Transaction,P_CAS_GMFPVfCIDaGPOSTID_1749 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			...
			var commandLocation = "DataImporter.DBMethods.Case.Atomic.Retrieval.SQL.cls_Get_Management_Fee_Property_Value_for_CaseID_and_GPOSTypeID.sql";
			...
			{
				reader.Close();
				throw new Exception("Exception occured durng data retrieval in method cls_Get_Management_Fee_Property_Value_for_CaseID_and_GPOSTypeID",ex);
			}
			reader.Close();
		...
		protected static FR_CAS_GMFPVfCIDaGPOSTID_1749 Invoke(DbConnection Connection, DbTransaction Transaction, string ConnectionString,P_CAS_GMFPVfCIDaGPOSTID_1749 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
			...
			catch (Exception ex)
			{
				...
				throw new Exception("Exception occured in method cls_Get_Management_Fee_Property_Value_for_CaseID_and_GPOSTypeID",ex);
			}
...
[OperationContract]
FR_CAS_GMFPVfCIDaGPOSTID_1749 cls_Get_Management_Fee_Property_Value_for_CaseID_and_GPOSTypeID(,P_CAS_GMFPVfCIDaGPOSTID_1749 Parameter, string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_CAS_GMFPVfCIDaGPOSTID_1749 invocationResult = cls_Get_Management_Fee_Property_Value_for_CaseID_and_GPOSTypeID.Invoke(connectionString,P_CAS_GMFPVfCIDaGPOSTID_1749 Parameter,securityTicket);
...
var parameter = new DataImporter.DBMethods.Case.Atomic.Retrieval.P_CAS_GMFPVfCIDaGPOSTID_1749();
parameter.CaseID = ...;

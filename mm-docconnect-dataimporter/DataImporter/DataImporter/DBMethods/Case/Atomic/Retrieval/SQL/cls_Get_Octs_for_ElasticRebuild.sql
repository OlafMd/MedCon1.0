    ...
    Select
      ...
      Concat_Ws(' ', cmn_per_personinfo1.Title, cmn_per_personinfo1.FirstName, cmn_per_personinfo1.LastName) As OctDoctorName,
      Concat_Ws(' ', cmn_per_personinfo.Title, cmn_per_personinfo.FirstName, cmn_per_personinfo.LastName) As OpDoctorName,
      Concat_Ws(', ', hec_cas_cases.Patient_LastName, hec_cas_cases.Patient_FirstName) As PatientName,
    ...
    From
      ...
      hec_act_plannedactions hec_act_plannedactions1
        ...
        hec_act_plannedactions1.IsPerformed = 0 And
        hec_act_plannedactions1.Tenant_RefID = @TenantID And
        hec_act_plannedactions1.IsDeleted = 0 Inner Join
      hec_act_plannedaction_2_actiontype
        On hec_act_plannedactions1.HEC_ACT_PlannedActionID = hec_act_plannedaction_2_actiontype.HEC_ACT_PlannedAction_RefID And
      ...
      hec_act_actiontype
        ...
        hec_act_actiontype.GlobalPropertyMatchingID = 'mm.docconect.doc.app.planned.action.oct' And 
        hec_act_actiontype.Tenant_RefID = @TenantID And
        hec_act_actiontype.IsDeleted = 0 Inner Join
      cmn_bpt_businessparticipants cmn_bpt_businessparticipants1
        On hec_act_plannedactions1.ToBePerformedBy_BusinessParticipant_RefID = cmn_bpt_businessparticipants1.CMN_BPT_BusinessParticipantID And 
      ...
      cmn_per_personinfo cmn_per_personinfo1
        On cmn_bpt_businessparticipants1.IfNaturalPerson_CMN_PER_PersonInfo_RefID = cmn_per_personinfo1.CMN_PER_PersonInfoID And
        cmn_per_personinfo1.Tenant_RefID = @TenantID And
        cmn_per_personinfo1.IsDeleted = 0 Inner Join
      hec_act_performedaction_diagnosisupdates
        On hec_act_performedaction_diagnosisupdates.HEC_ACT_PerformedAction_RefID = hec_cas_case_relevantperformedactions.PerformedAction_RefID And
      ...
      hec_dia_potentialdiagnoses
        On hec_act_performedaction_diagnosisupdates.PotentialDiagnosis_RefID = hec_dia_potentialdiagnoses.HEC_DIA_PotentialDiagnosisID And
      ...
      hec_dia_potentialdiagnosis_catalogcodes
        On hec_dia_potentialdiagnoses.HEC_DIA_PotentialDiagnosisID = hec_dia_potentialdiagnosis_catalogcodes.PotentialDiagnosis_RefID And
      ...
      hec_doctors hec_doctors1
        On hec_act_plannedactions1.ToBePerformedBy_BusinessParticipant_RefID = hec_doctors1.BusinessParticipant_RefID And
        hec_doctors1.Tenant_RefID = @TenantID And
        hec_doctors1.IsDeleted = 0 Inner Join
      cmn_bpt_ctm_organizationalunit_staff
        On hec_act_plannedactions.ToBePerformedBy_BusinessParticipant_RefID = cmn_bpt_ctm_organizationalunit_staff.BusinessParticipant_RefID And
      ...
      cmn_bpt_ctm_organizationalunit_staff cmn_bpt_ctm_organizationalunit_staff1
        On hec_act_plannedactions1.ToBePerformedBy_BusinessParticipant_RefID = cmn_bpt_ctm_organizationalunit_staff1.BusinessParticipant_RefID And
      ...
      cmn_bpt_ctm_organizationalunits cmn_bpt_ctm_organizationalunits1
        On cmn_bpt_ctm_organizationalunit_staff1.OrganizationalUnit_RefID = cmn_bpt_ctm_organizationalunits1.CMN_BPT_CTM_OrganizationalUnitID And
      ...
      cmn_bpt_businessparticipants cmn_bpt_businessparticipants2
        On cmn_bpt_ctm_customers.Ext_BusinessParticipant_RefID = cmn_bpt_businessparticipants2.CMN_BPT_BusinessParticipantID And
        cmn_bpt_businessparticipants2.Tenant_RefID = @TenantID ANd
        cmn_bpt_businessparticipants2.IsDeleted = 0
    Where  
      hec_cas_cases.Tenant_RefID = @TenantID And
      hec_cas_cases.IsDeleted = 0
    Order by 
      hec_act_plannedactions1.Creation_Timestamp 

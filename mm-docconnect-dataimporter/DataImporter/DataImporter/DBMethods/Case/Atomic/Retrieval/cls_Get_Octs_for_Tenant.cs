/* 
 * Generated on 4/7/2017 11:06:48 AM
...
namespace DataImporter.DBMethods.Case.Atomic.Retrieval
{
    ...
    /// var result = cls_Get_Octs_for_Tenant.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Get_Octs_for_Tenant
	{
		...
		///<summary>
		public static FR_CAS_GOfT_1106_Array Invoke(string ConnectionString,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_CAS_GOfT_1106_Array Invoke(DbConnection Connection,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_CAS_GOfT_1106_Array Invoke(DbConnection Connection, DbTransaction Transaction,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
	...
	[Serializable]
	public class FR_CAS_GOfT_1106_Array : FR_Base
	{
		public CAS_GOfT_1106[] Result	{ get; set; } 
		public FR_CAS_GOfT_1106_Array() : base() {}

		public FR_CAS_GOfT_1106_Array(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass CAS_GOfT_1106 for attribute CAS_GOfT_1106
		[DataContract]
		public class CAS_GOfT_1106 
		{
...
[OperationContract]
FR_CAS_GOfT_1106_Array cls_Get_Octs_for_Tenant(string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_CAS_GOfT_1106_Array invocationResult = cls_Get_Octs_for_Tenant.Invoke(connectionString,securityTicket);

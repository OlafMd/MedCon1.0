...
namespace DataImporter.DBMethods.Case.Atomic.Retrieval
{
	...
	public class cls_Get_Treatment_Performed_Action_Diagnose_Details_for_CaseID
	{
		...
		protected static FR_CAS_GTPADDfCID_1304 Execute(DbConnection Connection,DbTransaction Transaction,P_CAS_GTPADDfCID_1304 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			...
			var commandLocation = "DataImporter.DBMethods.Case.Atomic.Retrieval.SQL.cls_Get_Treatment_Performed_Action_Diagnose_Details_for_CaseID.sql";
...
var parameter = new DataImporter.DBMethods.Case.Atomic.Retrieval.P_CAS_GTPADDfCID_1304();
parameter.CaseID = ...;

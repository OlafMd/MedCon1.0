...
namespace DataImporter.DBMethods.Case.Atomic.Retrieval
{
	...
	public class cls_Get_BillingCode_for_CaseBillCodeID
	{
		...
		protected static FR_CAS_GBCfCBCID_1334 Execute(DbConnection Connection,DbTransaction Transaction,P_CAS_GBCfCBCID_1334 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			...
			var commandLocation = "DataImporter.DBMethods.Case.Atomic.Retrieval.SQL.cls_Get_BillingCode_for_CaseBillCodeID.sql";
...
var parameter = new DataImporter.DBMethods.Case.Atomic.Retrieval.P_CAS_GBCfCBCID_1334();

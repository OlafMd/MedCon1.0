/* 
 * Generated on 06/30/15 17:33:55
...
namespace DataImporter.DBMethods.Case.Atomic.Manipulation
{
	...
	public class cls_Create_Aftercare_Planned_Action
	{
		...
		protected static FR_Guid Execute(DbConnection Connection,DbTransaction Transaction,P_CAS_CAPA_1237 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
            ...
            {
                var aftercare_practice_account = cls_Get_Practice_AccountID_for_PracticeID.Invoke(Connection, Transaction, new P_DO_GPAIDfPID_1522() { PracticeID = Parameter.aftercare_doctor_practice_id }, securityTicket).Result;
...
var parameter = new DataImporter.DBMethods.Case.Atomic.Manipulation.P_CAS_CAPA_1237();
parameter.case_id = ...;

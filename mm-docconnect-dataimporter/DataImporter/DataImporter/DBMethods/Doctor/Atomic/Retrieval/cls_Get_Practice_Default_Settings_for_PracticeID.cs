...
namespace DataImporter.DBMethods.Doctor.Atomic.Retrieval
{
	...
	public class cls_Get_Practice_Default_Settings_for_PracticeID
	{
		...
		protected static FR_DO_GPDSfPID_0909 Execute(DbConnection Connection,DbTransaction Transaction,P_DO_GPDSfPID_0909 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			...
			var commandLocation = "DataImporter.DBMethods.Doctor.Atomic.Retrieval.SQL.cls_Get_Practice_Default_Settings_for_PracticeID.sql";
...
var parameter = new DataImporter.DBMethods.Doctor.Atomic.Retrieval.P_DO_GPDSfPID_0909();

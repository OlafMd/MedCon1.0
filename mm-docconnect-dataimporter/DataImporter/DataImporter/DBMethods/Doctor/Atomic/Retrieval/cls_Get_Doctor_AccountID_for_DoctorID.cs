...
namespace DataImporter.DBMethods.Doctor.Atomic.Retrieval
{
	...
	public class cls_Get_Doctor_AccountID_for_DoctorID
	{
		...
		protected static FR_DO_GDAIDfDID_1549 Execute(DbConnection Connection,DbTransaction Transaction,P_DO_GDAIDfDID_1549 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			...
			var commandLocation = "DataImporter.DBMethods.Doctor.Atomic.Retrieval.SQL.cls_Get_Doctor_AccountID_for_DoctorID.sql";
...
var parameter = new DataImporter.DBMethods.Doctor.Atomic.Retrieval.P_DO_GDAIDfDID_1549();
parameter.DoctorID = ...;

...
namespace DataImporter.DBMethods.Doctor.Atomic.Retrieval
{
	...
	public class cls_Get_PracticeID_for_DoctorID
	{
		...
		protected static FR_DO_GPIDfDID_1353_Array Execute(DbConnection Connection,DbTransaction Transaction,P_DO_GPIDfDID_1353 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			...
			var commandLocation = "DataImporter.DBMethods.Doctor.Atomic.Retrieval.SQL.cls_Get_PracticeID_for_DoctorID.sql";
...
var parameter = new DataImporter.DBMethods.Doctor.Atomic.Retrieval.P_DO_GPIDfDID_1353();
parameter.DoctorID = ...;

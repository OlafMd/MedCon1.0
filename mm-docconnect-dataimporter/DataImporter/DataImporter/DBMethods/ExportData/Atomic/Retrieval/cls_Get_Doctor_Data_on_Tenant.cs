...
namespace DataImporter.DBMethods.ExportData.Atomic.Retrieval
{
    ...
    /// var result = cls_Get_Doctor_Data_on_Tenant.Invoke(connectionString).Result;
    /// </example>
    /// </summary>
	[DataContract]
	public class cls_Get_Doctor_Data_on_Tenant
	{
		...
		///<summary>
		public static FR_DO_GDDfDID_1207_Array Invoke(string ConnectionString,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_DO_GDDfDID_1207_Array Invoke(DbConnection Connection,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
		...
		///<summary>
		public static FR_DO_GDDfDID_1207_Array Invoke(DbConnection Connection, DbTransaction Transaction,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null)
		{
	...
	[Serializable]
	public class DO_GDDfDID_1207_raw 
	{
		...
		public static DO_GDDfDID_1207[] Convert(List<DO_GDDfDID_1207_raw> rawResult)
		{	
		    var gfunct_rawResult = rawResult;
			var groupResult = from el_DO_GDDfDID_1207 in gfunct_rawResult.Where(element => !EqualsDefaultValue(element.id)).ToArray()
	group el_DO_GDDfDID_1207 by new 
	{ 
		el_DO_GDDfDID_1207.id,

	}
	into gfunct_DO_GDDfDID_1207
	select new DO_GDDfDID_1207
	{     
		doctor_account_id = gfunct_DO_GDDfDID_1207.FirstOrDefault().doctor_account_id ,
		id = gfunct_DO_GDDfDID_1207.Key.id ,
		fax = gfunct_DO_GDDfDID_1207.FirstOrDefault().fax ,
		town = gfunct_DO_GDDfDID_1207.FirstOrDefault().town ,
		address = gfunct_DO_GDDfDID_1207.FirstOrDefault().address ,
		lanr = gfunct_DO_GDDfDID_1207.FirstOrDefault().lanr ,
		name = gfunct_DO_GDDfDID_1207.FirstOrDefault().name ,
		first_name = gfunct_DO_GDDfDID_1207.FirstOrDefault().first_name ,
		last_name = gfunct_DO_GDDfDID_1207.FirstOrDefault().last_name ,
		title = gfunct_DO_GDDfDID_1207.FirstOrDefault().title ,
		IBAN = gfunct_DO_GDDfDID_1207.FirstOrDefault().IBAN ,
		BankName = gfunct_DO_GDDfDID_1207.FirstOrDefault().BankName ,
		BICCode = gfunct_DO_GDDfDID_1207.FirstOrDefault().BICCode ,
		OwnerText = gfunct_DO_GDDfDID_1207.FirstOrDefault().OwnerText ,
		practice_id = gfunct_DO_GDDfDID_1207.FirstOrDefault().practice_id ,
		practice = gfunct_DO_GDDfDID_1207.FirstOrDefault().practice ,
		BSNR = gfunct_DO_GDDfDID_1207.FirstOrDefault().BSNR ,
		sign_in_email = gfunct_DO_GDDfDID_1207.FirstOrDefault().sign_in_email ,
		ZIP = gfunct_DO_GDDfDID_1207.FirstOrDefault().ZIP ,
		city = gfunct_DO_GDDfDID_1207.FirstOrDefault().city ,
		salutation = gfunct_DO_GDDfDID_1207.FirstOrDefault().salutation ,
		BankAccountID = gfunct_DO_GDDfDID_1207.FirstOrDefault().BankAccountID ,

		DoctorComunication = 
		(
			from el_DoctorComunication in gfunct_DO_GDDfDID_1207.Where(element => !EqualsDefaultValue(element.CMN_PER_CommunicationContact_TypeID)).ToArray()
			...
			select new DO_GDDfDID_1207_DoctorComunication
			{     
	...
	[Serializable]
	public class FR_DO_GDDfDID_1207_Array : FR_Base
	{
		public DO_GDDfDID_1207[] Result	{ get; set; } 
		public FR_DO_GDDfDID_1207_Array() : base() {}

		public FR_DO_GDDfDID_1207_Array(Exception ex): base(ex) {}

	}
	#endregion

	#region Support Classes
		#region SClass DO_GDDfDID_1207 for attribute DO_GDDfDID_1207
		[DataContract]
		public class DO_GDDfDID_1207 
		{
			[DataMember]
			public DO_GDDfDID_1207_DoctorComunication[] DoctorComunication { get; set; }
		...
		#endregion
		#region SClass DO_GDDfDID_1207_DoctorComunication for attribute DoctorComunication
		[DataContract]
		public class DO_GDDfDID_1207_DoctorComunication 
		{
			//Standard type parameters
			[DataMember]
...
[OperationContract]
FR_DO_GDDfDID_1207_Array cls_Get_Doctor_Data_on_Tenant(string sessionToken = null)
{
	try
	{
		var securityTicket = Verify(sessionToken);
		FR_DO_GDDfDID_1207_Array invocationResult = cls_Get_Doctor_Data_on_Tenant.Invoke(connectionString,securityTicket);

...
namespace DataImporter.DBMethods.ExportData.Atomic.Retrieval
{
	...
	public class cls_Get_Doctor_Details_for_DoctorID
	{
		...
		protected static FR_DO_GDDfDID_0823_Array Execute(DbConnection Connection,DbTransaction Transaction,P_DO_GDDfDID_0823 Parameter,CSV2Core.SessionSecurity.SessionSecurityTicket securityTicket = null){
			...
			var commandLocation = "DataImporter.DBMethods.ExportData.Atomic.Retrieval.SQL.cls_Get_Doctor_Details_for_DoctorID.sql";
	...
	{     
		...
		BankAccountID = gfunct_DO_GDDfDID_0823.FirstOrDefault().BankAccountID ,
...
var parameter = new DataImporter.DBMethods.ExportData.Atomic.Retrieval.P_DO_GDDfDID_0823();
parameter.DoctorID = ...;

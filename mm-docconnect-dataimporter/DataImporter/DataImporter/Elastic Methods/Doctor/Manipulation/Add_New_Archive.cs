...
{
    public static class Add_New_Archive
    {
        ...
        public static void Import_Archive_Item_to_ElasticDB(List<Archive_Model> ArchiveModel, string indexName)
        {
            ...
            Elastic_Utils.BulkType<Archive_Model>(ArchiveModel, connection, serializer, indexName, "docarchive");
        }

...
namespace DataImporter.Elastic_Methods.Doctor.Manipulation
{
    public static class Add_New_Patient
    {
                ...
                .RootObject("patient", ro => ro
                    .Properties(pr => pr
                                    .MultiField("id", mfp => mfp.Fields(f => f
                                     ...
                                     ).MultiField("has_oct_rejected", mfp => mfp.Fields(f => f.Boolean("has_oct_rejected")))
        ...
        public static void Import_Patients_to_ElasticDB(Patient_Model patient, string TenantID)
        {
        ...
        public static void Import_Patients_List_to_ElasticDB(List<Patient_Model> patient, string TenantID)
        {
            string indexElastic = TenantID;
            var serializer = new JsonNetSerializer();
            var connection = Elastic_Utils.ElsaticConnection();
            ...
            Elastic_Utils.BulkType_Generic<Patient_Model>(patient, connection, serializer, indexElastic, "patient");

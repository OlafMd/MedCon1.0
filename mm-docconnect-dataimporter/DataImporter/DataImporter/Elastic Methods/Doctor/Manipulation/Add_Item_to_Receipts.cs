 ...
 public static   class Add_Item_to_Receipts
    {
        ...
        public static void Import_Receipt_Item_to_ElasticDB( List<Receipt_Model> receipt, string indexName)
        {
            ...
            //List<Receipt_Model> receiptList = new List<Receipt_Model>();
          //  receiptList.Add(receipt);
            Elastic_Utils.BulkType<Receipt_Model>(receipt, connection, serializer, indexName, "receipts");
        }
